...
Sharpness & Both Section 2 constructions, against the theorems' own hypotheses. & \code{FinishYuWangSamworth/Symmetric/OrthogonalSharpness.lean} (preprint's top-block form), \code{Symmetric/PlanarSharpness.lean}. \\
