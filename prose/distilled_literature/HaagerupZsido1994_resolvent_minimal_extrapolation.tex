...
\texttt{\seqsplit{DavisKahan/Sylvester/BoundedOperator.lean}}, especially
...
Theorem 3.6, $\alpha=0$ & Unique $L^1$ extension of $1/(-ix)$ with norm $\pi/2$ & Exact scalar analytic root needed by \code{DavisKahan/Sylvester/BoundedOperator.lean}. \\
