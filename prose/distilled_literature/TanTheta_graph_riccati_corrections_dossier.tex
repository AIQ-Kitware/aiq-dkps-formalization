...
\item[Formalization target] \code{DavisKahanTheory/TanTheta.lean}, \code{DavisKahan/Experimental/Literature/GraphSubspace.lean}, \code{Riccati.lean}, and the generalized trial-map layer.
\end{sourceguide}
