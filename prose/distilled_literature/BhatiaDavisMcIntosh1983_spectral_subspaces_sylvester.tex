...
\item[Formalization target] \code{DavisKahan.FiniteDimensional.Sylvester}, \code{ReciprocalMultiplier}, and \code{RectangularUINorm}; in particular the distinction between ordered-gap constant one and arbitrary-separated sharp constant $\pi/2$.
