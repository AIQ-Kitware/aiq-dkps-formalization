...
| `DavisKahan1970` | 1970 | The Rotation of Eigenvectors by a Perturbation. III | primary theorem source | source-faithful Section 6 complete; finite four-theorem specialization complete; full Part III direct-rotation, tangent/double-angle, Section 8, classification, and Section 9 work remains active | `core_note` | P0 |
...
- **`DavisKahan1970` — The Rotation of Eigenvectors by a Perturbation. III**: Compile and promote the full Part III candidate surface; formalize the Section 3 classification and nonacute direct-rotation results; add exact source wrappers for Sections 4, 5, 7, and 8; prove Appendix Lemma 6.3; and formalize the Section 9 numerical example.
