...
| `DavisKahan1970` | 1970 | The Rotation of Eigenvectors by a Perturbation. III | primary theorem source | source-faithful sine family complete; finite equal-rank and strict-lower-rank tangent UI-norm specializations compile; Theorem 6.3 Hilbert-space directed Ky-Fan core and arbitrary-UI-norm unbounded passage remain open; Section 8 and Section 9 campaigns remain active | `core_note` | P0 |
...
- **`DavisKahan1970` — The Rotation of Eigenvectors by a Perturbation. III**: Prove the source-faithful Hilbert-space Theorem 6.3 from the directed E₀*F₁ tangent data via all finite Ky Fan inequalities and the unbounded cutoff passage; do not reintroduce the refuted hdim-to-IsAcute distillation. Continue the Section 3 classification, Section 4 infinite comparison, Section 8, and Section 9 campaigns.
