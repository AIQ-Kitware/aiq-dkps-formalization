...
| `DavisKahan1970` | 1970 | The Rotation of Eigenvectors by a Perturbation. III | primary theorem source | source-faithful sine family complete; bounded Theorem 6.3 proof written at source-effective finite-trial/arbitrary-ambient scope; compiler certification pending; equal-dimensional infinite tan theta and arbitrary-UI-norm unbounded passage remain open; Section 8 and Section 9 campaigns remain active | `core_note` | P0 |
...
- **`DavisKahan1970` — The Rotation of Eigenvectors by a Perturbation. III**: Compile and promote the bounded Theorem 6.3 implementation. The finite-trial typeclass is the explicit Lean encoding of the paper's strict Hilbert-dimension consequence under separability; a future cardinal bridge may derive it mechanically. Complete the equal-dimensional infinite/noncompact tan theta theorem and the arbitrary-UI-norm unbounded Appendix passage; do not reintroduce the refuted hdim-to-IsAcute distillation. Continue the Section 3 classification, Section 4 infinite comparison, Section 8, and Section 9 campaigns.
