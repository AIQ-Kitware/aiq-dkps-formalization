...
| `DavisKahan1970` | 1970 | The Rotation of Eigenvectors by a Perturbation. III | primary theorem source | strong finite specialization; partial bounded Hilbert-space theory; full source norm scope, Section 8, and unbounded passages remain active | `core_note` | P0 |
...
- **`DavisKahan1970` — The Rotation of Eigenvectors by a Perturbation. III**: Complete a theorem-number audit against the transcription; promote the bounded Hilbert-space four-theorem package; develop the infinite-dimensional unitary-invariant ideal layer; formalize direct-rotation extremality, Section 8, sharpness/equality results, and the unbounded Theorem 5.2/Appendix to Section 6 passages.
