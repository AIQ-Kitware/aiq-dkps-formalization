...
| `DavisKahan1970` | 1970 | The Rotation of Eigenvectors by a Perturbation. III | primary theorem source | source-faithful Section 6 complete; finite four-theorem specialization complete; Section 8 continuation-selected branch and conditional spectral-repulsion candidate added; Section 9 exact finite-moment, numerical, domain, and Schur-complement candidate added; full Part III direct-rotation, tangent/double-angle, exact Section 8 bridge/refinement, classification, and analytic free-beam work remains active | `core_note` | P0 |
...
- **`DavisKahan1970` — The Rotation of Eigenvectors by a Perturbation. III**: Compile and promote the full Part III candidate surface; formalize the Section 3 classification and nonacute direct-rotation results; add exact source wrappers for Sections 4, 5, and 7; complete the unrestricted Theorem 8.1 branch construction, compression/eigenvalue/symmetric-gauge repulsion, and the two exact Theorem 8.2 half-gap bridges; prove Appendix Lemma 6.3; and discharge the Section 9 analytic free-beam realization, spectral gap, and theorem-instantiation bridge.
