...
Proposition 4 & Residual/Rayleigh--Ritz form of Nakatsukasa's theorem & \code{partIII_tanTheta_ritzResidual_uiNorm}, \code{partIII_generalizedTanTheta_ritzResidual_uiNorm}, and the lower-dependency \code{partIII_tanTheta_vector} \\
