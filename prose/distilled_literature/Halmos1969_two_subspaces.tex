...
\item[Modern checks] Later formulations of Halmos's two-projection theorem and graph-subspace geometry; the repository's \code{PrincipalAngles.lean}, \code{DavisKahanExt/OperatorAngle.lean}, \code{DavisKahanTheory/DirectRotation.lean}, and experimental \code{GraphSubspace.lean}.
