...
an approximation error can always be corrected exactly. What remains at this
boundary is the quantitative version: bound the correction coefficient mass
linearly in the finite error vector, so that increasingly accurate Fourier
approximations have vanishing correction cost.
...
Finite exact correction after Fourier approximation & Lagrange interpolation on finitely many distinct circle phases & \code{exists_finite_fourier_interpolation}; a linear coefficient-mass bound is the remaining quantitative step. \\
