...
\item[Formalization target] The repository target is the full source scope: separable Hilbert spaces; the bounded Hermitian main body; all four theorem families in infinite and finite dimensions; arbitrary unitary-invariant norms with correct domains of finiteness; and the unbounded self-adjoint extensions with their domain assumptions.
...
\item source-faithful bounded Hilbert-space versions of the four main theorem
families, in residual and perturbation forms;
...
Bounded Hilbert-space main body & Partial operator-norm foundation & Complete all four source theorem families, direct rotation, and Section 8 without finite-dimensional assumptions \\
