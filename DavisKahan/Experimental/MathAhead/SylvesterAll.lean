...
This aggregate sits on the compiler-repaired scalar kernel and exponential
core from commit `53297a4`, and adds the pending Borel finite-step, Ky Fan,
real-descent, and rectangular-ideal layers.
-/
