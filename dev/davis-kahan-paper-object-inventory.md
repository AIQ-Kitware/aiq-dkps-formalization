...
| `paperSinAngleOperatorC` | **B** | DK-6.1-prop | The paper's *ambient* sine-angle operator. `sinAngleOperatorC_eq` characterizes it. Distinct from the directed `sinAngleOperatorC`. |
