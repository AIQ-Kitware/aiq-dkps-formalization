...
The theorem-by-theorem completeness ledger is:
...
- `dev/davis-kahan-1970-missing-statements-math-ahead-2026-07-20.md` -- proof
  and statement work queue.
...
3. update the JSON census;
4. regenerate the Markdown view;
5. run `scripts/check_davis_kahan_1970_source_census.py`;
