# Considerations — open API questions on the Hilbert-space operator roadmap

> **Paths in this file are relative to**
> `submodules/TauCetiRoadmap/TauCetiRoadmap/HilbertSpaceOperatorTheory/`,
> the roadmap this review covers. That submodule tracks the `hilbert-space-operator-theory`
> branch of the Erotemic fork, which is the head of
> [TauCetiProject/TauCetiRoadmap#126](https://github.com/TauCetiProject/TauCetiRoadmap/pull/126).

**Working notes, kept outside the roadmap PR.** They live here so the open questions are not
lost and not rediscovered by reading 2000 lines of `Suggested.lean`, without shipping a
review scratchpad to TauCeti reviewers. Nothing here is settled; each item is a judgement call with the argument
on both sides.
