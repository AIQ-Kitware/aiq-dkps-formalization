...
| jon (window A) | MathAhead/HiddenFoundations/Section3Nonacute.lean, Interop/Spectra/{DirectRotation,OperatorAbsoluteValue}.lean, Frontier/Section3.lean | nonacute polar campaign: canonicalPolarFactor_sourceCompression_nonnegative DONE, canonicalPolarFactor_crossed_blocks_general DONE, crossedDefectEquivOfPaperDirectRotation (necessity dir, in progress), downstream Proposition 3.2 promotion. Route: C=(1+R_V R_U)/2 normal, W+W*=2\|C\| ⇒ compressions/crossed closed; IsPaperDirectRotation ⇒ T+T* ≥ 0 ⇒ defect mappings. NOTE: does NOT include PolarIsometryFinal.lean adjoint_polarIsometry (delegated to window B) | 2026-07-23 | active |
