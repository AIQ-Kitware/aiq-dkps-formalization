...
| jon (window B) | MathAhead/HiddenFoundations/PolarIsometryFinal.lean | adjoint_polarIsometry ONLY: (polarIsometry T)† = polarIsometry (T†). Independent of window A (consumed only by PolarIntertwining, not by the Prop 3.2 chain). Polar-decomposition uniqueness / adjoint partial-isometry theory | 2026-07-23 | active |
