...
- **Next action:** Transport the identification to real scalars in Section4Real.lean; principalSines is already RCLike-generic and the argument is the same termwise Pythagoras.
