...
# C. Davis and W. M. Kahan, The Rotation of Eigenvectors by a Perturbation. III, SIAM J. Numer. Anal. 7(1), 1970, 1–46.
...
The `importance` field is an external-review priority, not a proof-status axis. `headline` is the deliberately small default semantic-alignment surface; `major` expands it to other important named results without changing the full census.
...
### `hostile-audit-atomization`

{'kind': 'mechanical', 'title': 'Current evidence map is too coarse or points at the wrong theorem layer', 'detail': 'The row is likely mathematically complete, but a generic `.whole` clause or incomplete evidence selection does not statically demonstrate correspondence for every separable assertion in the hashed TeX passage. Atomize the source passage and bind each clause to exact evidence.'}

### `hostile-mixed-disposition`

{'kind': 'mechanical', 'title': 'Established and open/attributed claims are mixed in one terminal row', 'detail': 'The row contains more than one semantic disposition. Split the established theorem assertions from open questions or source-attributed/unproved assertions so the checker cannot hide proof obligations inside an exempt/open row.'}
...
| DK-3.1-def | supporting | Section 3 setup, equations (3.1)--(3.4), and Definition 3.1 | compiled_exact | proved_in_build |  |
| DK-3.2-def | supporting | Definition 3.2 | compiled_exact | proved_in_build |  |
| DK-3.1-prop | supporting | Proposition 3.1 | compiled_exact | proved_in_build |  |
| DK-3.2-prop | supporting | Proposition 3.2 | compiled_exact | proved_in_build |  |
| S3-standing-scope | technical | Section 3, standing convention stated immediately after the proof of Proposition 3.2. | compiled_exact | proved_in_build |  |
| DK-3.3-prop | supporting | Proposition 3.3 | compiled_exact | proved_in_build |  |
| DK-3.4-prop | supporting | Proposition 3.4 | compiled_exact | proved_in_build |  |
| DK-3.1-thm | major | Theorem 3.1 | compiled_exact | proved_in_build |  |
| DK-3.1-cor | supporting | Corollary 3.1 | compiled_exact | proved_in_build |  |
| DK-3.5-prop | supporting | Proposition 3.5 | compiled_exact | proved_in_build |  |
| DK-3.2-cor | supporting | Corollary 3.2 | compiled_exact | proved_in_build |  |
| DK-4.1-prop | supporting | Section 4 setup, Proposition 4.1, and equations (4.1)--(4.2) | compiled_exact | proved_in_build |  |
| DK-4.1-cor | supporting | Corollary 4.1 | compiled_exact | proved_in_build |  |
| DK-4.2-prop | supporting | Proposition 4.2 | compiled_exact | proved_in_build |  |
| DK-4.3-prop | major | Proposition 4.3 | compiled_exact | proved_in_build |  |
| DK-4.4-prop | supporting | Examples 4.1–4.2 and Proposition 4.4 | refuted_as_transcribed | proved_in_build |  |
| DK-5.1-thm | major | Theorem 5.1 | compiled_exact | proved_in_build |  |
| DK-5-hermitian-inequalities | technical | Section 5, inequalities (5.1) and (5.2) | compiled_exact | proved_in_build |  |
| DK-5.2-thm | major | Theorem 5.2 | compiled_exact | proved_in_build |  |
| DK-5.1-lem | technical | Lemma 5.1 | compiled_exact | proved_in_build |  |
| DK-6.1-lem | technical | Lemma 6.1 | compiled_exact | proved_in_build |  |
| DK-6.2-lem | technical | Lemma 6.2 | compiled_exact | proved_in_build |  |
| DK-6.1-prop | supporting | Section 6 sine proof and Proposition 6.1 | compiled_exact | proved_in_build |  |
| DK-6.1-thm | major | Theorem 6.1 | compiled_exact | proved_in_build |  |
| DK-6.2-thm | supporting | Theorem 6.2 | compiled_exact | proved_in_build |  |
| DK-6.3-thm | major | Section 6 equations (6.2)–(6.6), Example 6.1, and Theorem 6.3 | compiled_exact | proved_in_build |  |
| DK-6-appendix | technical | Appendix to Section 6, equations (6.7)–(6.11) | compiled_exact | proved_in_build |  |
| DK-6.3-lem | technical | Lemma 6.3 | compiled_exact | proved_in_build |  |
| DK-7-sin2-proof | technical | Section 7, equations (7.1)–(7.5) | compiled_exact | proved_in_build |  |
| DK-7-tan2-proof | technical | Section 7, equation (7.6) and following argument | compiled_exact | proved_in_build |  |
| DK-8.1-thm | major | Theorem 8.1 | compiled_exact | proved_in_build |  |
| DK-8.2-thm | major | Theorem 8.2 and final Section 8 extension remark | compiled_exact | proved_in_build |  |
| DK-9-model | technical | Section 9, problem setup | compiled_exact | proved_in_build |  |
| DK-9.1-9.4 | technical | Equations (9.1)–(9.4) | compiled_exact | proved_in_build |  |
| DK-9.5-9.7 | technical | Equations (9.5)–(9.7) | compiled_exact | proved_in_build |  |
| DK-9.8 | technical | Equation (9.8) | compiled_exact | proved_in_build |  |
| DK-9-infinite-residual-counterexample | supporting | Section 9, l2 example after (9.8) | compiled_exact | proved_in_build |  |
| DK-9.9-9.11 | technical | Equations (9.9)–(9.11) and final bounds | compiled_exact | proved_in_build |  |
| DK-10.1 | technical | Question 10.1 | resolved_by_modern_development | proved_in_build |  |
| DK-10.2 | technical | Question 10.2 | not_a_completion_obligation | not_applicable |  |
| DK-10.3 | technical | Question 10.3 | not_a_completion_obligation | not_applicable |  |
| DK-10.4 | technical | Question 10.4, including ambient and directed functional-calculus specializations | not_a_completion_obligation | proved_in_build |  |

## Result details

### `S1-block-residual` — Two reducing decompositions and the residual

**importance:** `technical`  **section:** 1  **source:** Section 1, equations (1.1)–(1.8)  **kind:** construction  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Block decompositions for A and A+H, trial and exact coordinate maps, and R = (A+H)E0 - E0 A0.

**Scope gap.** Spelling of the block representation, not scope of any claim.  (1.1)--(1.7) are notation, and this repository represents them with orthogonal projections onto subspaces of the ambient space rather than the paper's isometries `E₀ : X(E₀) → ℋ` and `E₁ : X(E₁) → ℋ` onto separate coordinate spaces.  A reader looking for `B = E₁⋆HE₀` as a map between two *different* Hilbert spaces finds `Pᗮ.starProjection ∘ H ∘ P.subtypeL` instead, which is `E₁B`; the two agree in norm because `E₁` is an isometry, and the trial-map layer does carry the separate-space form where a theorem needs it (`UnboundedSinThetaData.X` is an arbitrary bounded map from a separate space into ℋ).
...
- `TauCeti.DavisKahan.ExactSinTheta.Theorem61Data`
- `TauCeti.DavisKahan.ExactSinTheta.UnboundedSinThetaData`
- `TauCeti.DavisKahan1970.equation1_8_residual_norm_minimized_by_rayleighQuotient`

**Notes.** The exact notation is distributed across the Section 6 source data records rather than exposed as a Section 1 facade.
...
### `S1-ui-norms` — Unitary-invariant norms, angle operators, and direct-rotation setup

**importance:** `technical`  **section:** 1  **source:** Section 1, equations (1.9)–(1.18)  **kind:** framework  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Norms determined by singular values, contraction laws, Ky Fan prefix norms, and dominance by all prefixes.

**Scope gap.** **No narrowing remains.**  The (1.12) codomain-room narrowing was REMOVED 2026-08-09 (Claude Opus 5, coordinator integration).  `equation1_12` now assumes only `hE : exists x : Fin nu -> E, Orthonormal C x`, which is the nonemptiness of the family the printed supremum ranges over, not an addition to the printed claim; the codomain carries no hypothesis at all and `dim F < nu` is allowed.  No replacement hypothesis was introduced: no `[FiniteDimensional]`, no compactness, no rank bound.  `equation1_13_compressions` and `equation1_13_reSum` keep both room hypotheses, which for printed (1.13) ARE the printed claim, since (1.13) quantifies over projectors on both sides.

**Not narrowings, but worth knowing.**  (i) The three equations are `IsLUB`, not attained maxima -- forced by the mathematics, see `notes`; the printed statements say `sup`, so this is fidelity rather than weakening.  (ii) The facade is stated over `C`, the paper's field, because the min--max localization behind the attaining half is available in this library for `R` and `C` but not for an abstract `RCLike` field; the `RCLike`-generic form carrying that localization as a hypothesis is `ApproximationNumber.exists_orthonormal_kyFanApproximationGauge_sub_le_re_sum_inner`.  (iii) `||K||_nu` is spelled `kyFanApproximationGauge nu`, the sum of the first `nu` approximation numbers, which is defined for every bounded operator and agrees with the sum of the `nu` largest singular values whenever those exist (`rectangularKyFanSum_eq_kyFanApproximationGauge`); the paper defines it by singular values, which presumes compactness it does not otherwise assume.

**THE FRONTIER NODE'S STALE FLAG IS CLEARED 2026-08-11 (Claude Opus 5, coordinator, task #9 strand 2).**  `s1-ui-norms-kyfan-suprema` still carried `open_obligation: true` for the (1.12) codomain-room hypothesis that was removed on 2026-08-09; its own note had said 'when it lands, this node stops being an open obligation and the row returns to compiled_exact', and only the second half happened.

SEPARATELY, AND WORTH KNOWING FOR ANY FUTURE READING OF THAT DOCUMENT: `dev/davis-kahan-1970-frontier-status.md` is regenerated only when the gate is run with `--write-report`, and the committed copy had drifted -- it reported 82 manifest nodes against a manifest holding 83, and THIS ROW WAS MISSING FROM ITS PAPER TABLE ENTIRELY.  Regenerating added it, already grounded at 100%.  So the document can understate coverage by omitting a row, not only by scoring one low; rerun it with `--write-report` after any manifest edit.

**Lean declarations:**

- `TauCeti.DavisKahan.ExactSinTheta.SymmetricNormingFunction`
- `TauCeti.DavisKahan.ExactSinTheta.SymmetricNormingFunction.prefixGauge_le_of_all_kyFan_le_hetero`
- `TauCeti.DavisKahan.ExactSinTheta.kyFanNormingFunction`
- `TauCeti.DavisKahan.ExactSinTheta.kyFanNormingFunction_gauge`
- `TauCeti.DavisKahan.ExactSinTheta.kyFanNormingFunction_extendedGauge`
- `TauCeti.DavisKahan.ExactSinTheta.all_kyFan_le_of_every_ext_finiteGaugeendedGauge_le`
- `TauCeti.DavisKahan.ExactSinTheta.all_mul_kyFan_le_of_every_symmetricNorming_gauge_le`
- `TauCeti.DavisKahan.ExactSinTheta.re_sum_inner_map_le_kyFanApproximationGauge`
- `TauCeti.DavisKahan1970.equation1_12`
- `TauCeti.DavisKahan1970.equation1_12_gauge_comp_starProjection_le`
...
- `TauCeti.DavisKahan1970.equation1_18_directRotation_exponential`
- `TauCeti.DavisKahan1970.equation1_18_directRotation_resolution`

**Notes.** The source norm correspondence is part of the clean Section 6 surface.
...
PRIOR WORK ON THIS ROW, RETAINED.  The Ky Fan biconditional (transcription L567) is complete in both directions: `SymmetricNormingFunction.prefixGauge_le_of_all_kyFan_le_hetero` forward, and `kyFanNormingFunction` / `kyFanNormingFunction_gauge` / `all_kyFan_le_of_every_ext_finiteGaugeendedGauge_le` / `all_mul_kyFan_le_of_every_symmetricNorming_gauge_le` converse, all axiom-clean and resolving from `DavisKahan.All`.  Every declaration listed on this row is `[propext, Classical.choice, Quot.sound]`.
...
**importance:** `headline`  **section:** 2  **source:** Section 2, tan theta theorem  **kind:** unnumbered_theorem  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** One-sided spectral separation plus the Rayleigh–Ritz/off-diagonal condition gives residual and perturbation tangent bounds in every unitary-invariant norm.
...
- `TauCeti.DavisKahan1970.secantSquared`
- `TauCeti.DavisKahan1970.tanBlockRepresentative`
- `TauCeti.DavisKahan1970.tanBlockRepresentative_mul_self`
- `TauCeti.DavisKahan1970.directedTanAngleOperatorC_eq_modulus_blockRepresentative`
- `TauCeti.DavisKahan1970.gramOperator_lowerCorner_moebius`
- `TauCeti.DavisKahan1970.approximationNumber_lowerCorner_le`
...
- `TauCeti.DavisKahan1970.tanTheta_directed_bounded_symmetricNorming_real`
- `TauCeti.DavisKahan1970.tanTheta_ambient_bounded_symmetricNorming_complex_of_crossedDefects`
- `TauCeti.DavisKahan1970.tanTheta_ambient_bounded_kyFan_complex_of_crossedDefects`
...
- `TauCeti.DavisKahan1970.tanTheta_directed_bounded_perturbation_symmetricNorming_real`
- `TauCeti.DavisKahan1970.theorem63ResidualReal_eq_neg_of_invariant`
- `TauCeti.DavisKahan1970.approximationSingularValue_theorem63ResidualReal_le_of_invariant`
...
**THE AMBIENT `Theta` HALF IS PROVED, 2026-08-09 (Claude Opus 5), at arbitrary Hilbert-space dimension and every unitarily invariant norm.**  `DavisKahan/Sources/DavisKahan1970/TanThetaAmbient.lean` (default build through `DavisKahan.Sources.DavisKahan1970.All`, every new declaration `[propext, Classical.choice, Quot.sound]`).

`tanTheta_ambient_bounded_kyFan_complex_of_transversality`: for `T` symmetric with `T.Reduces V`, `A` self-adjoint with `U` invariant for `A`, the Theorem 6.3 form gap (`re <compression of T to U> <= alpha` and `(alpha + delta) ||y||^2 <= re <T y, y>` on `V-perp`), and uniform transversality `||sinAngleOperatorC U V|| < 1`, one has `delta * kyFan_k (tanAngleOperatorC U V) <= kyFan_k (T - A)` for every `k`.  `tanTheta_ambient_bounded_symmetricNorming_complex_of_transversality` is the source form `delta * N (tan Theta) <= N (H)` for every `SymmetricNormingFunction`, with the membership conclusion `N.Mem (tan Theta)` supplied rather than assumed.  Arbitrary complete complex Hilbert space; no dimension, compactness, or separability hypothesis anywhere; the trial subspace `U` is arbitrary.
...
(b) The equisingularity identity `TauCeti.modulus_comp_left_cfc` / `modulus_polarPartial_comp_cfc_modulus` is likewise not used.  The proof builds the off-diagonal representative EXPLICITLY instead of factoring the paper's `J_0 tan Theta_0` through a polar partial isometry.  With `p = P_U`, `D = P_V - P_U` and `s = D^2` (`= sin^2 Theta`), `tanBlockRepresentative U V = ((1-p) D p + p D (1-p)) (1 - s)^{-1}`, and `directedTanAngleOperatorC_eq_modulus_blockRepresentative` proves `|tanBlockRepresentative U V| = tan Theta` -- equality of MODULI, not of singular-value lists, so the substitution is legitimate inside every unitarily invariant norm.  The only geometric input is the two-projection relation `D p + p D + D^2 = D` (`twoProjection_anticommutator`), from which `offDiagonal_sq` gives `((1-p) D p + p D (1-p))^2 = D^2 - D^4 = sin^2 Theta cos^2 Theta`.
...
the real-scalar axis and did not record that the ambient half `tanTheta_ambient_bounded_symmetricNorming_complex_of_transversality` carries
...
**THE AMBIENT TRANSVERSALITY HYPOTHESIS IS GONE, 2026-08-10 (Claude Opus 5, coordinator-verified).**  `||sin Theta|| < 1` is NO LONGER A HYPOTHESIS of the ambient `tan Theta` endpoints: `tanTheta_ambient_bounded_symmetricNorming_complex_of_crossedDefects` and `tanTheta_ambient_bounded_kyFan_complex_of_crossedDefects` derive it, with real twins in `DirectedReal.lean`.  This closes the audit finding at `dev/davis-kahan-1970-final-audit-2026-08-09.md:516-517`.
...
WHAT ACTUALLY WORKED, needing NO new mathematics: `approximationSingularValue_sineBlock_lt_one_infiniteTrial` (`DavisKahan/TanTheta/Theorem63InfiniteTrial.lean:378`) already bounds the directed sine block below one from the tangent theorem's OWN form bounds, dimension-free.  Chain: directed estimate at index 0, then `approximationNumber_index_zero`, giving `||directedSineAmbient U V|| < 1` which IS `directedGap U V < 1` by definition, then the (3.5) geometry `subspaceGap_eq_directedGap_of_crossedDefectsEquivalent`, then `norm_sinAngleOperatorC`.

UNEXAMINED AND LIKELY THE SAME: whether the whole-space `tan 2Theta` and `sin 2Theta` endpoints carry the same removable hypothesis.  Candidates measured 2026-08-10: `tanTwoTheta_ambient_bounded_orderedForm_kyFan_complex` and `tanTheta_ambient_bounded_symmetricNorming_complex_of_transversality` (`TanTwoThetaWholeSpace.lean:1426, :1495`), `sinTwoTheta_ambient_bounded_kyFan_complex` and `sinTwoTheta_ambient_bounded_symmetricNorming_complex` (`SinTwoThetaWholeSpace.lean:350, :372`), and the branch-free pair in `TanTwoThetaAmbientBranchFree.lean:206, :259`.  If the same wiring applies it would close hypotheses on further rows.

**THIS ROW CONTRADICTED ITSELF, AND THE CONTRADICTION COST A MISSION'S FRAMING.  Recorded so the pattern is visible.**  On 2026-08-10 the coordinator scoped a mission from this row's `next_action`, which read `REAL SCALARS, DIRECTED HALF ONLY`.  The same row's `scope_gap` already said, in capitals, `THE REAL-SCALAR AXIS IS NOW CLOSED FOR BOTH HALVES`, and named `tanTheta_directed_bounded_symmetricNorming_real` (`DirectedReal.lean:418`) as the closing declaration.  The coordinator had even cited that declaration in the brief as background while framing the endpoint as missing.  LESSON, general: these fields go stale INDEPENDENTLY, nothing cross-checks them, and NO GATE READS ANY OF THEM -- `probe_census_declarations.py` only checks the declarations a row NAMES.  Read `status`, `blocked_by`, `scope_gap`, `next_action` AND the tail of `notes` together before scoping from a row; when they disagree the newest dated statement wins and the others are the bug.

The mission was salvaged rather than wasted: it landed the two orientations that genuinely did NOT exist -- the real SPECTRAL orientation (`tanTheta_directed_bounded_spectralGap_symmetricNorming_real`, the real twin of `tanTheta_directed_bounded_spectralGap_symmetricNorming_complex`, with the spectral-to-form conversion done NATIVELY over `R` by `SpectralOrder.Real.upperFormBoundOn_top_of_spectrum_subset_Iic` and `lowerFormBoundOn_of_restriction_spectrum_subset_Ici`, so NO complexification was needed) and the real PERTURBATION companion, which existed at no scope.  The conjugation route the `next_action` prescribed was never needed: it had already been done by an earlier session and sits in `DirectedReal.lean:82-182`.
...
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_unbounded_addBounded_blockRepresentative_symmetricNorming_real`
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_unboundedReflectionResidual_blockRepresentative_symmetricNorming_real`
- `TauCeti.DavisKahan.sinTwoTheta_addBounded_gauge_real`
- `TauCeti.DavisKahan.sinTwoTheta_reflectionResidual_gauge_real`
- `TauCeti.DavisKahanExt.sinTwoTheta_perturbation`
...
- `TauCeti.DavisKahan1970.norm_sinTwoThetaBlock_real`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_perturbation_opNorm_real`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_reflectionResidual_opNorm_real`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_reflectionResidual_arbitraryRepresentative_unequalDimension_complex`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_unequalDimension_real`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_reflectionResidual_arbitraryRepresentative_unequalDimension_real`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_unequalDimension_complex`
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_unboundedResidual_blockRepresentative_kyFan_complex`
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_unboundedResidual_blockRepresentative_symmetricNorming_complex`
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_unboundedResidual_blockRepresentative_kyFan_real`
...
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_boundedResidual_blockRepresentative_symmetricNorming_complex`
...
- `TauCeti.DavisKahan1970.sinTwoTheta_reflectionResidual_block_gauge_reducing_rclike`
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_unboundedResidual_blockRepresentative_reducing_kyFan_rclike`
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_unboundedResidual_blockRepresentative_reducing_symmetricNorming_rclike`
- `TauCeti.DavisKahan1970.sinTwoTheta_directed_unboundedResidual_reducing_symmetricNorming_rclike`
...
* `sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_complex` -- the PERTURBATION form, `delta * N(sin 2Theta_0) <= 2 * N(E)`, sharp factor two;
* `sinTwoTheta_unbounded_reflectionResidual_arbitraryRepresentative_complex` -- the RESIDUAL form, `delta * N(sin 2Theta_0) <= N(R)`, constant one.
...
* `TauCeti.DavisKahan1970.sinTwoTheta_ambient_bounded_symmetricNorming_complex` and its Ky Fan core `TauCeti.DavisKahan1970.sinTwoTheta_ambient_bounded_kyFan_complex` (`DavisKahan/Sources/DavisKahan1970/SinTwoThetaAmbient.lean`, default build, `[propext, Classical.choice, Quot.sound]`).
...
* `TauCeti.DavisKahan1970.sinTwoTheta_directed_unbounded_addBounded_blockRepresentative_symmetricNorming_real` and `TauCeti.DavisKahan1970.sinTwoTheta_directed_unboundedReflectionResidual_blockRepresentative_symmetricNorming_real` -- at `SymmetricNormingFunction`, the SAME norm class as the real ambient half `sinTwoTheta_ambient_bounded_symmetricNorming_real`;
* `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_real` and `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_reflectionResidual_arbitraryRepresentative_real` -- the literal-source forms with the paper's `sin 2Theta_0` REPRESENTATIVE freedom, at `KyFanDominantIdealFamily (R)`, the exact scalar mirror of the two complex literal-source theorems listed above;
* `TauCeti.DavisKahan.sinTwoTheta_addBounded_gauge_real` and `TauCeti.DavisKahan.sinTwoTheta_reflectionResidual_gauge_real` (`DavisKahan/DoubleAngle/RealUnboundedIdeal.lean`) -- the cores.

All six are in the DEFAULT build (`DavisKahan.All`) and all give exactly `[propext, Classical.choice, Quot.sound]`.

THE ROUTE WAS NOT THE ONE THIS ROW'S `next_action` PRESCRIBED, and the reason is recorded because the prescribed route is genuinely blocked.  `next_action` said: complexify the configuration, instantiate the complex theorem at each finite Ky Fan family, finish with `SymmetricNormingFunction.mul_gauge_le_of_all_mul_kyFan_le`.  That works for a BOUNDED configuration (it is how `S2-tan-two-theta` closed), but the directed `sin 2theta` endpoints take an UNBOUNDED self-adjoint `LinearPMap` and its spectral subspaces, and transporting THOSE needs, on top of the subspace adapter, (i) an identification of `selfAdjointSpectralRestriction (complexify A)` with a unitary conjugate of `complexify (realSelfAdjointSpectralRestriction A)` as CLOSED operators, and (ii) a transport of the spectral-separation hypotheses, which are stated over `TauCeti.LinearPMap.spectrum` and hence exist only over `C`.  Neither is available.
...
THE ONE REAL-SCALAR SPELLING STILL ABSENT, recorded so it is not counted as present: there is no real unbounded OPERATOR-NORM directed statement in the shape of `sinTwoTheta_addBounded_of_spectrum_gap`, i.e. one whose conclusion names a real `sin 2Theta` angle operator rather than the block `sinTwoThetaIdealBlock`.  The estimate itself is available -- read `sinTwoTheta_addBounded_gauge_real` at `KyFanDominantIdealFamily.kyFan 1` -- but converting the block to an angle operator needs the real counterpart of `norm_sinTwoThetaIdealBlock_complex`, which rests on `directedSinTwoAngleOperatorC`.  This is a naming/geometry step, not analysis.

**THE SCALAR AXIS IS NOW CLOSED WITHOUT RESIDUAL, 2026-08-09 (Claude Opus 5, M34); `real-scalar-infinite-dimensional-scope` REMOVED from this row.**  The single item for which the blocker reference was deliberately retained above -- "no real unbounded OPERATOR-NORM statement whose conclusion names a real `sin 2Theta` angle operator exists, because the block-to-angle identification `norm_sinTwoThetaIdealBlock_complex` is stated over `directedSinTwoAngleOperatorC`" -- is discharged.  The missing geometric renaming is `norm_sinTwoThetaIdealBlock_real` (`DavisKahan/DoubleAngle/RealAngleIdentification.lean`): `||sinTwoThetaIdealBlock U V|| = ||sinTwoAngleOperatorR U V||` for a pair of closed subspaces of an arbitrary real Hilbert space.

HOW IT DESCENDS, and why no `Submodule.map` complexification was needed.  `sinTwoThetaIdealBlock_eq_comp` rewrites the canonical block `P_U . P_{J_V U^perp}` as the map-free composition `P_U . J_V . P_{U^perp} . J_V`, SCALAR-GENERICALLY over `RCLike`, using `starProjection_map_unitary` (already generic) and `Submodule.reflection_symm`.  Every factor of that composition already had a complexification identity -- `starProjection_complexifySubmodule`, `starProjection_complexifySubmodule_orthogonal`, and the pre-existing `complexify_reflectionOperator` of `DavisKahan/Geometry/Polar/DirectRotationReal.lean`, which was found only after a duplicate of it collided in `DavisKahan.All` -- so `complexify_sinTwoThetaIdealBlock` is immediate.  The remaining step is purely complex: `norm_sinTwoAngleOperatorC_eq_norm_directedSinTwoAngleOperatorC` shows that the two complex spellings of `sin 2Theta` (the product form `2 sinTheta cosTheta` behind `directedSinTwoAngleOperatorC`, and the functional calculus `sin(2 .)` of the operator angle behind `sinTwoAngleOperatorC`) have the same NORM, because each equals the projection gap between `U` and its reflection through `V`: the second by `directedSinTwoAngleOperatorC_eq_modulus_starProjection_sub` with `ContinuousLinearMap.norm_modulus`, the first by `subspaceGap_map_reflection_eq_norm_sinTwoAngle`.

The two printed operator-norm conclusions over a real Hilbert space follow by reading the real Ky-Fan-dominant theorems at the first Ky Fan family (`KyFanDominantIdealFamily.kyFan 1`, whose gauge is `kyFanApproximationGauge 1 = ||.||`) and renaming the block.  `sinTwoTheta_unbounded_perturbation_opNorm_real` is `delta ||sin 2Theta|| <= 2||E||` and `sinTwoTheta_unbounded_reflectionResidual_opNorm_real` is `delta ||sin 2Theta|| <= ||R||`, both for an unbounded self-adjoint closed operator on a real Hilbert space of arbitrary dimension with genuine real spectral subspaces and the scalar-generic `FormBoundedSylvesterGap` separation.  All seven new declarations are axiom-clean `[propext, Classical.choice, Quot.sound]` and reached from `DavisKahan.All`.
...
MEASURED: `sinTwoTheta_unbounded_reflectionResidual_arbitraryRepresentative_unequalDimension_complex` is the SAME STATEMENT as `sinTwoTheta_unbounded_reflectionResidual_arbitraryRepresentative_complex` plus ONE EXTRA HYPOTHESIS, and its entire proof is `exact` applied to that sibling.  The extra hypothesis is bound as `_hStrictDimension` -- AN UNDERSCORE BINDER, hence UNUSED.  So the wrapper is strictly WEAKER than its base (more hypotheses, identical conclusion).
...
This resolves the contradiction introduced by the later 2026-08-10 audit paragraph claiming that those wrappers could not close the row without an ambient bridge.  That paragraph implicitly required an object the source does not have under strict dimension.  The row therefore moves to `compiled_exact`; no mathematical or scalar-scope obligation remains. Complex source-norm wrapper added 2026-08-29: `sinTwoTheta_directed_unbounded_addBounded_blockRepresentative_symmetricNorming_complex` completes the pair with `sinTwoTheta_directed_unbounded_addBounded_blockRepresentative_symmetricNorming_real`. It takes the spectrum-gap hypotheses, which is what the complex ideal-level route provides, where the real route uses `FormBoundedSylvesterGap`. **Ideal-level angle transport proved 2026-08-29.** The unbounded theorems concluded about `sinTwoThetaIdealBlock`, and the only bridge to an angle operator was `norm_starProjection_reflectedComplementary_eq_sinTwoAngle`, an equality of OPERATOR NORMS, which says nothing in any other unitarily invariant norm. The bridge now holds as an operator identity: `directedSinAngleOperatorC U (reflectedU U V) = directedSinTwoAngleOperatorC U V`, i.e. the directed sine of the angle between U and its V-reflection IS the sine of twice the angle between U and V. The proof is one ring identity, `p r p r p = 4t^2 - 4t + p` with r = 2q - 1 and t = pqp, needing only p^2 = p: both sides square to 4(t - t^2) and both are nonnegative, so the positive square roots agree. Consequently the block and the angle operator have the same approximation numbers, hence the same membership and gauge in EVERY symmetric ideal family, and `sinTwoTheta_directed_unbounded_addBounded_symmetricNorming_complex` is the unbounded theorem read on `2 sin Theta cos Theta`. Scope note: this is the DIRECTED double-angle operator, and the distinction from the ambient one is a multiplicity. `sinTwoThetaIdealBlock U V = P_U P_{W-perp}` is one-sided, so it carries each principal angle once, which is what the directed `directedSinTwoAngleOperatorC` does. The ambient spelling `sinTwoAngleOperatorC U V` is `|R_V P_U R_V - P_U|` (`directedSinTwoAngleOperatorC_eq_modulus_reflect`), built like every paper angle object on the ambient sine |P_U - P_V|, so it carries every angle TWICE. The two are therefore different operators, equal in operator norm but not in gauge generally, and the transport here is correctly stated for the directed one. Contrast `S2-tan-two-theta`, where the block IS two-sided and the ambient paper object is the right partner. **Real transport added 2026-08-30.** `norm_sinTwoThetaIdealBlock_real` gave the real block-to-angle identification at the operator norm only -- one number. `approximationSingularValue_sinTwoThetaIdealBlock_real` gives every approximation singular value, which is what a symmetric ideal reads, by the route the norm identification already used: complexification preserves approximation singular values, the real block complexifies to the complex block of the complexified pair, and the complex transport applies there. The target is `Real.directedSinTwoAngleOperatorRC`, the DIRECTED double-angle sine of the real pair read in the complexification, which is where the tree keeps it -- there is no real directed spelling, only the ambient `sinTwoAngleOperatorR`. Turning this into an equality of real SymmetricNormingFunction gauges would need a real directed sin 2Theta operator; that would be a second spelling of an existing concept and is deliberately not introduced. **Real angle-operator endpoint, 2026-08-30.** `sinTwoTheta_directed_unbounded_addBounded_symmetricNorming_real` states the real bounded-perturbation theorem on the directed double-angle sine of the real pair instead of on `sinTwoThetaIdealBlock`. The transport is `extendedGauge_sinTwoThetaIdealBlock_real`, the gauge form of the approximation-number identity: the two operators live over different scalar fields -- the block is real, the angle is read in the canonical complexification where this development keeps the real double-angle operators -- so the equality is chained through `extendedGauge_complexify` rather than through the same-field `gauge_eq_of_sameApproximationSingularValues`. The ambient real spelling `sinTwoAngleOperatorR` is deliberately not the target: it carries each principal angle twice where the one-sided block carries it once. **Canonical Section 2 inventory, 2026-08-30.** `DavisKahan/Sources/DavisKahan1970/SectionTwo.lean` is the public inventory of the paper's four unnumbered headline theorems over both scalar fields: `TauCeti.DavisKahan1970.SectionTwo.{sinTheta_complex, tanTheta_complex, sinTwoTheta_complex, tanTwoTheta_complex}` and their `_real` siblings. The unqualified `SectionTwo.{sinTheta, tanTheta, sinTwoTheta, tanTwoTheta}` are reserved by a standing rule: a short name is bound only to a declaration that is BOTH scalar-generic over `RCLike` AND at the printed source scope, and is left unbound otherwise. Which of the four currently satisfy that is a property of the Lean file, and `SectionTwo.lean` is where it is recorded; this note deliberately does not restate it, because a copy of a moving fact goes stale silently -- this sentence itself did. They are `alias`es, so each carries exactly the type of the declaration it names -- unbounded self-adjoint `LinearPMap` ambient operator, arbitrary Hilbert dimension, a `SymmetricNormingFunction`, both printed conclusions, no capability class, no finite-dimensional hypothesis, no proof vehicle in the conclusion. `SectionTwoUsage.lean` calls each from ordinary operator-theory hypotheses, so the advertised entry points are compiler-checked to be reachable without building Sylvester witnesses, reflection blocks, or spectral reflections by hand. The scalar-generic presentation forms, directed and whole-space variants, finite specializations, operator-norm statements and bundled-problem entry points are unchanged and remain registered separately. GAP SCOPE DOWNGRADED 2026-08-31, on review. The source inventory attaches the half-infinite gap-interval scope to this result, and the real endpoint `sinTwoTheta_directed_unbounded_addBounded_symmetricNorming_real` genuinely carries it: it takes `FormBoundedSylvesterGap`, whose two semibounded constructors are that scope. The COMPLEX endpoint `sinTwoTheta_directed_unbounded_addBounded_symmetricNorming_complex` does not. It requires finite `beta <= alpha` with the selected restriction semibounded both below and above and the complement avoiding `(beta-delta, alpha+delta)` -- a bounded interval. So the complex half of this row was certified beyond what it proves.

THE MISSING THEOREM, exactly: a complex Paper-UI endpoint taking `hgap : FormBoundedSylvesterGap (selfAdjointSpectralRestriction A hA B hB) (selfAdjointSpectralRestriction A hA Bcompl hB.compl) delta`. It is NOT the one-line bridge the sine case was. Traced: the complex chain runs `..._symmetricNorming_complex` -> `..._blockRepresentative_symmetricNorming_complex` -> `sinTwoTheta_reflectionResidual_block_gauge_of_spectrum_gap` -> `sinTheta_addBounded_gauge_block_of_spectrum_gap` -> `sinTheta_unbounded_gauge_of_spectrum_gap` -> `sinTheta_unbounded_gauge`, and that analytic core consumes the interval as `TwoSidedShiftedInverseBound D.Lambda1 ((alpha+beta)/2) ((alpha-beta)/2 + delta)` -- a centre and a radius, which the semibounded branches of `FormBoundedSylvesterGap` do not have. The real route reaches the full gap through a different engine, `sinTwoTheta_reflectionResidual_gauge_real`. Closing the complex side means either giving the complex reflection-residual engine a full-gap route of the kind the real one has, or generalizing `sinTheta_unbounded_gauge` past the centred interval. Until one of those lands, the complex half of this result is a bounded-interval specialization and this row must not be read as full source scope.
...
**importance:** `headline`  **section:** 2  **source:** Section 2, tan 2 theta theorem  **kind:** unnumbered_theorem  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Fully off-diagonal perturbations across an ordered gap give residual and perturbation tan(2 Theta) bounds with factor two.
...
- `TauCeti.DavisKahan1970.tanTwoTheta_branchFree_prefix_arbitrarySubspace`
- `TauCeti.DavisKahan1970.tanTwoTheta_branchFree_idealFamily_complex`
...
- `TauCeti.DavisKahan1970.tanTwoBlockRepresentative_lowerBlock`
...
- `TauCeti.DavisKahan1970.tanTwoTheta_ambient_bounded_branchFree_kyFan_complex_of_corner`
- `TauCeti.DavisKahan1970.tanTwoTheta_ambient_bounded_branchFree_symmetricNorming_complex_of_corner`
- `TauCeti.DavisKahan1970.tanTwoTheta_ambient_bounded_branchFree_orderedForm_kyFan_complex`
- `TauCeti.DavisKahan1970.tanTwoTheta_ambient_bounded_branchFree_orderedForm_symmetricNorming_complex_of_poleExclusion`
- `TauCeti.DavisKahan1970.tanTwoTheta_directed_boundedResidual_branchFree_blockRepresentative_kyFan_complex`
- `TauCeti.DavisKahan1970.tanTwoTheta_directed_boundedResidual_branchFree_blockRepresentative_symmetricNorming_complex`
...
- `TauCeti.DavisKahan1970.projectionBlock_complexifySubmodule_real`
- `TauCeti.DavisKahan1970.tanTwoTheta_directed_boundedResidual_blockRepresentative_spectralGap_symmetricNorming_real`
- `TauCeti.DavisKahan1970.absTanTwoAngleOperatorC_eq_modulus_directedTanTwoAngleOperatorC`
...
SOURCE-FACING CLOSURE 2026-08-12: the Section 2 `tan 2 Theta` theorem now has exact source-facing wrappers for both printed conclusions and for both complex and real Hilbert spaces. `tanTwoTheta_directed_boundedResidual_blockRepresentative_spectralGap_symmetricNorming_complex` upgrades the branch-free Section 7 directed Ky Fan estimate to every `SymmetricNormingFunction` and derives `cos (2 theta) != 0` internally from the printed ordered spectral gap and `H_0 = H_1 = 0`; it states the sharp residual conclusion `delta * N(tan(2 Theta_0)) <= 2 * N(R)` on the canonical directed projection-block representative. `tanTwoTheta_directed_boundedResidual_blockRepresentative_spectralGap_symmetricNorming_real` transports this exact source statement to real Hilbert spaces using the same canonical complexification convention already used by `sourceDirectedAngleR`, while the residual norm is descended to the real projection block. The ambient half is independently closed by `tanTwoTheta_ambient_bounded_spectralGap_symmetricNorming_complex` and `tanTwoTheta_ambient_bounded_spectralGap_symmetricNorming_real`, with `absTanTwoAngleOperatorC_eq_modulus_directedTanTwoAngleOperatorC` connecting the branch-free positive representative to the literal signed functional-calculus tangent. Neither exact endpoint assumes a quarter branch, explicit pole exclusion, nor perturbed-Q-block spectral placement. A semantic search before adding the directed wrapper found no existing source-facing theorem with this exact signature hidden elsewhere; the nearest declarations were the explicit-`hcos` Ky Fan corner specialization, the graph-coordinate real branch-free theorem, and the already-closed ambient theorem.

INDEPENDENT AUDIT CORRECTION 2026-08-12: this row was downgraded from `compiled_exact`. The source theorem does not assume quarter-pole exclusion or perturbed-block spectral placement. The registered `tanTwoTheta_ambient_bounded_branchFree_orderedForm_symmetricNorming_complex_of_poleExclusion` still takes `hcos` explicitly, while the graph-coordinate branch-free theorem has extra representation data. Those are useful compiled specializations, not yet the literal ambient Section 2 wrapper.

The finite operator-norm theorem is compiled. The source arbitrary-UI-norm Hilbert-space endpoint and branch selection are not yet certified.
...
* `TauCeti.DavisKahan1970.tanTwoTheta_branchFree_bounded_symmetricNorming_complex` -- ℂ;
* `TauCeti.DavisKahan1970.tanTwoTheta_branchFree_bounded_symmetricNorming_real` -- ℝ.
...
**ONE THING A LATER AUDITOR SHOULD KNOW, NOT A NEW GAP.**  Like every declaration already on this row, the new endpoints are the PERTURBATION form `2 · N(H)`, not the residual form `2 · N(R)` of the printed (DK-tan2).  That was already true of `tanTwoTheta_branchFree_bounded_finiteSubspace_symmetricNorming_rclike`, and the 2026-08-07 audit recorded the finite-dimensional trial subspace as the row's ONLY remaining axis, so closing it closes the row on the recorded evidence.  If a future audit wants the residual form as a separate axis, it should be opened as its own scope note rather than folded in here.
...
Verified by elaboration, not by grep.  `tanTwoTheta_principalBranch_finiteDimensional_uiNorm_rclike` concludes
`(b - a) * N tanTwoTheta0 <= 2 * N H` under `[FiniteDimensional k E]`, and
`tanTwoTheta_principalBranch_finiteSubspace_idealFamily_rclike` concludes the same gauge inequality under
...
`directedTanTwoAngleOperatorC` is built on `directedSinTwoAngleOperatorC := 2 . (|P_Vperp P_U| . |P_V P_U|)`,
...
during this campaign (`sinTwoTheta_ambient_bounded_symmetricNorming_complex` 2026-08-08,
`tanTheta_ambient_bounded_symmetricNorming_complex_of_transversality` 2026-08-09).  When a census row covers a
...
New module `DavisKahan/Sources/DavisKahan1970/TanTwoThetaAmbient.lean`; the
ambient object itself is added to `DavisKahan/Geometry/Angle/TanAngleFunctionalCalculus.lean`.
...
THE REPRESENTATIVE.  `tanTwoBlockRepresentative U V :=
paperDiagonalPair Uperp U (2 * (D * (1 - 2 D^2)^{-1}))` with `D = P_V - P_U`, and
`directedTanTwoAngleOperatorC_eq_modulus_blockRepresentative` proves
...
ENDPOINTS.
* `tanTwoTheta_ambient_bounded_orderedForm_kyFan_complex`:
  `(b - a) * kyFan_k (tanTwoAngleOperatorC U V) <= 2 * kyFan_k H`, every `k`.
* `tanTwoTheta_ambient_bounded_orderedForm_symmetricNorming_complex`:
  `N.Mem H -> N.Mem (tan 2Theta) /\ (b - a) * N.gauge (tan 2Theta) <= 2 * N.gauge H`
  for every `SymmetricNormingFunction`.  Boundedness of `tan 2Theta` is
...
`tanTwoTheta_directed_boundedResidual_blockRepresentative_kyFan_complex`:
...
identity `tanTwoBlockRepresentative_lowerBlock` says the lower corner of the
...
(`tanTwoAngleOperatorC`, `tanTwoTheta_ambient_bounded_orderedForm_kyFan_complex`,
`tanTwoTheta_ambient_bounded_orderedForm_symmetricNorming_complex`), with the real form at `b967c62f`.  Re-verified here by
elaboration: `tanTwoTheta_ambient_bounded_orderedForm_symmetricNorming_complex` concludes
`(b - a) * N.gauge (tanTwoAngleOperatorC U V) <= 2 * N.gauge H` for every
`SymmetricNormingFunction`, on an arbitrary complete complex Hilbert space, with NO
...
* `TauCeti.DavisKahan1970.absTanTwo_sq_mul_cos_two_sq` and
  `TauCeti.DavisKahan1970.absTanTwoAngleOperatorC_eq_modulus_blockRepresentative` --
...
* `TauCeti.DavisKahan1970.tanTwoTheta_ambient_bounded_branchFree_kyFan_complex_of_corner` and
  `TauCeti.DavisKahan1970.tanTwoTheta_ambient_bounded_branchFree_symmetricNorming_complex_of_corner` -- THE REDUCTION.
  Given only `cos 2theta != 0` and the printed residual estimate on the directed corner,
  `delta * N (|tan 2Theta|) <= 2 * N H` for every `SymmetricNormingFunction`, on an
...
No statement already on this row changed.  `tanTwoTheta_ambient_bounded_orderedForm_kyFan_complex` and
`tanTwoTheta_ambient_bounded_orderedForm_symmetricNorming_complex` are now DERIVED from the reduction, and the private
...
**M30 CLOSED 2026-08-09 (GPT-5.6 Sol): THE BRANCH-FREE AMBIENT HALF IS NOW THE INTEGRATED SOURCE PATH.**  `DavisKahan/Sources/DavisKahan1970/TanTwoThetaReflectionAmbient.lean` supplies the missing directed-corner estimate directly from the Section 7 reflection equation, using approximate leading singular families of the actual tangent corner, signed-cosine polar isometries, the corrected Gram identities, and the magnitude Ky Fan variational theorem.  The public chain is `tanTwoTheta_directed_boundedResidual_branchFree_blockRepresentative_kyFan_complex`, `..._upper`, `tanTwoTheta_ambient_bounded_branchFree_orderedForm_kyFan_complex`, and `tanTwoTheta_ambient_bounded_branchFree_orderedForm_symmetricNorming_complex_of_poleExclusion`.  The lower-to-upper residual transport is only adjoint/Ky-Fan invariance, so it introduces no second factor two: the sharp factor `2` still comes exactly once from the two residual pairings in equation (7.6).  The whole-space endpoint reuses `tanTwoTheta_wholeSpace_*_of_corner`; no ambient Lemma-6.1 machinery is duplicated.  No `IsQuarterAcute` hypothesis or graph-coordinate spectral rearrangement is used.  The module is imported by `DavisKahan.Sources.DavisKahan1970.All`, so these declarations are now part of `DavisKahan.All` and are compiler-probed by this row.

DECLARATION LIST COMPLETED 2026-08-09 (Claude Opus 5, integrating M30).  The M30 upgrade to `compiled_exact` is substantively justified -- the branch-free ambient endpoints carry no finite-dimensionality hypothesis, and the off-diagonal conditions `hHU`/`hHUperp` on `H` are the paper's own Section 7 residual form and predate M30 throughout `TanTwoThetaWholeSpace.lean` -- but it was recorded WITHOUT NAMING THE TWO DECLARATIONS THAT JUSTIFY IT.  The row already listed the branch-carrying and `_of_corner` whole-space endpoints; what it did not list were `tanTwoTheta_ambient_bounded_branchFree_orderedForm_kyFan_complex` and `tanTwoTheta_ambient_bounded_branchFree_orderedForm_symmetricNorming_complex_of_poleExclusion`, which are precisely the ones that close the gap the previous `scope_gap` named.  The census gate therefore had nothing to disagree with -- the omitted-declaration failure documented in the header of `scripts/probe_census_declarations.py`, whose own example is an earlier instance on this same row.  Both are now listed; both resolve from `DavisKahan.All` and are `[propext, Classical.choice, Quot.sound]`, as are the two directed corner endpoints M30 rewrote. **Subspace-first interface added 2026-08-29.** The ambient form asked its caller for a reflection Z together with four facts. Two of them, self-adjointness and Z^2 = 1, are not hypotheses at all: a subspace determines its reflection and the reflection has both by construction. `ReflectionIntertwines A B V` carries only the two that are mathematics -- the reflection preserves A's domain and commutes with A + B on it -- and `tanTwoTheta_ambient_unbounded_blockRepresentative_derivedReflection_symmetricNorming_complex` takes the reducing subspace, builds Z = V.reflectionOperator internally, and supplies the two structural facts itself. Not internalized: the conclusion still names `unboundedReflectionTangent`, the block tangent, rather than the paper's canonical double-angle tangent; bringing it across needs the tan-2Theta analogue of `sinTwoThetaIdealBlock_hasSameApproximationNumbers`, which is not proved. **What the tangent block is, and its transport, proved 2026-08-29/30.** The unbounded theorems concluded about `unboundedReflectionTangent U Z = S (C^2)^{-1} C`, with C and S the diagonal and off-diagonal blocks of a self-adjoint involution relative to U + U-perp. Two elementary identities, both Z* = Z and Z^2 = 1 read on and off the diagonal, are `C^2 + S^2 = 1` and `C S + S C = 0`; the anticommutation makes S^2 commute with C and hence with (C^2)^{-1}, and the Gram computation collapses to `T*T = S^2 (1 - S^2)^{-1}` -- the diagonal block cancels entirely, so the tangent is a function of S alone. `starProjection_offDiagonal_sq_reflection` identifies the U block of S^2 for the reflection as (sin 2Theta)^2. **The transport to the paper's tangent then holds, contrary to what this row said on 2026-08-29.** For the reflection, `unboundedReflectionTangent U J_V = tanTwoBlockRepresentative U V * J_U`: the tangent's (C^2)^{-1} C factor carries the signed doubled cosine 1 - 2(P_V - P_U)^2, which is exactly what the block representative's secant inverts, and the reflection J_U is what is left over. J_U is a self-adjoint unitary, so the two have the same approximation numbers, and `absTanTwoAngleOperatorC_eq_modulus_blockRepresentative` closes the chain to the paper's ambient |tan 2Theta|. Hence equal gauge and membership in every SymmetricNormingFunction, and `tanTwoTheta_ambient_unbounded_symmetricNorming_complex` is the unbounded theorem on the paper object. The extra hypothesis is the paper's own cos 2theta != 0, which is what makes tan 2Theta bounded at all. **The retracted claim, recorded so the mistake is not repeated:** this row previously said the transport could not hold because `absTanTwoAngleOperatorC` is supported on U alone while the tangent has both off-diagonal blocks. That was wrong. `angleOperatorC` is `cfc arcsin (sinAngleOperatorC U V)` built on the AMBIENT sine |P_U - P_V|, so the paper's |tan 2Theta| carries every principal angle twice -- the same multiplicity as the two-sided tangent. The error was reading the ambient angle object as the directed one. **Pole hypothesis removed from the public statement, 2026-08-30.** `tanTwoTheta_ambient_unbounded_symmetricNorming_complex` previously asked its caller for `cos (2 t) != 0` on the angle spectrum. That is not an independent Section 2 assumption: the ordered gap already forces the reflection's diagonal block to be invertible, which is the first component of `tanTwoTheta_ambient_unbounded_blockRepresentative_derivedReflection_symmetricNorming_complex`, and `C = J_U (1 - 2 (P_V - P_U)^2)` with `J_U` a unit, so a unit `C` is a unit signed doubled cosine. `isUnit_signedCosTwo_of_isUnit_diagonalPart_sq` and `cos_two_ne_zero_of_isUnit_diagonalPart_reflection_sq` are the two-step bridge, factored in the generic reflection layer rather than inlined in the source wrapper; the second composes with the pre-existing `cos_two_ne_zero_of_isUnit_one_sub_two_mul_projectorDifference_sq`. **Real endpoints, 2026-08-30.** `tanTwoTheta_ambient_unbounded_blockRepresentative_derivedReflection_symmetricNorming_real` and `tanTwoTheta_ambient_unbounded_symmetricNorming_real` mirror the cleaned complex API over a real Hilbert space, concluding on the new real ambient `absTanTwoAngleOperatorR` -- the real member of the existing family of `realPartOperator`-of-`cfc` paper angle operators. The transport `extendedGauge_unboundedReflectionTangent_real` descends through the complexification, with no second analytic proof and no loss of constant or norm class. **`ReflectionIntertwines` moved and generalized, 2026-08-30.** It was `TauCeti.DavisKahan1970.ReflectionIntertwines`, complex-only; it is now `TauCeti.DavisKahan.ReflectionIntertwines`, scalar-generic, beside `UnboundedRitzPair` and `ReducingComplement`, and it gains `ofReducesSubspace`: a caller holding `TauCeti.LinearPMap.ReducesSubspace (A.addBounded B) V` -- the generic reducing-subspace vocabulary -- constructs nothing by hand. The underlying generic fact is `reflection_commutes_of_reducesSubspace`, that a reducing subspace commutes with its own reflection, which mentions neither perturbation nor Davis--Kahan. **Canonical Section 2 inventory, 2026-08-30.** `DavisKahan/Sources/DavisKahan1970/SectionTwo.lean` is the public inventory of the paper's four unnumbered headline theorems over both scalar fields: `TauCeti.DavisKahan1970.SectionTwo.{sinTheta_complex, tanTheta_complex, sinTwoTheta_complex, tanTwoTheta_complex}` and their `_real` siblings. The unqualified `SectionTwo.{sinTheta, tanTheta, sinTwoTheta, tanTwoTheta}` are reserved by a standing rule: a short name is bound only to a declaration that is BOTH scalar-generic over `RCLike` AND at the printed source scope, and is left unbound otherwise. Which of the four currently satisfy that is a property of the Lean file, and `SectionTwo.lean` is where it is recorded; this note deliberately does not restate it, because a copy of a moving fact goes stale silently -- this sentence itself did. They are `alias`es, so each carries exactly the type of the declaration it names -- unbounded self-adjoint `LinearPMap` ambient operator, arbitrary Hilbert dimension, a `SymmetricNormingFunction`, both printed conclusions, no capability class, no finite-dimensional hypothesis, no proof vehicle in the conclusion. `SectionTwoUsage.lean` calls each from ordinary operator-theory hypotheses, so the advertised entry points are compiler-checked to be reachable without building Sylvester witnesses, reflection blocks, or spectral reflections by hand. The scalar-generic presentation forms, directed and whole-space variants, finite specializations, operator-norm statements and bundled-problem entry points are unchanged and remain registered separately.
...
**Scope gap.** None. The four Section 2 sharpness families have compiled admissible equality configurations. The reflection-residual sin(2 Theta) model is instantiated, and the orthogonal direct-sum constructions are identified with the canonical subspace sin Theta, Theta, tan Theta, and tan(2 Theta) operators. The source requires simultaneous attainment across unitary-invariant norms within any one theorem family, not one common pair extremizing all four families.
...
**importance:** `technical`  **section:** 2  **source:** Section 2, final paragraphs  **kind:** scope_claim  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `reopened_mapping`

**Summary.** The four theorem families extend to unbounded self-adjoint operators under bounded perturbation or residual assumptions, with analytic work concentrated in Theorem 5.2 and the Section 6 appendix.

**Scope gap.** real-scalar, for the TANGENT families only.

**THE 2026-08-09 SCOPE_GAP TEXT WAS FALSE AND IS CORRECTED HERE (Claude Opus 5, M34).**  It read: "`sinTheta_generalized_bundled_complex`, `sinTheta_unbounded_opNorm_complex`, `sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_complex`, the five `theorem6_3_unbounded_*` endpoints and `tanTwoTheta_unbounded_residual_opNorm_complex` are all `InnerProductSpace C` ... No declaration in the repository states any unbounded-scope Davis--Kahan theorem over a real Hilbert space."  Both halves are wrong, and by the same audit error that this census already recorded and corrected once on `S2-sin-theta`: only the declarations LISTED on the row were inspected, which answers "does this row list a real theorem?" and not "does the repository HAVE one?".

MEASURED 2026-08-09 by elaborating each name.  (1) `sinTheta_unbounded_opNorm_complex` is NOT complex-only: it is `{k : Type u} [RCLike k]` throughout (`DavisKahan/SinTheta/Unbounded/OpNorm.lean`), so it already covers a real Hilbert space of arbitrary dimension at the operator norm.  (2) The unbounded SINE family has real counterparts that were simply never listed here: `sinTheta_unbounded_real` and `generalizedSinTheta_unbounded_real` (`DavisKahan/SinTheta/Real/{Unbounded,Generalized}.lean`) over a real `KyFanDominantIdealFamily` and a real closed self-adjoint `LinearPMap`, and `sinTheta_unbounded_real_spectralSubspace` / `generalizedSinTheta_unbounded_real_spectralSubspace` (`DavisKahan/SinTheta/Natural/Real.lean`) with GENUINE real spectral subspaces supplied by the caller-free natural interface.  (3) The unbounded DOUBLE-ANGLE SINE family likewise: `unbounded_sinTwoTheta_{,residual_}uiNorm_representative_real` and `sinTwoTheta_{addBounded,reflectionResidual}_symmetricNorming_real`, and since M34 the operator-norm forms `sinTwoTheta_unbounded_perturbation_opNorm_real` / `sinTwoTheta_unbounded_reflectionResidual_opNorm_real`, whose conclusions name the real angle operator `sinTwoAngleOperatorR`.  All are unbounded, real, of arbitrary dimension, membership concluded.

WHAT IS ACTUALLY MISSING, and it is the whole reason the blocker is retained: the unbounded TANGENT endpoints.  All five `theorem6_3_unbounded_*` names and `tanTwoTheta_unbounded_residual_opNorm_complex` are `InnerProductSpace C`, and so is the entire tree beneath them -- `Theorem63FiniteSource`, `Theorem63TrialData`, `Theorem63InfiniteTrial`, `Theorem63Unbounded`, `Theorem63UnboundedInfiniteTrial`, about 3800 lines with `variable {H} [InnerProductSpace C H]` at the top of each.

MEASURED OBSTRUCTION, and it is NOT foundational.  Nothing in that tree needs complex scalars mathematically: `BoundedCompressionTrialBlock` is pure data over a complex partial map (at the time of this note, an abbreviation `DKClosedOperator` of the bundled `TauCeti.DavisKahanExt.ClosedOperator` record at `𝕜 = C`; that record was deleted 2026-08-28 and the carrier is `LinearPMap`), `Theorem63TrialData` records only bounded action/compression/residual, and `all_kyFan_core_of_formBounds` derives the Ky Fan root from the two printed form bounds.  The scalar fixing is a convention, not a dependency.  There are therefore two routes and they should be compared before either is started: (a) generalize the tangent tree to `RCLike 𝕜`, which is a large but mechanical edit; (b) transport, exactly as `DavisKahan/Sources/DavisKahan1970/DirectedReal.lean` already transports the BOUNDED tangent theorem -- at the finite-Ky-Fan level where `approximationNumber_complexify` is an equality, with the infinite-dimensional tangent representative built over the real trial space -- using the real spectral layer of `DavisKahan/SpectralTheory/Real/SpectralRestriction.lean` and the form transports of `DavisKahan/SpectralTheory/Complexification/FormTransport.lean` for the reducing-subspace hypotheses `hVdom`/`hVcomm`.  The real BOUNDED tangent theorems `tanTheta_directed_bounded_symmetricNorming_real{,_infinite}` already exist, so route (b) starts from a worked precedent at one scope below.

Note that this row's OTHER axis is untouched by all of the above: the unbounded `tan 2Theta` theorem beyond the operator norm is open at COMPLEX scalars too, and that is what `next_action` is about.

**TANGENT HALF CLOSED 2026-08-09 (Claude Opus 5, M35); ONLY THE DOUBLE-ANGLE TANGENT REMAINS.**

The five `theorem6_3_unbounded_*` endpoints now have real counterparts that are strictly stronger than they are (no trial-dimension hypothesis): see `notes`.  `crossed_lower_of_reducing` and `Theorem63TrialData.ofUnbounded` are `RCLike`-generic, so they are real as they stand.

WHAT IS LEFT ON THIS ROW'S REAL-SCALAR AXIS, and it is one declaration: `tanTwoTheta_unbounded_residual_opNorm_complex`.  There is no real unbounded `tan 2Θ` statement anywhere in the repository (checked by search, 2026-08-09).  That family is also the one this row's `next_action` records as incomplete at COMPLEX scalars beyond the operator norm and beyond the residual form, so the real lift should follow the complex `nu >= 2` work rather than precede it; the obstruction to the complex work is written out on `DK-6-appendix`.

ROUTE (a) OF THE TEXT ABOVE IS NOT AVAILABLE.  `Theorem63InfiniteTrial.lean` and `Theorem63UnboundedInfiniteTrial.lean` rest on the ℂ-only bounded projection-valued measure through `TauCeti.BorelCalculus.exists_finiteDimensional_le_almostInvariant`; generalizing the tree to `RCLike` would require a real Borel calculus that the pinned dependencies do not have.  Route (b) was taken.

**THE EXTREMALITY DEAD END NOW HAS A LIVE REPLACEMENT ROUTE, AND ITS FIRST TWO STAGES ARE COMPILED, 2026-08-10 (Claude Opus 5, coordinator-verified independently: build 9612 -> 9613 jobs, BUILD_EXIT=0 read from the echoed log line, zero errors and ZERO warnings in the new module, seven checks EXIT=0, all four ratchets byte-identical at 165/51/51/91, probe EXIT=0 with zero `sorryAx`).**

New module `DavisKahan/Sources/DavisKahan1970/TanTwoThetaUnboundedGramBridge.lean` (570 lines, 26 declarations, no `sorry`).  `IsCompressedDoubleAngleEigenbasis` appears NOWHERE in it or its dependency closure -- the route removes the extremality clause from the proof rather than attacking it.  THE PROVED OBSTRUCTION IS UNCHANGED AND STILL STANDS: `sum_tangent_le_kyFan_of_compressedDoubleAngleEigenfamily` and `kyFan_eq_sum_tangent_of_isCompressedDoubleAngleEigenbasis` still show that clause is a Ky Fan attainment condition, and it must never be attacked directly.

THE TARGET CHAIN is `kyFan k T_0 <= sum_{n<k} tan(arcsin a_n(S_0)) <= (2/delta) kyFan k R_0` on the TYPED directed corners `blockCompression U^perp U`, never the ambient `unboundedReflectionTangent : H ->L[C] H` (which carries both adjoint corners and would risk double-counting the sharp factor 2).

**THE LEFT HALF OF THAT CHAIN IS NOW A THEOREM**, at every index and at every Ky Fan prefix:
  `approximationNumber_reflectionTangentCorner_le` -- `a_n(T_0) <= tan (arcsin (a_n(S_0)))`
  `kyFan_reflectionTangentCorner_le` -- `kyFanApproximationGauge k T_0 <= sum_{n<k} tan (arcsin (a_n(S_0)))`
both under `IsSelfAdjoint Z`, `Z * Z = 1` and pole exclusion `||offDiagonalPart Z|| < 1` only.

THE LOAD-BEARING STEP IS A CLOSED FORM NOBODY HAD PREDICTED, and it is why the route worked: `adjoint_mul_unboundedReflectionTangent` proves `T* T = Ring.inverse (C^2) - 1` from `unboundedReflectionTangent_comp_diagonalPart` and `diagonalPart_sq_add_offDiagonalPart_sq` ALONE.  That places `T* T` inside the commutative subalgebra generated by `C^2`, after which the Gram-resolvent equation `T* T = S^2 + S^2 (T* T)` is `noncomm_ring`.  It restricts to the typed corners because `T` is purely off-diagonal.  A `Commute`/`Ring.inverse` lemma Mathlib lacks was proved on the way (`commute_ringInverse`).

**CHECKPOINT B WAS AN AGREED ABANDON POINT AND IT IS NOT ONE.**  `GramSpectralBandModel` promises only `right_mem_polarInitial`, so cutoff-fixity of the selected vectors was a genuinely new obligation; it costs 29 lines (`eq_of_mem_polarInitial_comp`, `gramSpectralBandModel_toProj_right`).  The polar-initial vectors CAN be placed in the cutoff range without touching the approximation numbers.

THE LIMIT APPARATUS FOR THE RIGHT HALF ALSO EXISTS: `tendsto_sum_tanArcsin_approximationNumber_reflectionSineCorner_comp` releases a fixed-cutoff prefix bound to the full trial subspace, via the per-index `approximationSingularValue_comp_strongProjection_tendsto_complex`.  The pole is never approached because `a_n(S_0 . Omega) <= ||S_0|| < 1` uniformly.

**WHAT IS LEFT IS EXACTLY THE MIDDLE INEQUALITY** -- the fixed-cutoff prefix theorem `delta * sum_{n<k} tan(arcsin a_n(S_0 . Omega)) <= 2 * kyFanApproximationGauge k R_0`, with no extremality hypothesis.  MEASURED SCOPE, so this is not mistaken for a checkpoint: the approximate PER-VECTOR layer exists (`TanTwoThetaUnboundedKyFan.lean` lines 577, 619, 748) but the approximate SUM layer does not.  It needs approximate analogues of two ~140-line theorems -- `gap_mul_sum_tangent_le_kyFan_of_compressedDoubleAngleEigenfamily` (line 1266) and its contraction input `sq_norm_sum_smul_diagonalPart_offDiagonalPart_le_of_compressed` (line 1084) -- plus the theta-threshold split and the rho -> 0 passage at FIXED tau.  Several hundred lines.  Nothing found contradicts the route: the existing lemmas carry `tau` and `epsilon` as independent parameters, which is what the `rho -> 0 at fixed tau` ordering needs, and that ordering is precisely what avoids the `tau * cutoff-error(tau)` rate problem already measured as a no-go.

**SCALAR AXIS: EVERYTHING IN THE NEW MODULE IS C-ONLY**, because the Gram-resolvent and Gram-selection layers are `E0 ->L[C] E1`.  Real scalars were not attempted and must be recorded as UNKNOWN, not assumed -- a full success on this route still leaves the real axis open on this row.

FALSE PREMISES IN THE COORDINATOR'S BRIEF, all reported rather than worked around: (1) `approximationNumber_gramOperator_complex` is used ONCE, not twice -- only the endomorphism slot needs converting, and the cited precedent `approximationNumber_lowerCorner_le` also uses it once; (2) neither `blockCompression` nor `gramOperator` is in the import closure of `TanTwoThetaUnboundedKyFan.lean`, so three extra imports were required; (3) `polarInitial` is NOT definitionally the orthogonal complement of the kernel and the un-flipped form does not exist in the repository -- only the flipped `ContinuousLinearMap.polarInitial_orthogonal_eq_ker`.  All 15 other declaration names and line numbers in the brief verified EXACT.

**THE UNBOUNDED `tan 2Theta` ENDPOINT IS CLOSED AT COMPLEX SCALARS, 2026-08-10 (Claude Opus 5, coordinator-verified: merged build **9614 jobs BUILD_EXIT=0**, zero errors, ZERO warnings from the new module, seven checks EXIT=0, four ratchets byte-identical, probe EXIT=0).**  New module `DavisKahan/Sources/DavisKahan1970/TanTwoThetaUnboundedGramMiddle.lean`, 1205 lines, 19 declarations, no `sorry`.

  `gap_mul_kyFan_reflectionTangentCorner_le_two_mul_kyFan` -- `(b - a) * kyFanApproximationGauge k T_0 <= 2 * kyFanApproximationGauge k R_0`
  `mem_and_gauge_le_reflectionTangentCorner` -- the same at EVERY `KyFanDominantIdealFamily`, i.e. every arbitrary unitarily invariant norm

**THE EXTREMALITY HYPOTHESIS IS DELETED, NOT DISCHARGED.**  The endpoint is literally the old `mem_and_gauge_le_of_compressedDoubleAngleEigenbasis` statement with `IsCompressedDoubleAngleEigenbasis` removed.  The proved obstruction is UNTOUCHED and still governs -- it must never be attacked.  MACHINE-CHECKED, not asserted: the transitive constant closure over all four main theorems is 3701 constants and contains neither `IsCompressedDoubleAngleEigenbasis` nor `sorryAx`; the only two textual occurrences in the new module are docstrings stating its absence (coordinator re-grepped and confirmed both are prose).

**THE ORDERING PAID OFF EXACTLY WHERE IT WAS SUPPOSED TO.**  Because the fixed-cutoff conclusion contains no `tau`, no `rho` and no `theta`, the endpoint quantifies over a NET of cutoffs `Omega i : BoundedCutoff A U (sigma i)` whose levels grow WITHOUT BOUND.  That is what makes it non-vacuous for genuinely unbounded `A`, and it is the concrete distinction from the graph/spectral-cutoff lane refuted in `dev/failed-proof-directions-2026-08-10.md` section 2.1.

FOUR CORRECTIONS TO THE COORDINATOR'S BRIEF, all reported rather than worked around.  (1) The `theta`-threshold is NOT needed for the unbounded-`A` error and the brief's stated REASON was wrong although its figure was right: `gram_residual` gives `||Omega S^2 x_i - q_i^2 x_i|| <= rho a_i / 4`, and that `a_i` cancels the `q_i` from dividing by `q_i c_i`, so the per-index error is `(tau+|b|) rho / (4 c_i)` with no `q_i` in it; `theta` is needed ONLY for the contraction constants.  (2) `abs_norm_sq_offDiagonalPart_sum_sub_le` does NOT suffice -- it covers two of the three systems, and the third needs `||C S g||^2 = ||S g||^2 - ||S^2 g||^2` with a LOWER bound on `||S^2 g||`, which did not exist; that is the new `sq_norm_offDiagonalPart_sq_sum_ge`, which needs only that the cutoff is a contraction (NOT `IsSelfAdjoint Z`, NOT cutoff-fixity -- both dropped after the compiler flagged them unused).  (3) `rho` and `theta` collapse to ONE parameter: `rho := theta^4` makes all three errors `<= theta` times a `theta`-free constant, so a single passage releases everything -- still the briefed ordering, but one limit rather than two.  (4) `0 <= tau` must be an explicit hypothesis, because `BoundedCutoff A U tau` does not force it (the zero projection satisfies it for every `tau`).  Pole exclusion turned out FREE and uniform: `a_n(S_0 . Omega) <= ||offDiagonalPart Z|| < 1`, so `kappa := sqrt(1 - ||S||^2)` works at every index and every cutoff.

**SCALAR AXIS: THIS IS C-ONLY AND THE REAL AXIS IS UNKNOWN, NOT ASSUMED.**  The Gram-resolvent and Gram-selection layers are `->L[C]`.  This row therefore KEEPS `real-scalar-infinite-dimensional-scope` and stays `compiled_specialization`: what closed is the complex endpoint, which was the mathematical obstruction, not the scalar one.

**THE REAL `tan 2Theta` ENDPOINT LANDED 2026-08-11 (Claude Opus 5; coordinator-verified: build 9618 -> 9619 jobs, BUILD_EXIT=0 read from the echoed log line after waiting for it, zero errors, seven checks EXIT=0, four ratchets TRUE_EXIT=1 with counts flat at 165/51/51/91, three baselines flat at 13/154/16).**  New leaf module `DavisKahan/Sources/DavisKahan1970/TanTwoThetaUnboundedGramReal.lean` (683 lines).  **THE REAL STATEMENTS MENTION NO COMPLEX OBJECT AT ALL** -- `A`, `B`, `Z`, `U`, the cutoff net and the gauge are all real:
  `gap_mul_kyFan_reflectionTangentCorner_le_two_mul_kyFan_real` -- `(b - a) * kyFanApproximationGauge k (reflectionTangentCorner U Z) <= 2 * kyFanApproximationGauge k (reflectionResidualCorner U B)`
  `mem_and_gauge_le_reflectionTangentCorner_real` -- the same at every `KyFanDominantIdealFamily (k := R)`
  `gap_mul_kyFan_reflectionTangentCorner_le_two_mul_kyFan_ambient_real` -- the ambient-perturbation form, `... <= 2 * kyFanApproximationGauge k B`

THE TRIAL-DATA TRANSPORT WORKED WITH NO FALLBACK, third confirmation of that route.  A large amount was generalized IN PLACE with names kept and no `Real`-suffixed duplicate carriers: `TauCeti.BoundedCutoff` and its four lemmas, `inner_swap_of_isSelfAdjoint`, `unboundedReflectionTangent`, `reflectionSineCorner`, `reflectionTangentCorner`, `reflectionResidualCorner`, `cutoffCorner` and its projection lemmas, `adjoint_blockCompression`, `coe_blockCompression_apply`, `kyFanApproximationGauge_reflectionResidualCorner_le`.  `gramOperator` remains C-only and `coe_gramOperator_blockCompression_apply` stays at C in a new `GramCompressionAlgebra` section; the real side does not need it.  **NO REAL GRAM PVM EXISTS OR IS NEEDED** -- the Cayley-transform prohibition was respected.

**THE EXTREMALITY CONDITION IS ABSENT FROM THE REAL SIDE TOO, CHECKED PROPERLY.**  Transitive constant closure from all three real endpoints, size **56793**, with `IsCompressedDoubleAngleEigenbasis`, `IsDoubleAngleEigenbasis`, `exists_finiteDimensional_le_almostInvariant` and `sorryAx` all at **0**, and positive controls proving the traversal really reaches the C interior (`gramSpectralPVM` 2, `GramSpectralBandModel` 8, `BoundedCutoff` 21, `Cayley` 1, `specProjection` 31, `cfc` 141).  **A TRAP WORTH RECORDING:** `ConstantInfo.value?` returns `none` for theorems unless `allowOpaque := true`, and three earlier attempts silently produced a TYPES-ONLY closure of 3291 constants in which every count read 0.  A zero from a closure computation is meaningless without positive controls.

**A HYPOTHESIS WAS DROPPED, MAKING THE REAL STATEMENTS STRICTLY WEAKER THAN THE COMPLEX ONES.**  `hproj` is redundant: `isIdempotentElem_cutoffCorner` and `isSelfAdjoint_cutoffCorner` prove `IsOrthogonalProjectionMap (cutoffCorner Omega)` unconditionally for every `BoundedCutoff`.  The three C siblings still carry it and SHOULD SHED IT.

THREE FALSE PREMISES IN THE COORDINATOR'S BRIEF.  (1) The predicted bridging ingredient (a `semiboundedAbove_unitaryConjugate` analogue) DID NOT ARISE, and `complexifySubmoduleEquiv` never appears in the endpoint proofs -- because nothing here is a `DKClosedOperator` on a subspace; `TauCeti.LinearPMap.complexifyReal` complexifies a raw real `LinearPMap` directly onto `RealComplexification E`, so all five hypothesis transports are coordinatewise.  (2) `BoundedCutoff` was NOT an obstacle: only the CONSTRUCTION of a cutoff from a PVM is complex, the data is not, and `complexifyBoundedCutoff` carries a real cutoff across (its only non-trivial field needs a case split on `0 <= tau`, a negative `tau` being consistent only with `Omega.toProj = 0`).  (3) The axiom probe is weaker than it looks in this toolchain -- `#print axioms` reads a precomputed per-declaration extension rather than traversing values, and `[propext, Classical.choice, Quot.sound]` is already forced by `Real` appearing in the TYPES.  It returned the expected three, but the closure computation above is the check that carries weight.

**PROMOTED TO `compiled_exact` AND THE BLOCKER COMES OFF, 2026-08-11 (coordinator-verified: build 9619 -> 9620 jobs, BUILD_EXIT=0 read from the echoed log line after waiting for it, zero errors, seven checks EXIT=0, four ratchets TRUE_EXIT=1 flat at 165/51/51/91, baselines flat at 13/154/16).**  `tanTwoTheta_unbounded_residual_opNorm_real` and `tanTwoTheta_unbounded_residual_div_real` are the last real-scalar items, and every object in them is real.

**THE COORDINATOR'S ADJUDICATION PREMISE WAS FALSE, AND THE IMPLICATION RUNS THE OTHER WAY.**  I briefed that the real counterpart was probably the `k = 1` case of the new gauge endpoint and that only STATEMENT SHAPE was in question.  It is not a corollary at all: `tanTwoTheta_unbounded_residual_opNorm_complex` is a POINTWISE VECTOR inequality `delta * ||sin 2Theta_0 x|| <= 2 ||B|| ||cos 2Theta_0 x||` on the trial subspace, not a Ky Fan gauge bound; it carries a SECOND conclusion (the pole-exclusion constant `diagonalBlockBound (b-a) ||B|| * ||x|| <= ||cos 2Theta_0 x||`) for which the gauge endpoints have no analogue; and it assumes NEITHER `hS1 : ||offDiagonalPart Z|| < 1` NOR a cutoff net, whereas the gauge endpoints ASSUME `hS1` (pole exclusion is what produces it) and take a cutoff net.  `kyFanApproximationGauge_reflectionResidualCorner_le` is therefore NOT a bridge to it.  What is true is that the real form is the SAME complexification transport applied to the POINTWISE complex theorems rather than the gauge ones, with `TauCeti.LinearPMap.realSpecRange` supplying the real trial subspace.

NEW SUPPORT: `diagonalPart_congr` / `offDiagonalPart_congr`, needed because `rw` with `complexifySubmodule_realSpecRange` has a non-type-correct motive -- the subspace occurs in a `HasOrthogonalProjection` INSTANCE argument -- so `subst` plus `rfl` is the route, the class being a `Prop`.  NOTE: `complexifySubmodule_realSpecRange` had **zero consumers** before this; this is its first use.
...
- `TauCeti.DavisKahan.ExactSinTheta.generalizedSinTheta_unbounded_real`
- `TauCeti.DavisKahan.ExactSinTheta.sinTheta_unbounded_real_spectralSubspace`
- `TauCeti.DavisKahan.ExactSinTheta.generalizedSinTheta_unbounded_real_spectralSubspace`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_real`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_perturbation_opNorm_real`
- `TauCeti.DavisKahan1970.sinTwoTheta_unbounded_reflectionResidual_opNorm_real`
...
- `TauCeti.DavisKahan1970.gap_mul_kyFan_reflectionTangentCorner_le_two_mul_kyFan_real`
- `TauCeti.DavisKahan1970.mem_and_gauge_le_reflectionTangentCorner_real`
...
SCALAR SCOPE, measured the same day by elaborating each listed declaration: `sinTheta_generalized_bundled_complex`, `sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_complex`, all five unbounded tangent endpoints and `tanTwoTheta_unbounded_residual_opNorm_complex` are `InnerProductSpace C` without exception.  So this row also carries the standing real-scalar gap, now recorded in `blocked_by` and `scope_gap`.

**SCOPE_GAP CORRECTED 2026-08-09 (Claude Opus 5, M34).**  See `scope_gap` for the measurement.  In one line: the claim that no unbounded-scope theorem over a real Hilbert space exists anywhere in the repository was false, `sinTheta_unbounded_opNorm_complex` is `RCLike`-generic rather than complex-only, and the real unbounded sine and double-angle-sine families are compiled and are now listed on this row.  The blocker stays because the unbounded TANGENT endpoints -- the five `theorem6_3_unbounded_*` and `tanTwoTheta_unbounded_residual_opNorm_complex` -- and the ~3800-line tree beneath them are complex-only.  That fixing is a convention rather than a mathematical dependency, and two routes to remove it are named in `scope_gap`.

**THE REAL UNBOUNDED TANGENT FAMILY IS DONE, 2026-08-09 (Claude Opus 5, M35).**

The scalar gap recorded above for the tangent side is closed, at the PRINTED Theorem 6.3 hypothesis and at arbitrary trial dimension.  `theorem6_3_unbounded_infiniteTrial_ideal_exists_of_reducing_real` (`DavisKahan/Sources/DavisKahan1970/DirectedUnboundedReal.lean`, default build, axiom-clean) is: a REAL Hilbert space of arbitrary dimension; a closed unbounded REAL operator (`E →ₗ.[ℝ] E`); an arbitrary complete REAL trial subspace with no dimension hypothesis; an arbitrary CHOSEN reducing subspace `V` under the printed `hVdom` / `hVcomm` / `hUnwanted` and nothing more; an arbitrary REAL Fan-dominant unitarily invariant ideal gauge; the tangent representative constructed over the real trial space and exhibited; and its ideal membership CONCLUDED.  `..._ideal_of_reducing_real` is the caller-supplied-representative form.  `..._ideal_exists_real` and `..._ideal_real` are the spectral-gap specializations at `V = realSelfAdjointSpectralSubspace A hA (Set.Iic α)`, whose reducing hypotheses come from `DavisKahan/SpectralTheory/Real/SpectralRestriction.lean` and whose form bound `α + δ ≤ Λ₁` comes from a real spectral gap.
...
**THE UNBOUNDED `tan 2Theta` `nu >= 2` AND ARBITRARY-UI-NORM ENDPOINTS EXIST, CONDITIONALLY, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9601 EXIT=0, six gates EXIT=0, baselines flat, ALL FOUR ratchets byte-identical, probe EXIT=0 with `sorryAx` count ZERO on all ten declarations).**  New module `DavisKahan/Sources/DavisKahan1970/TanTwoThetaUnboundedKyFan.lean`, in the DEFAULT build.  `FinishTanTwoTheta/` was read only and nothing depends on it.

**THE COORDINATOR'S RECORDED NO-GO IS LANE-SCOPED, NOT THEOREM-SCOPED, AND ITS STATED MECHANISM COULD NOT BE REPRODUCED.**  The record said "a NO-GO for ANY argument resting only on strong convergence of spectral cutoffs".  True of the GRAPH lane; FALSE as a claim about the theorem.  The record further asserted the surviving pairing "evaluates EXACTLY to `(||P X x|| - a) * <A_1 y, y>` -- the leakage term is ANNIHILATED because `y` lies in the band and the band projection COMMUTES WITH `A_1`".  THAT COULD NOT BE DERIVED: with `y proportional to X x` the surviving pairing is an `A_0`-side quantity, `Re <A_0 x, (G - s^2) x>`, and the band in question is a band of `A_0`, whose projection lives on `E_0` and cannot commute with `A_1` on `E_1`.  Flagged as probably wrong.

THE SHARP FORM OF THE GRAPH-LANE OBSTRUCTION, derived fresh: taking `y := X x / ||X x||` makes `e_0 = 0` exactly, and the seam collapses to ONE real scalar requirement, `Re <A_0 x, (G - s^2) x> <= eps * s` with `G = X*X` -- i.e. an approximate eigenvector of `X*X` inside `dom A_0` whose residual beats its graph norm.  Fixing the `A_0`-band first does control the COMPRESSED residual, but the same vector enters the BOUNDED `B_01` terms (`Unbounded.lean:461,483`), which need the FULL norm small, not the compressed one; the uncompressed leak `(1 - Omega) G x` enters with no sign advantage.  That, not the recorded mechanism, is why the graph lane cannot borrow the `nu = 1` device.

**THE ELEGANT PATH IS THE REFLECTION PICTURE, AND THE ASYMMETRY IS THE WHOLE POINT.**  In `TauCeti.sylvester_pairing_le` the uncompressed residual enters only through `||S y||^2 = q^2 + ||r||^2`, giving `||C y||^2 <= 1 - q^2` -- a FAVOURABLE sign, courtesy of `C^2 + S^2 = 1`.  So the full residual is harmless there and only `Omega r` is ever paired with `A`.  Pairing the unbounded equation (7.6) at `x` with `S x` rather than with a normalised near-maximiser makes the estimate EXACT when `S^2 x = q^2 x`: no residual at all, and dividing by `c_i = sqrt(1 - q_i^2)` yields EXACTLY orthonormal systems, which is what makes `nu >= 2` reachable.  A free bonus: `doubleAngleEigenvalue_lt_one` excludes the pole with no cutoff, no limit and no constant.

Declarations, copied from source, all in `TauCeti.DavisKahan1970`: `gap_mul_sq_le_paired_of_doubleAngleEigenvector`, `gap_mul_sum_tangent_le_kyFan_of_doubleAngleEigenfamily`, `IsDoubleAngleEigenbasis`, `gap_mul_kyFan_le_two_mul_kyFan_of_doubleAngleEigenbasis`, `mem_and_gauge_le_of_doubleAngleEigenbasis`, `doubleAngleEigenvalue_lt_one`, `norm_sq_offDiagonalPart_of_doubleAngleEigenvector`, `norm_sq_diagonalPart_of_doubleAngleEigenvector`, `inner_of_doubleAngleEigenfamily`, `orthonormal_scaled_of_inner_eq`.

**SCOPE, AND IT MUST NOT BE OVERSTATED: THESE ARE CONDITIONAL ON `IsDoubleAngleEigenbasis`.  At `n = 1` the result is WEAKER than `tanTwoTheta_unbounded_residual_opNorm_complex`, which needs no eigenvector.  What is new is `n >= 2`, which that theorem does not reach at all.  DO NOT CITE THESE AS THE UNCONDITIONAL ENDPOINTS.**  The honest-scope caveat is also in the module docstring (line 340), coordinator-read.

**COSTED ROUTE TO REMOVE THE HYPOTHESIS (mission's estimate, NOT formalized; ~740 lines).**  The `nu = 1` tau-first device DOES survive to `nu >= 2` in the reflection picture -- the circularity that blocks the graph lane does not apply.  Order: fix `tau`, then `eps`.  (1) package `specProjection hA (Icc (-T) T)` as a `TauCeti.BoundedCutoff` (~80); (2) apply `exists_approximateLeadingSingularFamily` to the COMPRESSED block `S . Omega_tau`, whose right vectors land in `ran Omega_tau` with `||A x_i|| <= tau` automatically (~60); (3) take `y_i := S x_i / ||S x_i||`, Gram matrix `delta_ij + O(eps)` because `<S x_i, S x_j> = <Omega S^2 Omega x_i, x_j>` EXACTLY (~150); (4) `||A (S x_i)|| <= tau + 2||B||` falls out of (7.6) itself, so every error term is `O(eps * poly(tau))` and `eps` is chosen AFTER `tau` -- NO CIRCULARITY (~150); (5) **THE ONE GENUINE RISK**: the `v_i = C y_i / c_i` system is only approximately orthonormal and its defect is NOT controlled by the compressed residual, but the leak enters as a PSD Gram matrix, so a CONTRACTION form of the Ky Fan variational bound is needed -- provable from the SVD of the `k`-column contraction plus Abel summation against `sum_le_kyFanApproximationGauge_of_orthonormal` (~200); (6) `tau -> infinity` via Lemma 5.1, NO RATE NEEDED because step 5 is uniform in `tau`, which is exactly what the graph lane lacks (~100).

FOR THIS ROW SPECIFICALLY: of the three items in `next_action`, the Ky Fan `nu >= 2` case and the arbitrary-UI-norm endpoint now EXIST conditionally; the PERTURBATION form `delta * N(tan 2Theta) <= 2 * N(H)` is UNTOUCHED -- the new work's `hB : IsOddFor U B` is the RESIDUAL case `H_0 = H_1 = 0`.

**THE EIGENFAMILY HYPOTHESIS IS WEAKENED, NOT REMOVED, AND THE PLAN THAT AIMED TO REMOVE IT IS INCOMPLETE IN A LOAD-BEARING PLACE, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9601 EXIT=0, six gates EXIT=0, baselines flat, ALL FOUR ratchets byte-identical, probe EXIT=0 with `sorryAx` count ZERO).**

**THE PLAN'S GAP.**  The campaign owner's route -- do not prove `IsDoubleAngleEigenbasis` globally (it is too strong in infinite dimension, the operator may have continuous spectrum), instead eliminate it by diagonalizing `P_W S^2 P_W` on finite-dimensional trial spaces -- is CORRECT about the Gram side and its exact identities `<S x_i, S x_j> = q_j^2 delta_ij` and `<C x_i, C x_j> = (1 - q_j^2) delta_ij`.  BUT IT NEVER ADDRESSES WHERE THE EIGEN-RELATION IS ACTUALLY USED in the per-index estimate (`TanTwoThetaUnboundedKyFan.lean:152` rewrites `<S(A x), S x> = <A x, S^2 x>` by `S^2 x = q^2 x`).  Under compression that term becomes `q_i^2 Re<A x_i, x_i> + Re<A x_i, r_i>`, PAIRING THE UNBOUNDED `A` WITH THE LEAKAGE.  Compression alone therefore does not make the theorem unconditional: **the Gram side and the `A` side fail independently.**

**WHAT LANDED.**  `IsCompressedDoubleAngleEigenbasis`, replacing the exact eigen-relation with two hypotheses that are TRIVIAL when the leakage vanishes: `hgram` (the compressed Gram identity) and `hres : Re<A x_i, S^2 x_i - q_i^2 x_i> <= 0`.  Endpoints `gap_mul_kyFan_le_two_mul_kyFan_of_doubleAngleEigenbasis_via_compressed` and `mem_and_gauge_le_of_compressedDoubleAngleEigenbasis`.

**STRENGTH IS MACHINE-CHECKED, NOT ARGUED.**  The `_via_compressed` endpoint has the VERBATIM statement of the old `gap_mul_kyFan_le_two_mul_kyFan_of_doubleAngleEigenbasis` -- same hypotheses, same conclusion, same constant `2` -- and coordinator-read, its proof is a COMPOSITION through `isCompressedDoubleAngleEigenbasis_of_isDoubleAngleEigenbasis`, not a re-proof.  Nothing was weakened to typecheck.  **THE FACTOR 2 IS INTACT AND THE REASON IS STRUCTURAL:** three of the four auxiliary systems stay EXACTLY orthonormal under compression (they pair only members of the trial space, and the leakage is orthogonal to it); only `C S x_i / (q_i c_i)` acquires a defect, its Gram is `1 - D^-1 R* R D^-1 <= 1`, and the contraction lemma charges `cu * cv = 1 * 1`.  The bound is `kyFan + kyFan`, not `(1 + eps) * kyFan`.

**WHY THE NEW HYPOTHESIS IS REACHABLE** (`re_inner_compressedResidual_eq_zero_of_apply_eq_sum`, machine-checked): if `A x_i` lies in the span of the family then `Re<A x_i, r_i> = 0` EXACTLY.  So on any finite-dimensional **`A`-INVARIANT** `W`, the compression `P_W S^2 P_W` is self-adjoint on a finite-dimensional space and ALWAYS has an orthonormal eigenbasis -- nothing about the point spectrum of `S^2` is needed.  **The hypothesis moves off the unknown rotation `Theta` and onto the given operator `A`.**  That is the elegant reframing.

**THE REMAINING BRICK, and it is now small and concrete (~200-300 lines):** construct an `IsCompressedDoubleAngleEigenbasis` from an `A`-invariant finite-dimensional subspace plus finite-dimensional diagonalization -- `Submodule.span` + `orthogonalProjection` + a finite-dimensional spectral theorem, then the prefix-realisation clause.  Strictness was NOT proved: no witness of a compressed-but-not-exact basis is constructed.

**A RECORDED RISK IS RETIRED.**  The "ONE GENUINE RISK" this campaign recorded -- a contraction form of the Ky Fan variational bound, estimated at ~200 lines via SVD plus Abel summation -- exists by a CHEAPER route and needs no singular-value machinery: `re_sum_inner_map_le_kyFanApproximationGauge_of_contraction` absorbs the contraction through `ContinuousLinearMap.adjoint.norm_map` and `approximationSingularValue_comp_le`.  **A COORDINATOR CLAIM WAS ALSO FALSE:** I briefed that the orthonormal Ky Fan UPPER bound might not exist.  It exists at `DavisKahan/DoubleAngle/KyFanOrthonormal.lean:45` and the campaign's own committed endpoints already depend on it; my search looked in the wrong `Core.lean` (`ForTauCeti/.../ApproximationNumber/` rather than `DavisKahan/OperatorIdeal/ApproximationNumbers/`).

FOR THIS ROW: still open.  Its remaining axis is the REAL-scalar `tanTwoTheta_unbounded_residual_opNorm_complex`; this work is complex-only.  The perturbation form `delta * N(tan 2Theta) <= 2 * N(H)` also remains untouched.

**THE SPECTRAL HALF OF THE `tan 2Theta` HYPOTHESIS IS NOW DERIVED, AND THE RESIDUAL OBSTRUCTION IS SHARP AND STRUCTURAL, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9601 EXIT=0, six gates EXIT=0, baselines flat, ALL FOUR ratchets byte-identical, probe EXIT=0 with `sorryAx` count ZERO).**  767 insertions, ZERO deletions -- nothing existing was changed, weakened or removed.

**WHY THE ENDPOINTS CANNOT BE MADE UNCONDITIONAL AS THE MODULE IS STATED, and this is the finding.**  The last clause of `IsCompressedDoubleAngleEigenbasis` is `kyFanApproximationGauge k T <= sum_i q_i / sqrt(1 - q_i^2)`, and **`T` is an ARBITRARY `H ->L[C] H`: there is no definition of `tan 2Theta_0` anywhere in this module's scope.**  That clause is the SOLE link between `T` and the geometry, so NO subspace construction can produce it -- for any candidate construction, pick a `T` with larger gauge and the statement is false.  Coordinator-verified by reading the definition (`TanTwoThetaUnboundedKyFan.lean:1398-1410`).  **The route to a genuinely unconditional endpoint therefore runs through DEFINING `tan 2Theta_0` in scope and tying `T` to it, not through more subspace work.**

**WHAT IS NOW UNCONDITIONAL: everything about `Theta`.**  `gap_mul_sum_tangent_le_kyFan_of_invariantSubspace` needs only the standing block hypotheses plus `hWdom : W <= A.domain`, `hWU : W <= U`, `hWinv` (`A`-invariance) and `hk : finrank W = k`.  **No eigenfamily hypothesis, no positivity hypothesis, no cutoff, no error term, constant 2.**  Zero compression eigenvalues are handled by shortening the family and absorbing the shorter prefix by monotonicity of the gauge.  Construction term: `exists_compressedDoubleAngleEigenfamily_of_invariantSubspace`, delivering the leakage clause as `= 0`, not `<= 0`; supported by `offDiagonalSqCompression` and `isSymmetric_offDiagonalSqCompression`.  Bridge and composed endpoints: `HasInvariantDoubleAngleFiltration`, `isCompressedDoubleAngleEigenbasis_of_hasInvariantDoubleAngleFiltration`, `gap_mul_kyFan_le_two_mul_kyFan_of_invariantDoubleAngleFiltration`, `mem_and_gauge_le_of_invariantDoubleAngleFiltration` -- the last two single-term compositions with byte-identical conclusions, `2 *` and `(b-a)/2` included.

**A COORDINATOR FRAMING WAS WRONG AND THE MISSION CORRECTED IT.**  I briefed this as replacing a weaker hypothesis with a stronger derivation.  `HasInvariantDoubleAngleFiltration` is **NOT weaker** than `IsCompressedDoubleAngleEigenbasis` -- they are **INCOMPARABLE**, because a compressed eigenfamily need not span an `A`-invariant subspace (coordinator-verified: `IsCompressedDoubleAngleEigenbasis` imposes no invariance).  The new endpoints are **ADDITIONS, NOT REPLACEMENTS**; the exact-hypothesis endpoints remain in place.  What is strictly gained is that the SPECTRAL half is derived rather than assumed.  My brief also listed two discharge targets that are stated on the EXACT relation, not the compressed one, so the list was internally inconsistent.

**STRICTNESS IS PROVED, and more strongly than asked.**  `namespace CompressedStrictness` builds `C^3`, `U = (C e_2)^perp`, `Z` the reflection through `C(e_0+e_1+e_2)`, `A` the rank-one projection onto `C e_2`, `B` its off-diagonal completion, with EVERY standing hypothesis machine-checked (`a = 0`, `b = 1`).  `inner_unitVector_zero_offDiagonalPart_sq` gives the compressed Gram condition at `e_0` with `q = 2/3`, while `not_doubleAngleEigenvector_unitVector_zero` proves `S^2 e_0 = (4/9)(e_0 + e_1) != (4/9) e_0`.  `gap_mul_sum_tangent_le_kyFan_on_model` then RUNS the new unconditional endpoint on that data.  So the weakening is real, not cosmetic, and the endpoint is exhibited non-vacuous.

ALSO CORRECTED: `0 < q_i` is NOT automatic -- compression eigenvalues are only `>= 0`, so positivity remains a clause of the filtration even though the family endpoint absorbs it.

FOR THIS ROW: does not close.  Remaining: the prefix-realisation clause (see the `T`-is-free finding), existence of finite-dimensional `A`-invariant subspaces of `U inter D(A)` at every dimension, the REAL-scalar lift, and the separate PERTURBATION form `delta * N(tan 2Theta) <= 2 * N(H)`.

**THE OBSTRUCTION IS NOW A THEOREM, NOT AN ESTIMATE, AND IT REFUTES THE COORDINATOR'S ROUTE, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9601 EXIT=0, six gates EXIT=0, baselines flat, all four ratchets byte-identical, probe EXIT=0 with `sorryAx` count ZERO).**

**THE COORDINATOR ASKED FOR AN INEQUALITY THAT RUNS THE WRONG WAY.**  The brief asked to derive `kyFanApproximationGauge k (tan 2Theta_0) <= sum_i q_i / sqrt(1 - q_i^2)` from the compression data.  **THE REVERSE IS A THEOREM** -- `sum_tangent_le_kyFan_of_compressedDoubleAngleEigenfamily` proves `sum_i q_i / sqrt(1 - q_i^2) <= kyFanApproximationGauge n T` for EVERY double-angle tangent and EVERY compressed eigenfamily, in three lines of geometry: at a compressed family the systems `S x_i / q_i` and `C x_i / c_i` are already EXACTLY orthonormal (the leakage never enters those Gram identities), the defining identity sends the second to the first, and the pairing is exactly `q_i^2/(q_i c_i) = q_i/c_i`.

**CONSEQUENCE, MACHINE-CHECKED: the blocking clause can only hold WITH EQUALITY** (`kyFan_eq_sum_tangent_of_isCompressedDoubleAngleEigenbasis`).  It is NOT an inequality a construction can over-satisfy -- **it is a KY FAN EXTREMALITY condition on the family: the compression of `sin^2 2Theta` to its span must ATTAIN the prefix.**  Finite-dimensional `A`-invariance says nothing about extremality for `S^2`, and `sum_tangent_le_kyFan_of_invariantSubspace` records that what the invariant-subspace construction actually supplies is precisely the OPPOSITE inequality.  **So no subspace construction of that shape can discharge the clause.  This is mathematics, not a Lean difficulty.**

**THE TANGENT OBJECT NOW EXISTS AND IS CONSTRUCTIBLE WITH NO EXTRA HYPOTHESIS.**  `unboundedReflectionTangent U Z := S * Ring.inverse (C * C) * C` with `C = U.diagonalPart Z` and `S = U.offDiagonalPart Z` -- i.e. `tan 2Theta_0 = sin 2Theta_0 * (cos 2Theta_0)^-1`, total by construction, pinned by `IsDoubleAngleTangent` (the same defining identity the bounded theory uses, `directedTanTwoAngleOperatorC_comp_cosTwoAngleExtendedC`).  `isDoubleAngleTangent_unboundedReflectionTangent_specRange` produces it from EXACTLY the standing data of `tanTwoTheta_unbounded_residual_opNorm_complex`: `norm_offDiagonalPart_apply_le_specRange` bounds `||S||` on `U`, self-adjointness transfers it to `Uperp` and the orthogonal splitting to all of `H` with no factor lost, `crossBlockBound delta ||B|| = 2||B||/sqrt(delta^2 + 4||B||^2) < 1` gives `||S|| < 1`, and `C^2 = 1 - S^2` is then a Neumann unit.  **The hypotheses are not vacuous.**

**TWO MORE COORDINATOR ERRORS.**  (i) `tanTwoThetaIdealBlock` was briefed as "the most likely intended `T`".  IT IS THE WRONG OBJECT: it is a function of a submodule PAIR `(U,V)` requiring `IsQuarterAcute U V`, and **there is no `V` in the unbounded module's scope at all** -- the perturbed subspace enters only through the free involution `Z`, whose range is never exposed as a submodule; its own gauge theorem also carries the spurious `1/(1 - 2*directedGap^2)` factor.  (ii) The Theorem 8.2 "direct precedent" DOES NOT TRANSFER: `sinTwoTheta_directed_boundedResidual_blockRepresentative_kyFan_complex` is stated for BOUNDED `A : E ->L[C] E`, not for `A : H ->l.[C] H`.

**THE ENDPOINTS AT THE GENUINE OBJECT ARE WEAKER, NOT STRONGER, AND THE MISSION SAID SO.**  `gap_mul_kyFan_le_two_mul_kyFan_unboundedReflectionTangent` and `mem_and_gauge_le_unboundedReflectionTangent` are LITERAL SPECIALISATIONS at `T := unboundedReflectionTangent U Z` of the universally-quantified compressed endpoints -- one-line applications, weaker as propositions.  Constant 2 intact, nothing weakened to typecheck.  What is gained is that the conclusion concerns a CONSTRUCTED operator rather than a free variable, and that the surviving hypothesis is now exactly nameable ("some compressed family attains the prefix") instead of hiding inside an unconstrained `T`.

FOR THIS ROW: does not close.  The remaining obstruction is the ATTAINMENT clause above, which should be recorded as the obstruction rather than as unscoped work.

**Next action.** Hostile re-audit reopened this row. The passage asserts the full infinite-dimensional/unbounded/arbitrary-UI-norm scope for all four headline theorem families. The current evidence is a sample of endpoints rather than an explicit clause-by-clause four-family scope certificate.

**Blocked by:** `hostile-audit-atomization`

**Completion holes:**

- {'kind': 'audit_atomization', 'detail': 'The passage asserts the full infinite-dimensional/unbounded/arbitrary-UI-norm scope for all four headline theorem families. The current evidence is a sample of endpoints rather than an explicit clause-by-clause four-family scope certificate.'}

### `DK-3.1-def` — Direct rotation

**importance:** `supporting`  **section:** 3  **source:** Section 3 setup, equations (3.1)--(3.4), and Definition 3.1  **kind:** definition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `reopened_mapping`
...
**Notes.** Acute complex and finite constructions exist; exact nonacute source scope is not yet unified.
...
**M33, 2026-08-09 (Claude Opus 5).  THE REAL-SCALAR AXIS IS CLOSED ON THIS ROW.**  `DavisKahan/Geometry/Polar/DirectRotationReal.lean` constructs `TauCeti.DavisKahan.directRotationR` -- the direct rotation of a pair of REAL closed subspaces of a real Hilbert space of arbitrary dimension -- and proves it satisfies the printed definition: it is orthogonal, it intertwines `P_U` with `P_V`, and both diagonal blocks are the positive Halmos cosine (`real_directRotation_diagonalBlock`, `real_directRotation_complementaryDiagonalBlock`).  Membership is CONCLUDED: `directRotationR_maps_subspace` proves `U.map W = V`.
...
**M37, 2026-08-09 (Claude Opus 5).  STALE BLOCKER ENTRY REMOVED.**  `exact-source-wrappers` asked for 'a statement carrying the paper's numbering, scope and hypotheses'.  This row's 2026-08-06 note had already recorded that `IsDirectRotation` IS printed Definition 3.1, for an arbitrary pair and with no acuteness, and its `next_action` opens 'Nothing outstanding for the printed narrative'.  Re-measured 2026-08-09 by elaborating `IsDirectRotation`, `complex_directRotation`, `real_directRotation` and `directRotation_eq_exp_angleComplexStructure_comp_angleOperator` against `DavisKahan.All`: every one resolves and every one is axiom-clean.  The gap this row still carries is the DIMENSION axis on the quarter turn `J`, recorded in `scope_gap`; no blocker in the table covers it, and it is not a wrapper question.  The blocker is retired; its text is preserved on `S1-block-residual`.

**Next action.** Hostile re-audit reopened this row. The block contains equations (3.1)-(3.4), unitarity block identities, singular-value/nullity assertions, and the direct-rotation definition. The current generic `.whole` clause does not certify those assertions individually.

**Blocked by:** `hostile-audit-atomization`

**Completion holes:**

- {'kind': 'audit_atomization', 'detail': 'The block contains equations (3.1)-(3.4), unitarity block identities, singular-value/nullity assertions, and the direct-rotation definition. The current generic `.whole` clause does not certify those assertions individually.'}

### `DK-3.2-def` — Acute case

**importance:** `supporting`  **section:** 3  **source:** Definition 3.2  **kind:** definition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Both crossed intersections P ∩ Q-perp and P-perp ∩ Q vanish.

**Lean declarations:**

- `TauCeti.IsAcute`
- `TauCeti.isAcute_iff_inf_orthogonal_eq_bot`
- `TauCeti.DavisKahan.IsUniformlyAcute`
- `TauCeti.isAcute_of_projectionGap_lt_one`
- `TauCeti.directedProjectionGap_lt_one_of_transverse`
- `TauCeti.projectionGap_lt_one_of_isAcute`
- `TauCeti.isAcute_iff_projectionGap_lt_one`
- `TauCeti.one_le_projectionGap_of_forall_exists_unit_lt`
- `TauCeti.DavisKahan1970.Section3AcuteCounterexample.exists_isAcute_projectionGap_eq_one`

**Notes.** The predicate is broadly used but lacks a numbered source alias.
...
**importance:** `supporting`  **section:** 3  **source:** Proposition 3.1  **kind:** proposition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** In the acute case the direct rotation exists, is unique, and positivity of its diagonal blocks characterizes it.
...
- `TauCeti.DavisKahan1970.complex_directRotation_iff_diagonalBlocks`
- `TauCeti.DavisKahan1970.real_directRotation`
- `TauCeti.DavisKahan1970.real_directRotation_orthogonal`
- `TauCeti.DavisKahan1970.real_directRotation_intertwines`
- `TauCeti.DavisKahan1970.real_directRotation_maps_subspace`
- `TauCeti.DavisKahan1970.real_directRotation_maps_orthogonalComplement`
- `TauCeti.DavisKahan1970.real_directRotation_diagonalBlock`
- `TauCeti.DavisKahan1970.real_directRotation_complementaryDiagonalBlock`
- `TauCeti.DavisKahan1970.real_directRotation_principal_of_sq`
- `TauCeti.DavisKahan1970.real_directRotation_of_diagonalBlocks`
- `TauCeti.DavisKahan1970.real_directRotation_iff_diagonalBlocks`
- `TauCeti.DavisKahan1970.complex_directRotation_reflectionConjugate_of_positiveDiagonalBlocks`
- `TauCeti.DavisKahan1970.complex_directRotation_of_positiveDiagonalBlocks`
- `TauCeti.DavisKahan1970.complex_directRotation_iff_positiveDiagonalBlocks`
- `TauCeti.DavisKahan1970.real_directRotation_of_positiveDiagonalBlocks`
- `TauCeti.DavisKahan1970.real_directRotation_iff_positiveDiagonalBlocks`
- `TauCeti.DavisKahan.eq_directRotationR_iff_diagonalBlocks_pos`
- `TauCeti.DavisKahan.isPositive_of_complexify`
- `TauCeti.DavisKahan.isPositive_canonicalAbsoluteValueR`
- `TauCeti.DavisKahan1970.acute_directRotation`
- `TauCeti.DavisKahan1970.acute_directRotation_existsUnique`
...
**ADJUDICATED 2026-08-10 AND CONFIRMED NOT EXACT (Claude Opus 5, coordinator-verified).  THE GAP IS GENUINELY PRINTED.**  Printed Prop 3.1 (L850-852) is "in the acute case", i.e. printed Definition 3.2 (L847-848): `TauCeti.IsAcute U V`.  Every compiled endpoint instead takes `TauCeti.DavisKahan.IsUniformlyAcute U V = subspaceGap U V < 1`, which THIS REPOSITORY PROVES IS STRICTLY STRONGER in infinite dimension (`isAcute_of_projectionGap_lt_one` one way; the converse only in `FiniteDimensional`).  The paper's own proof of Prop 3.1 (L853-898) uses nothing but Definition 3.2, and Section 3 is explicitly infinite-dimensional (the bilateral-shift remark at L911-916, continuous spectrum at L1139).

PRECISE MISSING STATEMENT: *Let `U, V` be closed subspaces of a real or complex Hilbert space with `U inf Vperp = bot` and `Uperp inf V = bot`, together with (1.5).  Then a unitary `W` with `W P_U = P_V W` and both diagonal compressions positive exists, is unique, and any such `W` equals it.*
...
**THE GAP WAS LARGELY AN UNDERSCORE BINDER, AND THE COORDINATOR HAD A STANDING NOTE FOR EXACTLY THIS PATTERN.**  `spectraDirectRotation U V hacute` never depended on `hacute`: `DavisKahan/Geometry/Polar/DirectRotation.lean:225` binds it as `_hacute` and returns `spectraCanonicalPolarFactor U V`, whose docstring already said "the underlying polar factor is defined for every pair" (coordinator-read).  **The OBJECT was never gap-dependent; only the THEOREMS were.**  The construction is POLAR, not spectral, so bounded invertibility of `cos Theta` -- the coordinator's stated worry -- is never needed: a partial isometry is unitary exactly when both polar projections are `top`, which is precisely the vanishing of `ker S = (U inf Vperp) sup (Uperp inf V)`, i.e. printed Definition 3.2.  `Section3Nonacute.lean` already proved that kernel identity with NO acuteness at all.

WHERE `IsUniformlyAcute` IS genuinely essential is the OTHER branch: `spectraDirectRotation_eq_reflectionProductHalfPhase` needs `-1 not in spectrum (J_V J_U)`, which merely acute pairs can fail.  Everything routed through it was replaced.

**SUBSUMPTION IS MACHINE-CHECKED:** `eq_spectraDirectRotation_iff_diagonalBlocks_pos_of_isAcute` and `eq_directRotationR_iff_diagonalBlocks_pos_of_isAcute` have ELABORATED SIGNATURES BYTE-IDENTICAL to the existing `IsUniformlyAcute` endpoints, derived via `isAcute_of_projectionGap_lt_one`.  Nothing is lost.  A worthwhile by-product: `real_directRotation_eq_acute_directRotation` proves the complexification-descended real direct rotation IS the real polar factor, proved from the new uniqueness using only `directRotationR`'s existence-side facts, so it is not circular.
...
**importance:** `supporting`  **section:** 3  **source:** Proposition 3.2  **kind:** proposition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** A direct rotation exists exactly when the two crossed intersections have equal dimension; it is then nonunique.

**Scope gap.** NO SCOPE GAP REMAINS.  Closed 2026-08-10 (Claude Opus 5, coordinator-verified).  Both printed pieces are compiled AND the real-scalar axis is closed: five `_real` endpoints over `InnerProductSpace R` at unrestricted dimension, each grounded on the generic theorem by `:=`.  COORDINATOR ELABORATED the signature of `proposition3_2_not_unique_real`: it carries ONLY `NormedAddCommGroup`, `InnerProductSpace R`, `CompleteSpace`, the two subspaces with `HasOrthogonalProjection`, and the two printed hypotheses.  The three functional-calculus binders live on the generic statement and are discharged by inference at `R`; they do NOT appear in the real signature.  No finite dimension, no separability, no compactness, no degeneracy hypothesis.

One presentational caveat, unchanged from the complex form and already recorded: `l^2(Z)` is presented as any Hilbert space carrying a `HilbertBasis Z K`.  That is a presentation choice, not a hypothesis change.
...
- `TauCeti.DavisKahan1970.proposition3_2_not_existsUnique`
- `TauCeti.DavisKahan1970.proposition3_2_crossing_square_minus_one`
- `TauCeti.DavisKahan1970.remark3_2_bilateralShift_separates_dimensionHypotheses`
- `TauCeti.DavisKahan.halmosSourceDefect_coordinateHalfSpace`
- `TauCeti.DavisKahan.halmosTargetDefect_coordinateHalfSpace`
- `TauCeti.DavisKahan.halmosSourceDefect_ne_bot_of_not_isAcute`
- `TauCeti.DavisKahan1970.proposition3_2_exists_iff_crossedDefectsEquivalent_real`
- `TauCeti.DavisKahan1970.proposition3_2_parameterized_nonuniqueness_real`
- `TauCeti.DavisKahan1970.proposition3_2_not_unique_real`
- `TauCeti.DavisKahan1970.proposition3_2_not_existsUnique_real`
...
**IN THE BUILD 2026-08-06.**  `DavisKahan/Experimental/Frontier/{Core,Section3,Section4}.lean` became admission-free and were promoted to `DavisKahan/Frontier/`, reached from `DavisKahan.All` via `DavisKahan.Sources.DavisKahan1970.Section8.All`.  Nothing was renamed -- the `TauCeti.DavisKahan.Experimental.Frontier` namespaces are untouched, exactly as in the 84-module promotion earlier the same day, because the namespace has never been tied to the directory here.  The census declaration probe now resolves 145/145 against `DavisKahan.All`, up from 143/145, and these two declarations are the two that changed.  `check_library_structure` rule 3 drops from 16 violations to 13.
...
* `proposition3_2_exists_iff_crossedDefectsEquivalent (U V : Submodule C H) : (exists T, IsDirectRotation U V T) <-> CrossedDefectsEquivalent U V` -- the printed existence criterion, for arbitrary complete complex Hilbert spaces, with NO finite-dimensionality, NO separability and NO compactness hypothesis.  `CrossedDefectsEquivalent` is a linear isometry equivalence between the two crossed defect subspaces, which is the cardinal-free way to say "equal dimension", so the dimension bookkeeping the old blocker demanded is not needed and was never on the path.
* `proposition3_2_parameterized_nonuniqueness ... : CrossedDefectsEquivalent U V -> exists build, (forall J, IsDirectRotation U V (build J)) and Function.Injective build` -- the printed nonuniqueness, as an injective parameterization by the isometries between the defects, which is stronger than merely exhibiting two.
...
### `S3-standing-scope` — Standing crossing-dimension convention

**importance:** `technical`  **section:** 3  **source:** Section 3, standing convention stated immediately after the proof of Proposition 3.2.  **kind:** scope_claim  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** From this point on the paper assumes (3.5) as well as (1.5) except where the contrary is stated, so a direct rotation always exists and the development uses its direct special case (3.6).
...
**Notes.** ADDED 2026-08-12.  This organizational block exists because the standing convention is a source SCOPE assertion that governs later results and therefore cannot live inside the Proposition 3.2 result block, whose boundary partition is reserved for that proposition's own printed statement.  It mirrors `S2-unbounded-scope`.  Verified against the original paper: the sentence reads "We shall assume (3.5) as well as (1.5) except where stated otherwise.  Consequently the direct rotation will always exist, and rather than the more general V of (1.6) we shall deal mostly with its direct special case U ~ (C0, -S0*; S0, C1), Cj >= 0."  It is not a new result and does not enlarge the 29-result denominator.
...
**importance:** `supporting`  **section:** 3  **source:** Proposition 3.3  **kind:** proposition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Every direct rotation is a principal square root of the product of the two reflections; conversely a suitable principal square root is a direct rotation.
...
The self-adjointness hypotheses on the two diagonal compressions are *not* a specialization of the source: they are the same two Proposition 3.1 needs, and they are needed because this repository's `IsDirectRotation` records the compressions only through their numerical range, which is strictly weaker than the printed "positive diagonal blocks".  The canonical direct rotation satisfies them, its diagonal blocks being the positive Halmos cosine.

**The self-adjointness hypotheses are gone in the printed form.**  `proposition3_3_principalSquareRoot_forward_of_nonneg_blocks` states the forward direction with the diagonal compressions *positive as operators*, which is what the source prints, and needs no side hypothesis: a positive operator is self-adjoint and has nonnegative numerical range, so both of the weaker conditions this repository's `IsDirectRotation` records come for free.  It also returns `IsDirectRotation` itself, so the printed hypotheses alone give the printed conclusion.
...
**importance:** `supporting`  **section:** 3  **source:** Proposition 3.4  **kind:** proposition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** When the cosine block squared is at least one half, U squared is the direct rotation from the reflected subspace to the target subspace.
...
- `TauCeti.DavisKahan.re_inner_halmosCosineSq_self`
- `TauCeti.DavisKahan.isSelfAdjoint_source_block_spectraDirectRotation`
- `TauCeti.DavisKahan.isSelfAdjoint_complement_block_spectraDirectRotation`
...
**importance:** `major`  **section:** 3  **source:** Theorem 3.1  **kind:** theorem  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Spectral multiplicity functions of the two angle operators classify dimension-compatible subspace pairs up to isometric equivalence.

**Scope gap.** **THIS FIELD WAS REWRITTEN 2026-08-10 AFTER A READ-ONLY CONSUMER CHECK; ITS TWO PREDECESSORS WERE BOTH WRONG.**  The first claimed every declaration on this row is `InnerProductSpace C` only (23 of 28 are `RCLike`-generic or `R` instances).  The second named `MultiplicityDatum` and `OperatorUnitaryEquiv` as the two definitions hardcoding `C`; `OperatorUnitaryEquiv` is `RCLike`-generic, and `MultiplicityDatum`'s blocking hardcode is `operator`'s `Lp C 2` / `->L[C]`, NOT `base : Measure C`.

**THE ACTUAL REMAINING GAP IS ONE SENTENCE OF THE PRINTED THEOREM, IN THE NONCOMPACT CASE ONLY.**  Real and axiom-clean today, coordinator-probed: `twoProjection_operator_classification_real` (the full biconditional, no compactness, no separability, no finite dimension), `theorem3_1_realization` at `k = R`, and Corollary 3.1 in all three real forms -- which IS the paper's own multiplicity phrasing in the compact case.  What is missing over `R` is only the phrase "spectral multiplicity function" for NONCOMPACT operators, i.e. Hahn--Hellinger over a real Hilbert space, which Mathlib does not have and which the paper itself imports from Halmos 1951 rather than proving.

THE BLOCKER REFERENCE IS RETAINED AND HONEST -- the printed sentence is not yet real at noncompact -- but it should be read as **"real Hahn--Hellinger for the noncompact multiplicity phrasing"**, NOT as "real scalars", and NOT as anything about the SPECTRUM parameter.  `MultiplicityDatum.base : Measure C` is the spectrum parameter and is already off-paper at COMPLEX `H`, since the paper's multiplicity function is a function of a real parameter at either scalar.  **NO CONSUMER IN THE REPOSITORY NEEDS A REAL-PARAMETER DATUM: measured, zero.**  See `notes` for the consumer census, for why the six-module real-spectrum transport layer is disjoint from this axis, and for four false statements in this row that the check retracted.

**THE REMAINING ITEM IS MEASURED AND SCOPED, 2026-08-11 (Claude Opus 5; measurement mission, NOTHING BUILT, baseline reproduced exactly: build 9623 jobs BUILD_EXIT=0, seven checks EXIT=0, four ratchets flat at 165/51/51/91, baselines flat at 13/154/16).**

**WHAT THE CLASSIFICATION CLAUSE ACTUALLY CONSUMES IS THREE DECLARATIONS.**  `Section3.theorem3_1_spectralMultiplicity_classification_complex` (`DavisKahan/Frontier/Section3.lean:2443`) has an EIGHT-LINE proof and uses only `Frontier.SameSpectralMultiplicity`, `Frontier.sameSpectralMultiplicity_of_unitarilyEquivalent` and `Frontier.unitarilyEquivalent_of_sameSpectralMultiplicity` (`Frontier/Core.lean:82,112,97`).  `SameSpectralMultiplicity` has EXACTLY ONE CONSUMER in the repository, and that consumer has none.  It does NOT consume `SpectralMultiplicityFoundation`, `MultiplicityDatum.multiplicity`, `mem_level_iff`, `measurable_multiplicity`, or ANY uniqueness result -- the consumer-check rule paid off for a third time on this repository.

**AND THE CLASSIFICATION CONTENT IS ALREADY AT REAL SCALARS.**  `Section3.twoProjection_operator_classification` is `RCLike`-generic carrying the `[Algebra R ...] [IsScalarTower R 𝕜 ...] [ContinuousFunctionalCalculus R ... IsSelfAdjoint]` triple, and `Section3.twoProjection_operator_classification_real` (`Section3.lean:2973`) already instantiates it -- no separability, no compactness, no finite dimension.  **What is missing over R is only the TRANSLATION of that invariant into MULTIPLICITY language.**

**THE GAP IS ONE AXIS, NOT TWO, AND THE COORDINATOR'S FRAMING WAS WRONG.**  The symbol domain is not an axis: `Lp R 2` over a `Measure C` is type-legal.  The blocker is `MultiplicityDatum.operator`, whose type is `Lp C 2 D.measure ->L[C] Lp C 2 D.measure`.  Since `OperatorUnitaryEquiv` (already `RCLike`-generic) requires both operators over the SAME 𝕜, `A` is pinned to C **by the model, not by the definition's binders**.  Removing C means making `operator` field-indexed -- a RESTATEMENT of `MultiplicityDatum`, not a generalization in place.  `MeasureEquiv` is field-free.

**THE FIVE `RealSpectrum*` MODULES GENUINELY DO NOT COMPOSE, AND THE FAILURE IS EARLIER THAN GOVERNANCE.**  Machine-checked: `failed to synthesize Algebra C (E ->L[R] E)`.  The stack fails at the VERY FIRST typeclass at a real Hilbert space, before any CFC question arises.  `RealSpectrum` there means real spectral PARAMETER, not real scalar field -- their own headers say so.

**THE COORDINATOR'S `Measure R` HYPOTHESIS IS WRONG AS A LEVER, AND WAS ALREADY REJECTED.**  `dev/failed-proof-directions-2026-08-10.md` section 1.2 states verbatim that a real parameter is neither necessary nor sufficient; `MultiplicityDatum : Type` takes no parameters at all.  The two CFC facts the coordinator cited are individually TRUE and were re-verified (`ContinuousFunctionalCalculus C (H ->L[C] H) IsSelfAdjoint` really does fail to synthesize; the R-symbol class really is present at both fields), but the conclusion drawn from them had already been measured and rejected.

**DESCENT IS OBSTRUCTED HERE FOR A REAL REASON.**  The repo's two working descent precedents both succeed because the complex object is CANONICAL -- a Hausdorff limit, or a polar factor with invertible modulus.  A unitary-equivalence WITNESS is not canonical: it is unique only up to the commutant of `A_C`, so an arbitrary intertwiner need not commute with the conjugations and nothing forces it to.  Mathematics, not a Lean difficulty.

**WHAT IS ACTUALLY MISSING IS REAL HAHN-HELLINGER, AND MATHLIB HAS IT FOR NO FIELD.**  No Borel functional calculus, no cyclic-vector theory, no multiplication model; its only 𝕜-generic spectral theorem is finite-dimensional.  This repository DOES have a real CFC in unrestricted dimension, so the route is not blocked at the CFC layer -- but nothing between the CFC and the multiplication model exists over R.  Sizing: `BorelCalculus` is 18 modules / 5989 lines plus ~905 lines of `Lp C 2`-hardcoded measure theory.

NAMED BASE-LAYER MISSION IF THE OWNER WANTS THE PROGRAMME: *conjugation-equivariant cyclic decomposition* -- run the complexification's countable cyclic decomposition with cyclic vectors drawn from the real copy, so each cyclic isometry intertwines `conjugation` on `E_C` with complex conjugation on `Lp C 2 mu`, where `BorelCalculus.map_ofReal_realSpectrumDiagMeasure` already puts mu on the real spectrum; deliverable, a real analogue of `exists_countable_isHilbertSum_lp_diagMeasure_complex`.  **THIS IS AN ESTIMATE, NOT A FINDING**, and section 5 of the failed-directions doc records that estimates on this row have been false in BOTH directions.

PROCESS NOTE WORTH KEEPING: `BorelCalculus.map_ofReal_realSpectrumDiagMeasure` is **not reachable from `DavisKahan.All`** -- it is a `ForTauCeti` module built only by the lakefile glob, so an axiom probe importing `DavisKahan.All` alone silently MISSES it.

**PROMOTED TO `compiled_exact` AND THE BLOCKER COMES OFF, 2026-08-11.  REAL HAHN-HELLINGER IS BUILT (coordinator-verified: build 9626 -> 9629 jobs, BUILD_EXIT=0 read from the echoed log line after waiting for it, zero errors, seven checks EXIT=0, four ratchets flat at 165/51/51/94, baselines flat at 13/154/16).**  Closing declaration: `Section3.theorem3_1_spectralMultiplicity_classification_real`.  The owner directed that the missing theory be BUILT rather than adjudicated around, and it was, in four missions.

M1 `exists_countable_isHilbertSum_lp_diagMeasure_real` -- countable cyclic decomposition with all cyclic vectors in the real copy, each isometry intertwining `conjugation` with `star`.  M2 `starFixedLpEquivRealLp : starFixedSubmodule K p mu ≃ₗᵢ[R] Lp R p mu`, absent from Mathlib.  M3 `starFixedInvariant_iff_base_im_eq_zero` -- a BICONDITIONAL -- plus star-equivariance of every assembly step.  M4 the transport and the row.

**THE PROBE THAT GATED M4 CAME BACK FAVOURABLE, AND THE REASON IS REUSABLE.**  `star_linearIsometryEquiv_trans_symm_of_isHilbertSum` shows the Hilbert-sum unitary's equivariance needs only ADDITIVITY AND CONTINUITY of the structure maps -- no conjugate-linearity, no involutivity, no inner-product compatibility -- because `Submodule.iSup_induction` generates the supremum of the summand ranges under ADDITION ALONE, each range being already C-stable, so the scalar structure of the supremum is never re-examined.  **No field-change of `IsHilbertSum` was needed**, which was the feared bleed.

**THE SECOND TRANSFER DIRECTION WAS UNEXPECTEDLY CHEAP AND REFUTES A RECORDED CLAIM.**  `Frontier/Core.lean`'s docstring said the `<-` direction is stuck because `operatorUnitaryEquiv_of_measureEquiv_complex` uses the complex `rnDerivL2Equiv` API and generalizing it is `separate mathematics'.  That inference is WRONG: `operatorUnitaryEquiv_of_measureEquiv_real` runs the COMPLEX `rnDerivL2Equiv` against the symbol `Complex.ofReal . coordTruncField R R . Prod.fst`, which is real-valued and therefore commutes with `star` for ANY base measure, and descends.  Nothing was generalized.  It needs neither separability nor reality of the base.

**THE RISK RANKING IN THE COORDINATOR'S BRIEF WAS INVERTED, and the reason is worth keeping.**  E3, named highest risk, was free once the probe landed.  E4, estimated at ~40 lines, was the expensive step: **`Module R (RealComplexification E)` has TWO NON-DEFEQ INSTANCES** -- `instModuleReal` and `NormedSpace.complexToReal.toModule` -- bridged only by the theorem `coe_real_smul`, so any bundled `→ₗᵢ[R]` crossing that boundary is rejected.  The descent lemma therefore takes its inclusions UNBUNDLED, with homogeneity stated as `jE (c . x) = (c : C) . jE x`, mentioning only the complex action.

ALSO CORRECTED: `MultiplicityDatum` no longer has exactly one construction site -- there are now two plus `retype` -- though the substance stands, that `base_supported_real` as a FIELD would make `exists_hasMultiplicityModel` unprovable.  `D.base {z | im z != 0} = 0` is delivered as a CONCLUSION by `exists_hasMultiplicityModel_star`, from `IsSelfAdjoint.im_eq_zero_of_mem_spectrum`, never as a field.  And this row's note that `DavisKahan.Experimental.Frontier` `is built by no default target' is FALSE today: `DavisKahan/Frontier/All.lean` is imported by `DavisKahan/All.lean`, proved by a sentinel that errored under plain `lake build`.

CENSUS-GATE NOTE 2026-08-11: `TauCeti.MultiplicityDatum.retype` is deliberately NOT in `lean_declarations`.  It elaborates and is axiom-clean, but `MultiplicityDatum.measure`/`.operator`/`.retype` are not `@[expose]`, so the census declaration probe does not resolve it -- and exposing them to satisfy the probe would raise the expose ratchet off 165 for bookkeeping reasons.  The row's obligations are carried by the `*_real` endpoints regardless.  Same shape as the `HasUnboundedSylvesterKyFan` note on `DK-6-appendix`.

**Lean declarations:**

- `TauCeti.DavisKahan.SameHalmosCosineBlockInvariant`
- `TauCeti.DavisKahan.pairOfSubspacesUnitaryEquivalent_iff_sameHalmosCosineBlockInvariant`
- `TauCeti.DavisKahan.exists_cosineBlockEquiv_of_pairEquiv`
- `TauCeti.DavisKahan.pairOfSubspacesUnitaryEquivalent_of_cosineBlockEquiv`
- `TauCeti.DavisKahan.genericTransport`
- `TauCeti.DavisKahan.pairOfSubspacesUnitaryEquivalent_of_summandEquivs`
- `TauCeti.SameSpectralMultiplicity`
- `TauCeti.sameSpectralMultiplicity_iff_operatorUnitaryEquiv_complex`
- `TauCeti.operatorUnitaryEquiv_of_sameSpectralMultiplicity_complex`
- `TauCeti.sameSpectralMultiplicity_of_operatorUnitaryEquiv_complex`
- `TauCeti.DavisKahan1970.theorem3_1_spectralMultiplicity_classification_complex`
- `TauCeti.DavisKahan1970.twoProjection_operator_classification`
- `TauCeti.DavisKahan.HalmosAngleDatum`
- `TauCeti.DavisKahan.HalmosAngleDatum.starProjection_targetSubspace_apply`
- `TauCeti.DavisKahan.HalmosAngleDatum.compress_source_eq`
- `TauCeti.DavisKahan.HalmosAngleDatum.compress_sourceOrthogonal_eq`
- `TauCeti.DavisKahan.HalmosAngleDatum.halmosCommonPart_eq`
- `TauCeti.DavisKahan.HalmosAngleDatum.halmosSourceDefect_eq`
- `TauCeti.DavisKahan.HalmosAngleDatum.halmosTargetDefect_eq`
- `TauCeti.DavisKahan.HalmosAngleDatum.halmosExteriorPart_eq`
- `TauCeti.DavisKahan.HalmosAngleDatum.crossedDefectEquiv`
- `TauCeti.DavisKahan.HalmosAngleDatum.nonempty_halmosSourceDefect_equiv_targetDefect`
- `TauCeti.DavisKahan.trivialHalmosAngleDatum`
- `TauCeti.DavisKahan.trivial_halmosCommonPart_eq`
- `TauCeti.DavisKahan.trivial_halmosExteriorPart_eq`
- `TauCeti.DavisKahan1970.theorem3_1_realization`
- `TauCeti.DavisKahan1970.theorem3_1_realization_zeroAngle_unconstrained`
- `TauCeti.DavisKahan1970.twoProjection_operator_classification_real`
...
- `TauCeti.DavisKahan.RealSpectralRestriction.sameSpectralMultiplicity_of_operatorUnitaryEquiv_real`
- `TauCeti.DavisKahan.RealSpectralRestriction.operatorUnitaryEquiv_of_sameSpectralMultiplicity_real`
- `TauCeti.DavisKahan.RealSpectralRestriction.exists_hasMultiplicityModel_real`
- `TauCeti.BorelCalculus.exists_hasMultiplicityModel_star`
- `TauCeti.operatorUnitaryEquiv_of_measureEquiv_real`
- `TauCeti.StarOperatorUnitaryEquiv`
...
| Conversely the angle operators may be arbitrary Hermitian operators satisfying 0 <= Theta_j <= pi/2. | The canonical realization witness is `theorem3_1_realization`, which consumes a `HalmosAngleDatum` -- cos and sin of both angle operators together with the intertwiner. `theorem3_1_realization_ofAngles`, registered as supporting, is the same theorem restated in the printed shape: two Hermitian angle operators and one intertwining partial isometry, with the printed confinement `0 <= Theta_j <= pi/2` bound as an explicit (and deliberately unused) hypothesis, and each cos and sin read as the continuous functional calculus of Theta_j rather than as an opaque field. | claimed_exact |
...
**PROVED 2026-08-06, in the paper's multiplicity phrasing, admission-free.**  The remaining gap this row recorded -- "what remains for the literal printed sentence is a multiplicity theory Mathlib does not have" -- is closed.  `Frontier.SameSpectralMultiplicity` is no longer a `sorry`ed `def`; `Frontier.sameSpectralMultiplicity_iff_unitarilyEquivalent` and `Frontier.Section3.theorem3_1_spectralMultiplicity_classification_complex` are proved, and `#print axioms` gives exactly [propext, Classical.choice, Quot.sound] on all of them.
...
**STEP 2 OF THE SURVIVING ROUTE IS BUILT, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9593 EXIT=0, six gates EXIT=0, baselines flat, probe from outside the source tree).  NO OBSTRUCTION WAS FOUND.**  `ForTauCeti/Analysis/InnerProductSpace/RealSpectrumBorelSymbols.lean`, namespace `TauCeti.BorelCalculus`, one new module, NOTHING under `BorelCalculus/` edited.

The predicted brick count held exactly: the only new mathematics was that `IsBddMeasurable` transports in BOTH directions across `realSpectrumHomeomorph` (`Measurable` because `Subtype.borelSpace` gives both spectra the subspace Borel sigma-algebra and the homeomorphism is continuous each way; the uniform bound because reindexing does not change the range), plus the resulting linear equivalence.

Names copied from source: `IsRealSpectrumBddMeasurable` (structure), `IsRealSpectrumBddMeasurable.add`, `IsRealSpectrumBddMeasurable.const_smul`, `realSpectrumBddSymbols`, `mem_realSpectrumBddSymbols`, `isRealSpectrumBddMeasurable_coe`, `measurable_realSpectrumHomeomorph`, `measurable_realSpectrumHomeomorph_symm`, `IsRealSpectrumBddMeasurable.comp_realSpectrumHomeomorph`, `IsBddMeasurable.comp_realSpectrumHomeomorph_symm`, `isBddMeasurable_comp_realSpectrumHomeomorph_iff`, `realSpectrumBddSymbolsEquiv`, `coe_realSpectrumBddSymbolsEquiv`, `coe_realSpectrumBddSymbolsEquiv_symm`, `realSpectrumBddSymbolsEquiv_apply_apply`.  **THE DELIVERABLE** is `realSpectrumBddSymbolsEquiv (ha : IsSelfAdjoint a) : realSpectrumBddSymbols a ~=l[C] bddSymbols a`.

**A COORDINATOR CITATION WAS WRONG AND HAD BEEN REPEATED IN FOUR BRIEFS.**  I wrote, repeatedly, "`dev/davis-kahan-1970-completion-handoff.md` line 582 says do not descend an arbitrary complex defect isometry by taking real parts, reason at line 591".  THE TWO LINES ARE DIFFERENT ADJUDICATIONS ON DIFFERENT ROWS.  Line 582 sits under `#### D.2 DK-3.2-prop` and concerns DEFECT ISOMETRIES; its reason is the two bullets at 584-587 (generalize `Section3Nonacute` to `RCLike`, or build natively from a real crossed-defect isometric equivalence).  Line 591 opens `#### D.3 DK-3.1-thm` and is the claim relevant to THIS row: the classification contains existential unitary equivalences of invariant data, and an arbitrary complex unitary equivalence need not commute with conjugation.  So the prohibition I kept quoting at missions on THIS row does not bind here at all; the one that does is 591.  Verified by reading lines 578-594.

**TWO BASELINE PHRASINGS OF MINE INVITE PHANTOM REGRESSIONS, corrected here.**  "dependency layers 7" is a count of VIOLATIONS, and that check EXITS 1.  So do `check_docstring_coverage` and `check_library_structure`.  Only the SIX named gates are EXIT=0; the three baseline checks and the three ratchets are all red at baseline by construction.

LADDER: 84 -> **85**, +1, and it is NOT absorbed.  The one finding is this module being on no rung, and the cause is pre-existing: **no rung carries topic T28 at all**, and `BorelCalculus.CyclicModel` -- which this module imports -- is itself off-ladder.  Inventing a rung for a whole topic is a Tau Ceti submission-ordering decision for the repository owner, not a mid-integration coordinator action, so it is left open deliberately.  The `TOPICS` row WAS added (T28, "Cyclic subspaces, the multiplication model, and Hahn-Hellinger existence"), which is what readiness reads, and readiness is back at 51.

**NEXT MISSION, and it is the MEASURE side, not the symbol side -- a distinction the coordinator's brief did not name.**  The symbol side now composes: `(symbolCalculus hn xi).comp (realSpectrumBddSymbolsEquiv ha)` and `(symbolToLp hn xi).comp (realSpectrumBddSymbolsEquiv ha)` both elaborate today with no further glue.  What is open is that `cyclicIsometry` lands in `Lp C 2 (diagMeasure ha xi)` over `spectrum C a`; restating it over `spectrum R a` needs the scalar spectral measure PUSHED FORWARD and then an `Lp` transport.  Two Mathlib entry points confirmed to elaborate at these types: `(realSpectrumHomeomorph ha).toMeasurableEquiv : spectrum C a ~=m spectrum R a` and `(diagMeasure hn xi).map (realSpectrumHomeomorph ha) : Measure (spectrum R a)`.  Scope the next mission to: define the real-spectrum diagonal measure as that pushforward, prove the `MeasurePreserving` statement, transport `Lp C 2` across it -- and STOP.  The `cyclicIsometry` / `range_cyclicIsometry` rewrite must keep its own compile budget, because `range_cyclicIsometry` is exactly where the refuted route died.

**STEP 3 OF THE SURVIVING ROUTE IS BUILT AND THE `Lp` TRANSPORT IS A FULL LINEAR ISOMETRIC EQUIVALENCE, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9594 EXIT=0, six gates EXIT=0, baselines flat, concrete-operator probe from outside the source tree).**  `ForTauCeti/Analysis/InnerProductSpace/RealSpectrumDiagonalMeasure.lean`, namespace `TauCeti.BorelCalculus`, one new module, NOTHING under `BorelCalculus/` edited.  No obstruction remains on the measure side.

Names copied from source: `realSpectrumDiagMeasure`, `realSpectrumDiagMeasure_eq_map`, `instIsFiniteMeasure_realSpectrumDiagMeasure`, `measurePreserving_realSpectrumHomeomorph`, `measurePreserving_realSpectrumHomeomorph_symm`, `realSpectrumDiagMeasure_apply`, `integral_realSpectrumDiagMeasure`, `realSpectrumDiagMeasureLpEquiv`, `realSpectrumDiagMeasureLpEquiv_apply`, `realSpectrumDiagMeasureLpEquiv_symm_apply`, `coeFn_realSpectrumDiagMeasureLpEquiv`, `coeFn_realSpectrumDiagMeasureLpEquiv_symm`.

THE ONE PIECE OF REAL WORK: Mathlib supplies `Lp.compMeasurePreservingLI` in each direction but NO equivalence.  Composing them gives `Lp.compMeasurePreserving (e.symm . e) _`, whose FUNCTION argument is a composite rather than `id`, so `Lp.compMeasurePreserving_id_apply` does not apply and `rw` cannot fix it (rewriting the function would retype the `MeasurePreserving` argument).  The fix is a private helper taking `(hf : f = id)` and `subst`ing it, which retypes the hypothesis; `MeasurePreserving` being a `Prop` then makes the substituted proof defeq to `MeasurePreserving.id`.  That is the entire delta.

**A COORDINATOR BRIEF USED A WITNESS THAT DOES NOT TYPECHECK.**  I wrote `diagMeasure ha xi` with `ha : IsSelfAdjoint a`.  `TauCeti.BorelCalculus.diagMeasure` takes `IsStarNormal a`, while `realSpectrumHomeomorph` takes `IsSelfAdjoint a`; ONE WITNESS CANNOT SERVE BOTH.  Every statement in the new module is therefore spelled `diagMeasure ha.isStarNormal xi`.  Downstream consumers holding a bare `hn : IsStarNormal a` still match, by proof irrelevance.

**THERE IS A FOURTH RED-BY-CONSTRUCTION CHECK THAT THIS CAMPAIGN'S BASELINE LIST OMITTED.**  `scripts/check_tauceti_roadmap_topics.py --check` is EXIT=1 at **51 violations** (46 pre-existing `UNASSIGNED` modules).  It is not among the six gates, the three baseline checks, or the three ratchets I had been tracking.  It is COUPLED to readiness -- `check_tauceti_readiness.py` reads topic assignment FROM it (verified in that file's own header comment), which is why both sat at 51 and both move together when a module is unplaced.  Adding the `TOPICS` row fixes both at once.

MY OWN EARLIER CITATION CORRECTION WAS ITSELF TWO LINES OFF, recorded for accuracy: the `#### D.3 DK-3.1-thm` HEADING is at line 589; line 591 is the body paragraph carrying the adjudication.  The substance attributed to 591 is correct and is on 591.  D.2 checks out exactly: heading 572, "Real scalar form" 582, bullets 584-585, "Search ..." 587.  NEITHER adjudication binds the measure-transport work.

RATCHETS: `TOPICS` row added under T28, restoring roadmap-topics 51 and readiness 51; expose unchanged at 165.  Ladder 85 -> **86**, +1, the single off-ladder finding for this module, cause unchanged and pre-existing: NO RUNG CARRIES TOPIC T28, and ten T28 modules already carry that same error at baseline.

**NEXT MISSION, and the composite is already proved to elaborate and be axiom-clean at a CONCRETE self-adjoint operator (coordinator-probed on `Submodule.starProjection` over `EuclideanSpace C (Fin 2)`):** `(cyclicIsometry ha.isStarNormal xi).comp (realSpectrumDiagMeasureLpEquiv ha xi).toLinearIsometry : Lp C 2 (realSpectrumDiagMeasure ha xi) ->li[C] H`.  Scope it to `range_cyclicIsometry` over the real spectrum AND ONLY THAT: name the composite, and prove its range is `cyclicSubspace ha.isStarNormal xi` -- which should follow from the existing `range_cyclicIsometry` plus SURJECTIVITY of the equivalence, NOT from re-running the density argument.  [**RETRACTED 2026-08-10, SAME DAY: THIS POINTER WAS WRONG AND ACTIVELY MISLEADING -- see the step-4 entry below.**  Neither bridge is used or usable for the range; reaching for either means descending to almost-everywhere representatives, which IS the density rebuild the same sentence warns against.]  It still need not edit `BorelCalculus/`.  `range_cyclicIsometry` is where the refuted route died, so it keeps its own compile budget.

**STEP 4 CLOSES THE CYCLIC-MODEL HALF OF THE TRANSPORT, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9595 EXIT=0, six gates EXIT=0, baselines flat, range theorem elaborated at a CONCRETE self-adjoint operator from outside the source tree).**  `ForTauCeti/Analysis/InnerProductSpace/RealSpectrumCyclicModel.lean`, 171 lines, namespace `TauCeti.BorelCalculus`.  NOTHING under `BorelCalculus/` edited.  Compiled in 3.5s, first attempt, no errors.

**THE STATEMENT THAT KILLED THE REFUTED ROUTE IS NOW A THREE-LINE PROOF, AND IT NEEDED NO DENSITY.**  `range_realSpectrumCyclicIsometry (ha : IsSelfAdjoint a) (xi : H) : LinearMap.range (realSpectrumCyclicIsometry ha xi).toLinearMap = cyclicSubspace ha.isStarNormal xi`, proved by `LinearMap.range_comp_of_range_eq_top` against surjectivity of the transport, then `exact range_cyclicIsometry ha.isStarNormal xi`.  `denseRange_symbolToLp` is reached only THROUGH `range_cyclicIsometry`, and every use of it stays inside `BorelCalculus/CyclicModel.lean`.  The layering is right.

Names copied from source: `realSpectrumCyclicIsometry`, `realSpectrumCyclicIsometry_apply`, `realSpectrumCyclicIsometry_eq_borelCalculus`, `range_toLinearMap_realSpectrumDiagMeasureLpEquiv`, `range_realSpectrumCyclicIsometry`, `realSpectrumCyclicIsometry_mem_cyclicSubspace`, `exists_realSpectrumCyclicIsometry_eq`.

**THE COORDINATOR'S "TWO BRIDGES" POINTER, WRITTEN INTO THIS ROW ONE COMMIT EARLIER, WAS WRONG AND POINTED AT THE ONE ROUTE THAT WOULD HAVE LOOKED LIKE AN OBSTRUCTION.**  Neither `coeFn_realSpectrumDiagMeasureLpEquiv` nor `integral_realSpectrumDiagMeasure` is used, or usable: the range argument is purely algebraic.  Using either would mean descending to almost-everywhere representatives or change-of-variables on integrals -- exactly the density rebuild the same sentence told the mission to stop on.  Retracted in place above.  They ARE the right bridges for the INTERTWINING law, which is probably the source of the confusion.

**LADDER COST OF A NEW MODULE IS +3, NOT +1** -- this row said +1 twice.  One `on no rung` error PLUS TWO `document says 'of N ForTauCeti modules'; the tree has N+1` lines, because that count line occurs twice in the synced document.  `--sync` clears all three.  Also, the ladder error printed BEFORE the coordinator's `TOPICS` fixup is "it has no roadmap topic"; the "no rung carries T28" message is what appears AFTER it.

**THIS DOES NOT MOVE `SameSpectralMultiplicity`, AND THE REMAINING DISTANCE IS MORE THAN ONE STEP.**  Recorded plainly so the next scoping is honest.  (1) `BorelCalculus/CyclicDecomposition.lean`, `SeparableCyclic.lean` and `MultiplicityModel.lean` are all over `spectrum C a` and have no real-spectrum counterpart; transporting the DECOMPOSITION is not one composition, because it is an orthogonal family and needs compatibility with the orthogonality bookkeeping, not merely an isometry.  (2) The INTERTWINING law is not transported: `cyclicIsometry_coordMulLp` carries multiplication by the COMPLEX coordinate to `a`, while on `spectrum R a` the natural operator is multiplication by the REAL coordinate -- a different operator on the nose.  Cheap, but it is what layers 3-5 actually consume.  (3) `MultiplicityDatum` would itself need a real-parameter analogue (`base : Measure R`, `level : N -> Set R`) or a proved equivalence with the C-parameter data -- and THAT is the point at which the transport stops being additive.

[**DELIVERED 2026-08-10 -- see the step-5 entry below.  The sketched name `realCoordMulLp` is NOT what landed (it is `realSpectrumCoordMulLp`), and the sketched REASON was wrong: real-part-ness does not close it, reality of the spectrum does.**]

**STEP 5: THE INTERTWINING LAW IS TRANSPORTED, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9596 EXIT=0, six gates EXIT=0, baselines flat, law elaborated at a CONCRETE self-adjoint operator from outside the source tree).**  `ForTauCeti/Analysis/InnerProductSpace/RealSpectrumIntertwining.lean`, 300 lines, namespace `TauCeti.BorelCalculus`.  NOTHING under `BorelCalculus/` edited.  No obstruction arose; it elaborated on the first probe.

Names copied from source -- note the deliverable is `realSpectrumCoordMulLp`, NOT the `realCoordMulLp` this row sketched: `measurable_realCoord`, `norm_realCoord_le`, `isRealSpectrumBddMeasurable_realCoord`, `memLp_realCoord_mul`, `norm_toLp_realCoord_mul_le`, `realSpectrumCoordMulLp`, `realSpectrumCoordMulLp_apply`, `coeFn_realSpectrumCoordMulLp`, `realSpectrumDiagMeasureLpEquiv_realSpectrumCoordMulLp`, **`realSpectrumCyclicIsometry_realSpectrumCoordMulLp`** (the law), `realSpectrumCyclicIsometry_realSpectrumCoordMulLp_comp`, `apply_mem_cyclicSubspace_of_realSpectrum`.  The `realSpectrum` prefix matches the nine existing declarations of this family.

**THE COORDINATOR'S STATED REASON FOR WHY THE LAW HOLDS WAS WRONG, AND THE CORRECTION IS MATHEMATICAL, NOT COSMETIC.**  This row said the law follows because "`realSpectrumHomeomorph` IS the real-part map on the spectrum".  REAL-PART-NESS DOES NOT SUFFICE.  The multipliers to match at `z : spectrum C a` are `((realSpectrumHomeomorph ha z : R) : C)` and `(z : C)`, so the identity needed is `ofReal (re z) = z` -- FALSE at a general complex point, and true here ONLY because the complex spectrum of a SELF-ADJOINT operator is real.  The load-bearing lemma is `coe_realSpectrumHomeomorph` (which closes via `ha.spectrumRestricts.rightInvOn`), NOT `realSpectrumHomeomorph_apply_coe`.  Coordinator-verified by reading `RealSpectrumFunctionalCalculus.lean:153-156`.  Following the real-part lemma this row pointed at leaves an unprovable goal.

THE LAW ITSELF IS THREE `rw`s inside one `Lp.ext` + `filter_upwards` over four a.e. facts; the only measure theory is `MeasurePreserving.quasiMeasurePreserving.ae_eq_comp`.  `coeFn_realSpectrumDiagMeasureLpEquiv` WAS the right bridge here, used twice -- unlike for the range theorem, where this row wrongly recommended it.  **The expensive part was not the law but the BOUND machinery** (`memLp_realCoord_mul`, `norm_toLp_realCoord_mul_le`), 45 of the 300 lines, which the brief did not anticipate.  A pleasant surprise: no new bound constant was needed -- `(isBddMeasurable_coord (a := a)).chooseBound` bounds the real coordinate too, so no second `Classical.choose` enters and the operator-norm bound is literally the complex one.

ALSO CORRECTED: `RealSpectrumCyclicModel.lean:51-54` says relating the two coordinate multiplications is "a separate statement with its own cost".  The cost claim is wrong -- it is one `Lp.ext` and a `filter_upwards`, with zero new measure theory.

**REMAINING BEFORE `SameSpectralMultiplicity` CAN MOVE: TWO ITEMS, down from three.**  (1) The cyclic DECOMPOSITION (`CyclicDecomposition.lean`, `SeparableCyclic.lean`, `MultiplicityModel.lean`), still entirely over `spectrum C a`.  SHARPENED by this mission: since `realSpectrumDiagMeasureLpEquiv` is an `~=li[C]`, ORTHOGONALITY should carry mechanically (isometric equivalences preserve inner products), so the real obstacle is likely the INDEXING of the family and `MultiplicityModel`'s `embLpEquiv`/`coordTrunc` layer, NOT orthogonality.  (2) A real-parameter `MultiplicityDatum` (`base : Measure R`, `level : N -> Set R`), or a proved equivalence with the C-parameter data -- still where the transport stops being additive.  Also recorded: `MultiplicityModel.lean:350` consumes `cyclicIsometry_coordMulLp` inside `exists_hasMultiplicityModel`; that specific brick now exists over the real spectrum, so what remains AT THAT LINE is the `coordTrunc`/`embLpEquiv` machinery.

**STEP 6: THE DECOMPOSITION TRANSPORTS IN ONE LEMMA APPLICATION, AND THE MEASUREMENT REFUTES MOST OF THE COORDINATOR'S FRAMING, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9597 EXIT=0, six gates EXIT=0, baselines flat, concrete probe).**  `ForTauCeti/Analysis/InnerProductSpace/RealSpectrumCyclicDecomposition.lean`.  NOTHING under `BorelCalculus/` edited.

Names copied from source: `isHilbertSum_lp_realSpectrumDiagMeasure_of_isHilbertSum`, `exists_isHilbertSum_lp_realSpectrumDiagMeasure`, `exists_linearIsometryEquiv_lp_realSpectrumDiagMeasure`, `exists_countable_isHilbertSum_lp_realSpectrumDiagMeasure`, `exists_countable_isHilbertSum_realSpectrumCoordMulLp`, `map_ofReal_realSpectrumDiagMeasure`.

**FOUR FRAMING ERRORS, ALL THE COORDINATOR'S.**  (i) "`CyclicDecomposition.lean`, `SeparableCyclic.lean` and `MultiplicityModel.lean` are ALL stated over `spectrum C a`" is FALSE for all three: only FOUR declarations across them genuinely mention the spectrum-indexed `L^2` layer (`exists_isHilbertSum_lp_diagMeasure`, `exists_linearIsometryEquiv_lp_diagMeasure`, `exists_countable_isHilbertSum_lp_diagMeasure_complex`, `mulLp_eq_coordMulLp`); 20 of the other 21 are spectrum-free or binder-bound, and `MultiplicityModel.lean` is stated over `C` and `C x N` -- the subtype is already gone by then.  (ii) Orthogonality carries, but NOT for the stated reason: `TauCeti.isHilbertSum_comp_linearIsometryEquiv` never uses inner-product preservation; what needs the transport to be an EQUIVALENCE is the TOTALITY half.  (iii) INDEXING is not an obstacle at all -- the family is reused verbatim and `ha` is one witness shared across indices.  (iv) `embLpEquiv` is not an obstacle either: it is already fully field- and type-generic.

**THE OBSTRUCTION, PROVED RATHER THAN ASSERTED.**  `map_ofReal_realSpectrumDiagMeasure` shows that pushing the real-spectrum diagonal measure off its subtype INTO `C` -- the only push-forward a `MultiplicityDatum` (whose `base : Measure C`) can consume -- returns LITERALLY the measure `exists_hasMultiplicityModel` already builds from.  So a real-spectrum multiplicity model routed through `C` is the OLD theorem with a longer proof.  Also corrected: the real pin at `MultiplicityModel.lean` is NOT at line 350 but ~30 lines upstream, at `hemb : MeasurableEmbedding ((.) : spectrum C a -> C)` (lines 321-322), which would have to become an embedding out of `spectrum R a`.

**A STRATEGIC QUESTION THIS ROW MUST NOW CARRY, RAISED BY THE MISSION AND CONFIRMED BY THE COORDINATOR READING THE SOURCE.**  `SameSpectralMultiplicity` (`DavisKahan/Frontier/Core.lean:82`) sits under section variables `[InnerProductSpace C H1]` and `[InnerProductSpace C H2]` (`Core.lean:44-47`).  **THAT -- THE HILBERT-SPACE SCALAR -- IS THIS ROW'S RECORDED GAP, and it is a DIFFERENT AXIS from the one the six transport missions moved, which is the SYMBOL DOMAIN (`spectrum C a` -> `spectrum R a`) at a COMPLEX Hilbert space.**  `MultiplicityDatum.base : Measure C` is the SPECTRUM parameter, not the Hilbert scalar.  The transport work is sound, axiom-clean and reusable, and a real-parameter datum plausibly wants the real-spectrum layer underneath it -- but WHETHER IT MOVES THIS ROW IS NOW AN OPEN QUESTION AND MUST BE ANSWERED BEFORE MORE MISSIONS ARE SPENT ON IT.  The mission said plainly: "whether that is worth doing depends on whether `SameSpectralMultiplicity` actually needs real parameters -- I did not find a consumer that does."  See [[dkps-check-what-the-consumer-needs]]: twice already in this campaign a "missing" object demanded strictly more than any consumer used.

**NEXT MISSION IS A CONSUMER CHECK, NOT CONSTRUCTION.**  Determine what the REAL case of `theorem3_1_spectralMultiplicity_classification_complex` actually requires, from the paper's statement down, and whether the real-parameter `MultiplicityDatum` is on that path at all.  Additivity of the transport strategy is EXHAUSTED at the datum layer regardless: the mission's estimate is that a real-parameter datum is a from-scratch re-proof of `MultiplicityModel.lean`'s `Datum` and `Equivalence` sections plus `MeasureTheory/MultiplicityLevels.lean` at `X := R`, not a transport, because it changes a TYPE rather than a domain.

**CONSUMER CHECK, 2026-08-10 (Claude Opus 5, read-only mission; every claim below re-verified by the coordinator against the build).  IT FOUND THAT SIX CONSECUTIVE TRANSPORT MISSIONS WERE ON AN AXIS THAT CANNOT REACH THIS ROW'S BLOCKER, AND THAT THIS ROW CARRIES SEVERAL FALSE STATEMENTS.  Read this entry before believing anything above it.**

**(A) THE SIX-MODULE REAL-SPECTRUM LAYER CANNOT INSTANTIATE AT A REAL HILBERT SPACE AT ALL.**  Its base module is governed by `variable {A} [Ring A] [StarRing A] [Algebra C A] [ContinuousFunctionalCalculus C A IsStarNormal]` (`ForTauCeti/Analysis/CStarAlgebra/RealSpectrumFunctionalCalculus.lean:116`, coordinator-read).  At `A = E ->L[R] E` neither instance holds.  All six modules carry `[InnerProductSpace C H]`.  The layer moves the SYMBOL DOMAIN at a COMPLEX Hilbert space; this row's gap is the HILBERT SCALAR.  The layer is not a prerequisite for the real case -- it is DISJOINT from it.  It remains sound, axiom-clean, reusable Tau Ceti infrastructure (a Hahn--Hellinger-over-real-spectrum stack Mathlib lacks) and it does improve faithfulness of the COMPLEX statement, since the paper's multiplicity function is a function of a REAL parameter at either scalar and `MultiplicityDatum.base : Measure C` is already off-paper at complex `H`.  But it closes nothing here.  **Do not dispatch a seventh transport mission for this row.**

**(B) NO CONSUMER ANYWHERE NEEDS A REAL-PARAMETER `MultiplicityDatum`.  ZERO.**  Coordinator-verified by grep: `SameSpectralMultiplicity` has exactly ONE consumer repo-wide, `theorem3_1_spectralMultiplicity_classification_complex` (`Section3.lean:2326`); that theorem has ZERO consumers; `exists_hasMultiplicityModel` has exactly one call site (`Core.lean:116`).  Moreover the blocking hardcode is NOT the one this row names: a probe fails at `MultiplicityDatum.operator`'s `->L[C]` / `Lp C 2`, NOT at `base : Measure C`; `Lp R 2 (mu : Measure C)` is type-legal.  So a real PARAMETER is neither necessary nor sufficient -- a real-scalar MODEL SPACE is what the single consumer would need.

**(C) THE REAL SCOPE OF THIS ROW IS ALREADY LARGELY COMPLETE.**  Coordinator-probed axiom-clean at `[propext, Classical.choice, Quot.sound]`: `twoProjection_operator_classification_real` (the full real biconditional -- no compactness, no separability, no finite dimension), `theorem3_1_realization` (instantiates at `k = R`), `corollary3_1_compact_angleList_classification_real`, `corollary3_1_prescribedAngleSequence_classification_real`.  Corollary 3.1 IS the paper's own multiplicity phrasing in the compact case, and it is real, both halves.  **What is missing over `R` is only the WORD "spectral multiplicity function" in the NONCOMPACT case** -- and there is no cheap route to it, because "the multiplicity function is a complete invariant" IS Hahn--Hellinger, a renaming of the invariant `twoProjection_operator_classification_real` already proves.  The paper itself imports the apparatus from one citation (transcription line 1095, Halmos 1951) and uses it exactly once, at line 1101, to produce the isometry `J_0`; everything after is the explicit block construction, which is `theorem3_1_realization`.

**(D) FOUR STATEMENTS IN THIS ROW ARE FALSE.  Coordinator-verified individually.**  (i) The `notes` "HISTORY" says `theorem3_1_spectralMultiplicity_classification_complex` "remains `sorry`, and is vacuous besides".  BOTH ARE PROVED AND AXIOM-CLEAN; `Frontier/Section3.lean` contains ZERO `sorry` and the single hit in `Frontier/Core.lean` is the WORD inside a docstring at line 58 describing a PAST sorried definition.  (ii) The `notes` "NOTE ON EVIDENCE" says `twoProjection_operator_classification` is "deliberately NOT listed in this row's `lean_declarations`" because it "lives under `DavisKahan.Experimental.Frontier`, which no default target builds".  IT IS LISTED, and the module is `DavisKahan/Frontier/Section3.lean`, reachable from `DavisKahan/All.lean`, which IS in `defaultTargets`.  (iii) `scope_gap` says `OperatorUnitaryEquiv` hardcodes `C`; it is `RCLike`-generic, as this row's own `notes` record from the same day.  (iv) `Core.lean:81` cites "§5" of the Section 3 multiplicity campaign (Git history); that file has no §5, and is a 57-line record marked "Status: completed" with an explicit warning not to use it as a work queue.

**(E) MY "ROUTE C IS DEAD / CIRCULAR" VERDICT WAS OVER-GENERALIZED -- THE SECOND TIME I HAVE OVER-GENERALIZED A CLAIM ABOUT DESCENT.**  It is correct ONLY for descending an ARBITRARY intertwiner or defect isometry.  It is FALSE for CONJUGATION-FIXED objects, and the repository refutes the blanket form with working code: this repository's own real continuous functional calculus is BUILT by complexify-and-descend (`RealContinuousFunctionalCalculus.lean`, supplying the very instance every `_real` theorem on this row depends on), and `LinearPMap/Complexification/SpectralDescent.lean` descends spectral projections and proves conjugation-invariance of diagonal measures.  A multiplicity model is assembled from conjugation-fixed objects, so the blanket verdict would have suppressed the viable route.

**RE-SCOPING, and what the next mission should be.**  (1) The cheapest source-numbered win available is follow-up (1') already on this row: the `theorem3_1_realization`-shaped wrapper from `(Theta_0, Theta_1, J)` via `HalmosAngleDatum.ofIntertwinedAngles`.  It is `RCLike`-generic, so it lands the real case FOR FREE.  (2) If the campaign wants the printed real multiplicity sentence, the programme is a real Borel/multiplicity stack over REAL Hilbert spaces, and its first brick already exists -- `TauCeti.RealComplexification.realCfcHom : C(spectrum R a, R) -> (E ->L[R] E)` and `SpectralDescent.realSpecProjection`.  Scope its first mission to the bounded-CLM real PVM, `diag : E -> Measure R` on a REAL `E`, mirroring `ProjValMeasure/Basic.lean` (which has carried `diag : H -> Measure R` at COMPLEX `H` since before these missions).  (3) Park the six transport modules as Tau Ceti infrastructure.

**FOLLOW-UP (1') IS DISCHARGED, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9597 EXIT=0 and unchanged, six gates EXIT=0, all four ratchets byte-identical, real instance block probed).**  `theorem3_1_realization_ofAngles` (`DavisKahan/Frontier/Section3.lean`) states the paper's sentence (ii) from the ANGLE OPERATORS `(Theta_0, Theta_1, J)` rather than from a packaged datum, and its proof is the one-line `:=` on `theorem3_1_realization (HalmosAngleDatum.ofIntertwinedAngles ...)`.  A build-guarded `example` in `section RealScalars` reads off two of its conjuncts at `k = R`.

THE SPECTRAL CONFINEMENT IS ON THE WRAPPER, as this row directed, and it cost nothing: `_hspec_0`/`_hspec_1` are underscore-prefixed because they are genuinely unused in the proof.  What they buy is the READING: on `[0, pi/2]`, `sin t = 0 <-> t = 0` and `cos t = 0 <-> t = pi/2`, so the common/exterior conjuncts read as the two angle-`0` spaces and the defect conjuncts as the two angle-`pi/2` spaces -- which is what the paper means by "Hermitian operators with `0 <= Theta_j <= pi/2`".

**THE REAL CASE CAME FOR FREE, but the coordinator's reason was aimed at the wrong object.**  The brief said it follows because `theorem3_1_realization` instantiates at `R`.  That theorem is `RCLike`-generic and carries NO functional-calculus hypotheses, so nothing about it was ever at risk.  The only thing that could have cost anything is the hypothesis block `ofIntertwinedAngles` adds ON TOP -- `Algebra R`, `IsScalarTower R k`, and `ContinuousFunctionalCalculus R (. ->L[k] .) IsSelfAdjoint`, **on BOTH `E` and `F`** -- which the brief never mentioned.  Coordinator-probed: all three resolve by instance search at `k = R` on a general real Hilbert space.
...
**importance:** `supporting`  **section:** 3  **source:** Corollary 3.1  **kind:** corollary  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** When the cross projection is compact, the decreasing angle eigenvalue lists, including possible zero multiplicity, classify the pair.

**Scope gap.** **THE PREVIOUS TEXT OF THIS FIELD WAS FALSE AND CONTRADICTED THE ROW'S OWN DECLARATION LIST.**  It read `every declaration is InnerProductSpace C only, so no declaration on this row covers a real Hilbert space of infinite dimension`, and `blocked_by` carried `real-scalar-infinite-dimensional-scope` -- while `lean_declarations` ALREADY listed `corollary3_1_compact_classification_real` and `corollary3_1_compact_angleList_classification_real` and the notes recorded both as landed.  Both fields corrected 2026-08-10; `blocked_by` is now empty.

**THE REAL-SCALAR AXIS IS CLOSED.**  Dimension-function, decreasing-eigenvalue-list, defect-block and the composed prescribed-sequence classification all exist over `R`.

**WHAT REMAINS, three items, none of them scalars.**  (a) The composition against `corollary3_1_realization_zeroMultiplicity`, where the elementary Halmos summands are DELIBERATELY nontrivial so the bridge as stated does not apply; a multiplicity-aware version needs the ambient list to be the generic list merged with `1`s of multiplicity `dim (U inf Vperp)`.  (b) The `P(I-Q)P` versus `PQP` compact-object question, untouched and recorded above as INCOMPARABLE in infinite dimension.  (c) NEW 2026-08-10, and it is an UPSTREAM DEFECT rather than Davis-Kahan mathematics: at the CONCRETE realized pair the instance `ContinuousFunctionalCalculus R ... IsSelfAdjoint` FAILS TO SYNTHESIZE, while `CompleteSpace`, `Algebra C`, `CStarAlgebra` and `ContinuousFunctionalCalculus C ... IsStarNormal` all succeed at the same type and the SAME instance succeeds for an ABSTRACT pair.  MEASURED NOT TO BE A BUDGET: it fails at `maxSynthPendingDepth` 3, 6 and 10, `synthInstance.maxSize 800`, `synthInstance.maxHeartbeats 2000000`, with the trace showing `IsSelfAdjoint.instContinuousFunctionalCalculus` failing at `tryResolve` without ever reaching its `IsStarNormal` subgoal -- a defeq/diamond failure.  That is why the defect-block classification now has separate `_complex` and `_real` named instances with the calculus already discharged, instead of one generic composed corollary; the pre-existing complex composition compiled only because its instances were baked in abstractly.  The per-field split is an honest WORKAROUND, not a narrowing.

**Lean declarations:**

- `TauCeti.DavisKahan.SameCompactAngleData`
- `TauCeti.DavisKahan.pairOfSubspacesUnitaryEquivalent_iff_sameCompactAngleData`
- `TauCeti.DavisKahan.isCompactOperator_genericCosineBlock`
- `TauCeti.DavisKahan.eigenspace_genericCosineBlock_zero`
- `TauCeti.DavisKahan.finrank_eigenspace_eq_of_intertwiner`
...
- `TauCeti.DavisKahan.pairOfSubspacesUnitaryEquivalent_orthogonal_right_iff`
- `TauCeti.DavisKahan.sameHalmosTrivialDimensions_orthogonal_right_iff`
- `TauCeti.DavisKahan1970.corollary3_1_compact_classification_real`
- `TauCeti.DavisKahan1970.corollary3_1_compact_angleList_classification_real`
...
- `TauCeti.DavisKahan.approximationNumber_genericCosineBlock_eq_ambient`
...
HISTORY. The pre-existing frontier statement `TauCeti.DavisKahan1970.corollary3_1_compact_angleList_classification` remains `sorry` and is not on this row's evidence path. Unlike the Theorem 3.1 frontier statement it was at least not vacuous.
...
**PROMOTED TO `compiled_exact`, 2026-08-10, on a fidelity read against the transcription (Claude Opus 5; coordinator-verified axiom-clean).**  Printed Corollary 3.1 is L1118-1132.  Clause (i), the classification: `corollary3_1_compact_defectBlock_angleList_classification` -- `RCLike`-generic, hypothesis LITERALLY the printed `P Qtilde P` (`P_U .SL (id - P_V) .SL P_U` compact), biconditional, plus its `_real` sibling; it does NOT need `dim P = dim Q` or (3.5), so it is STRONGER than printed.  Clause (ii), the realization: `corollary3_1_realization` (`RCLike`, `0 <= theta n <= pi/2`, `Antitone`, `-> 0`) and `corollary3_1_realization_zeroMultiplicity`.
...
**importance:** `supporting`  **section:** 3  **source:** Proposition 3.5  **kind:** proposition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** The full angle commutes with both projections, the quarter turn and the direct rotation, and an angle eigenvector is rotated through exactly its eigenvalue; both clauses hold at the standing Section 3 scope for a completed direct rotation, with no acuteness hypothesis.  Only the third clause -- that each eigenspace is the maximal reducing constant-angle subspace -- is restricted by the source to the acute case.

**Lean declarations:**

- `TauCeti.DavisKahan1970.bounded_angle_commute`
- `TauCeti.DavisKahan1970.bounded_sinAngleOperatorC_norm`
- `TauCeti.DavisKahan.IsFixedCosineReducingSubspace`
- `TauCeti.DavisKahan.fixedCosineSubspace`
- `TauCeti.DavisKahan.fixedCosineSubspace_isFixedCosineReducing`
- `TauCeti.DavisKahan.fixedCosineSubspace_maximal`
...
- `TauCeti.vectorAngle_comm`
- `TauCeti.vectorAngle_eq_of_re_inner_eq`
...
- `TauCeti.DavisKahan.isFixedCosineReducingSubspace_of_printed`
- `TauCeti.DavisKahan.proposition3_5_fixedAngle_maximal_uniformlyAcute_form`
- `TauCeti.DavisKahan.halmosCosineSq_isSymmetric`
- `TauCeti.DavisKahan.halmosCosineSq_sub_smul_isSymmetric`
...
- `TauCeti.DavisKahan1970.proposition3_5_directRotation`
- `TauCeti.DavisKahan1970.proposition3_5_quarterTurn`
- `TauCeti.DavisKahan1970.proposition3_5_angleEigenspace`
- `TauCeti.LinearPMap.cfc_apply_of_apply_eq_real_smul`
...
commutation: `bounded_angle_commute` is `Commute (directedSinAngleOperatorC U V) (directedCosAngleOperatorC U V)`,
...
**ADJUDICATED 2026-08-10 AND CONFIRMED NOT EXACT (Claude Opus 5).  WHAT HOLDS IT OPEN IS ALL PRINTED.**  (1) FINITE DIMENSIONALITY: five of the six printed assertions are `RCLike`-generic but `[FiniteDimensional]`, and printed Prop 3.5 sits in a section whose whole point is the infinite-dimensional case -- L1139 says `Theta` can have CONTINUOUS spectrum and L1141 introduces `Omega(.)` as the spectral resolution.  (2) REAL SCALARS at infinite dimension, plus `IsUniformlyAcute` on the maximality clause: `proposition3_5_fixedAngle_maximal` is `InnerProductSpace C` only and takes `IsUniformlyAcute` where the print says "in the acute case".  The recorded `eigen_of_reducing_quadratic` complex-polarization obstruction is genuine.

**TWO FALSE CLAIMS IN THIS ROW, BOTH CORRECTED.**  (i) `scope_gap` says "no declaration on this row covers a real Hilbert space of infinite dimension".  FALSE and refutable by one `#check`: `halmosCosineSq_commute_projection`, ON THIS ROW'S OWN DECLARATION LIST, is `RCLike`-generic with no dimension hypothesis.  (The substance survives -- it is a `cos^2 Theta`-level fact, not a printed assertion -- but the field as written is wrong.)  (ii) THE RECORDED "TRANSCRIPTION CORRECTION ... LOAD-BEARING" MISREADS PRINTED (c).  `IsFixedCosineReducingSubspace` has SIX conjuncts (reduces `P_U`, reduces `P_V`, and four norm conditions on `M inf U`, `M inf V`, `M inf Uperp`, `M inf Vperp`), while printed (a)(b)(c) is reduces `P` and `Q` plus TWO conditions -- on `M inf P(H)` with `Q`, and on `M inf Ptilde(H)` with `Qtilde`.  The row justifies the extras by claiming a nonzero vector of the exterior `Uperp inf Vperp` "satisfies the printed conditions vacuously".  **THAT IS FALSE: such a vector lies in `Ptilde(H)`, so printed (c) APPLIES to it and gives `||Qtilde x|| = ||x|| = c||x||`, excluding it for `c < 1`.**  The census describes the printed pair as `{M inf U, M inf V}`; the transcription's pair is `{M inf U, M inf Uperp}`.  So `fixedCosineSubspace_maximal` proves maximality over a STRICTLY SMALLER class of `M` than printed.  (The two extra conjuncts are plausibly redundant -- the printed four give `<(cos^2 Theta - c^2) x, x> = 0` on all of `M`, with `cos^2 Theta - c^2` self-adjoint and reduced by `M` -- but that is NOT proved in the repository, so the compiled statement is formally weaker.)

**TWO OF THIS ROW'S RECORDED OBSTRUCTIONS ARE REFUTED, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9603 EXIT=0, six gates EXIT=0, baselines flat, all four ratchets flat, probe `sorryAx` count ZERO).**

**(i) THE "GENUINE COMPLEX OBSTRUCTION" IS NOT ONE.**  This row recorded `eigen_of_reducing_quadratic` as "the FIRST complex restriction this campaign has examined that is mathematics rather than decoration ... Do not dispatch this row as a binder-editing mission".  **REFUTED.**  The lemma is now `RCLike`-generic with a SYMMETRY hypothesis, and the proof is SHORTER than the complex one -- a single test vector `w + T w` giving `2<Tw, Tw> = 0`.  The skew-symmetric counterexample that motivated the complex-only framing is excluded by a hypothesis that was AVAILABLE AND UNUSED at every call site; it is supplied by the two new lemmas `halmosCosineSq_isSymmetric` and `halmosCosineSq_sub_smul_isSymmetric`.  **The ENTIRE fixed-cosine block (26 declarations) is now `RCLike`-generic at arbitrary dimension, and needs no `CompleteSpace` either.**

**(ii) `IsUniformlyAcute` AND `c <= 1` WERE NEVER USED IN THE PROOF BODY** of `proposition3_5_fixedAngle_maximal` and are dropped.  The new statement quantifies its maximality clause over `IsPrintedFixedCosineReducingSubspace` -- the PRINTED four conditions -- and `proposition3_5_fixedAngle_maximal_uniformlyAcute_form` re-derives the exact previous statement as a composition, so nothing is lost.  The first conjunct still delivers the STRONGER six-conjunct predicate; only the quantified class widened.  `isFixedCosineReducingSubspace_of_printed` proves the printed four imply all six for `0 < c`.

**A COORDINATOR CLAIM WAS WRONG, AND `dev/` HAD IT RIGHT ALREADY.**  The brief (inheriting this row's `scope_gap`) said `fixedCosineSubspace_maximal` "proves maximality over a strictly SMALLER class of `M` than printed".  FALSE: its four hypotheses were ALREADY exactly printed (a)(b)(c).  `dev/davis-kahan-1970-final-audit-2026-08-09.md:224` recorded this correctly -- "EXACT (the bundled `proposition3_5_fixedAngle_maximal` is narrower)" -- and the census overstated it.  The narrowing was only ever in the BUNDLED theorem.

**A REFINEMENT TO THE FAKE-SCOPE-GAP HEURISTIC, worth propagating.**  The underscore-binder test that closed `DK-3.1-prop` WOULD HAVE MISSED THIS ROW: `proposition3_5_fixedAngle_maximal` bound `hacute` with a full name, no underscore, and still used it nowhere.  **Grep the proof BODY, not just the binder.**  The tells here were the docstring ("the proof needs only `0 < c`") and the body itself.
...
**HOSTILE RE-AUDIT CLOSED 2026-08-13.**  The repaired Proposition 3.5 signatures were independently re-audited against the printed three-clause structure.  The commutation and eigenvector-angle clauses are now accepted at the standing nonacute Section 3 scope, including the right-angle eigenspace; only the maximal-eigenspace clause retains the source's acute restriction.  The stale `reopened_mapping` bookkeeping is therefore closed.
...
**importance:** `supporting`  **section:** 3  **source:** Corollary 3.2  **kind:** corollary  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Swapping P and Q leaves the angle operator unchanged and reverses the quarter-turn operator.
...
**importance:** `supporting`  **section:** 4  **source:** Section 4 setup, Proposition 4.1, and equations (4.1)--(4.2)  **kind:** proposition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** For any unitary carrying P to Q, an orthonormal sequence experiences angles at least the principal angles; equivalently the singular values of (1-V)|P are minimized by the direct rotation and equal 2 sin(theta_k/2).
...
- `TauCeti.DavisKahan1970.proposition4_1_real`
- `TauCeti.DavisKahan1970.restrictedDisplacementDominance_real`
- `TauCeti.DavisKahan1970.proposition4_1_infiniteDimensional_nonacute`
- `TauCeti.positiveApproximationEigenvector`
- `TauCeti.orthonormal_positiveApproximationEigenvector`
- `TauCeti.apply_positiveApproximationEigenvector`
- `TauCeti.DavisKahan1970.proposition4_1_compact_orthonormalVectors_complex`
...
**RESULT-ONLY SOURCE BRIDGE 2026-08-12.** `proposition4_1_compact_nonacute_directRotationValues_complex` and its real counterpart expose the printed exact value `a_k((1-U)P) = 2 sin(theta_k/2)` at the same arbitrary-dimensional compact, matched-defect scope as the existing nonacute Proposition 4.1 wrappers. This closes the maintained 29-result Proposition 4.1 obligation while leaving the legacy full-source row's separate bookkeeping for equations (4.1)--(4.2) unchanged.
...
`DK-4.1-prop.orthonormal-angle-lower-bounds` -- orthonormal `v_k` in `P` with `angle(v_k, V v_k) >= theta_k` -- is `proposition4_1_compact_orthonormalVectors_complex` and its real form, which produce exactly an orthonormal family with `principalAngleSequence U V n <= vectorAngle (v n) (W (v n))` for every intertwining unitary `W`.
...
**importance:** `supporting`  **section:** 4  **source:** Corollary 4.1  **kind:** corollary  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** The direct rotation minimizes the norm of (1-V)P for every unitary-invariant norm.
...
- `TauCeti.DavisKahan1970.corollary4_1_real`
- `TauCeti.DavisKahan1970.corollary4_1_opNorm_real`
...
**importance:** `supporting`  **section:** 4  **source:** Proposition 4.2  **kind:** proposition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `reopened_mapping`

**Summary.** For every orthonormal basis of P, the sum of squared displacement sines under V dominates the sum of squared principal sines.
...
- `TauCeti.DavisKahan.Section4.norm_inner_competitor_le`
- `TauCeti.DavisKahan.Section4.sum_displacementAngleSineSq_ge_of_mem_complex`
- `TauCeti.DavisKahan.Section4.tsum_displacementAngleSineSq_ge_of_mem_complex`
- `TauCeti.DavisKahan1970.displacementAngleSineSqR`
- `TauCeti.DavisKahan1970.displacementAngleSineSq_ge_real`
- `TauCeti.DavisKahan1970.sum_displacementAngleSineSq_ge_of_mem_real`
- `TauCeti.DavisKahan1970.tsum_displacementAngleSineSq_ge_of_mem_real`
- `TauCeti.DavisKahan.Section4.sum_one_sub_sq_norm_absoluteValue_eq_sum_sq_principalSines`
- `TauCeti.DavisKahan.Section4.sum_displacementAngleSineSq_ge_sum_sq_principalSines`
- `TauCeti.DavisKahan1970.norm_canonicalAbsoluteValueR_apply_eq_norm_projection`
- `TauCeti.DavisKahan1970.sum_one_sub_sq_norm_canonicalAbsoluteValueR_eq_sum_sq_principalSines`
- `TauCeti.DavisKahan1970.sum_displacementAngleSineSqR_ge_sum_sq_principalSines`
- `TauCeti.DavisKahan1970.proposition4_2_infiniteDimensional`
- `TauCeti.DavisKahan1970.tsum_displacementAngleSineSqR_ge_tsum_sq_principalSineSequence`
- `TauCeti.principalSineSequence`
- `TauCeti.principalAngleSequence`
...
**OBLIGATION (2), THE SUMMABILITY CONVENTION, HAS NOTHING TO SETTLE -- 2026-08-05.** With the paper's basis-free right-hand side the estimate is **termwise**: `displacementAngleSineSq_ge_complex` constrains one unit vector of `U` at a time.  So it uses neither completeness nor orthogonality, and survives passage to any subfamily -- which is exactly what fails for the wrong right-hand side `sum_i cost D b_i`, a genuine total statement.  Taking the sums in `ENNReal` then makes them unconditionally defined (divergence is a value, not a failure), and `ENNReal.tsum_le_tsum` lifts the termwise bound to an arbitrary index type with no hypothesis at all.

`sum_displacementAngleSineSq_ge_of_mem_complex` (arbitrary finite subfamily) and `tsum_displacementAngleSineSq_ge_of_mem_complex` (arbitrary index type, `ENNReal` sums) are both in the default build and axiom-clean, and the frontier statement `proposition4_2_basisAngleSquareSum_infinite` is grounded on the second by `:=`.
...
- {'kind': 'audit_atomization', 'detail': 'The main inequality appears formalized, but the source block also records the trace/basis identification used in the proof. The terminal row does not separately bind that preserved mathematical assertion to Lean evidence.'}

### `DK-4.3-prop` — Squared displacement UI-norm minimality

**importance:** `major`  **section:** 4  **source:** Proposition 4.3  **kind:** proposition  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `reopened_mapping`

**Summary.** The direct rotation minimizes the UI norm of (1-V*) (1-V).
...
- `TauCeti.DavisKahan1970.proposition4_3_infiniteDimensional_nonacute`
- `TauCeti.DavisKahan1970.proposition4_3_infiniteDimensional_nonacute_idealGauge`
- `TauCeti.DavisKahan1970.proposition4_3_nonacute_real`
...
reading the pinch through the isometry `H = U (+) U-perp`, feeding the middle step with Proposition 4.1 on `U` and on `U-perp`, and closing with the Fan--Hoffman pinching contraction `kyFanApproximationGauge_diagonalPart_le_complex`.
...
- {'kind': 'audit_mapping', 'detail': 'Broader nonacute and real source theorems exist, but the primary row evidence is narrower and the hashed block contains equations (4.3)-(4.6) plus the precise UI-norm limitation. Rebind/atomize the complete source scope.'}

### `DK-4.4-prop` — Full-displacement counterexamples and Proposition 4.4 as printed

**importance:** `supporting`  **section:** 4  **source:** Examples 4.1–4.2 and Proposition 4.4  **kind:** proposition  **status:** `refuted_as_transcribed`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** In a real Hilbert space, if the maximal angle is at most pi/3, the direct rotation minimizes every UI norm of 1-V.
...
**RESULT-INVENTORY REPAIR REGISTRATION 2026-08-12.** The printed Proposition 4.4 remains formally refuted. `directRotation_fullDisplacement_qnorm` is registered separately as the natural Q-norm repair required by repository policy; it is not evidence that the false printed conclusion is true.
...
**importance:** `technical`  **section:** 5  **source:** Section 5, inequalities (5.1) and (5.2)  **kind:** equation  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** For Hermitian A and B whose eigenvalues are pairwise at distance at least delta, C = AX - XB satisfies the square-norm bound (5.1); (5.2) is its trace-norm corollary with a sqrt(rank C) factor.

**Scope gap.** NO SCOPE GAP REMAINS.  Closed 2026-08-10 (Claude Opus 5, coordinator-verified).  (5.1) was already compiled at strictly greater generality than printed; (5.2) and the paper's own 2x2 sharpness witness are now compiled too, over real AND complex scalars.  Hilbert-Schmidt membership of `C` is NOT a hypothesis -- the rank bound supplies it.

**Lean declarations:**

- `TauCeti.DavisKahan.ExactSinTheta.hilbertSchmidt_sylvester_le_of_pairwiseSpectrumGap`
...
over `KyFanDominantIdealFamily R`, with `A`, `B` self-adjoint `LinearPMap`s, `FormBoundedSylvesterGap`
...
**importance:** `technical`  **section:** 5  **source:** Lemma 5.1  **kind:** lemma  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** If projections converge strongly to one, each singular value of K composed with the projection converges to the corresponding singular value of K.
...
**importance:** `technical`  **section:** 6  **source:** Lemma 6.1  **kind:** lemma  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Two diagonal block inequalities imply the direct-sum inequality; under equisingularity of paired blocks the converse holds.
...
**importance:** `technical`  **section:** 6  **source:** Lemma 6.2  **kind:** lemma  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** The sum of the two diagonal projection blocks of an operator is no larger than the operator in every source unitary-invariant norm.
...
**STATUS RESTORED 2026-08-08 (Claude Opus 5): `compiled_specialization` -> `compiled_exact`; blocker `real-scalar-infinite-dimensional-scope` removed from this row.**  The real-scalar form is now compiled, for an arbitrary real Hilbert space with no finite-dimensionality hypothesis: `DavisKahan/Sources/DavisKahan1970/SineTheta/SymmetricReal.lean`, surfaced as `TauCeti.DavisKahan1970.Proposition6_1_real`.  The proof MIRRORS the complex one step for step -- same two directed applications of the one-sided sine theorem, same Lemma 6.1 coupling on the scaled identity, same Lemma 6.2 contraction -- with exactly one substitution: `davisKahan1970_sylvester_complex` becomes `real_unbounded_sylvester_kyFan`.  No new mathematics was needed; `lemma61_all_kyFan`, `diagonalPair_all_kyFan_le`, the ambient/subspace singular-value transport, and `SymmetricNormingFunction` were already `RCLike`-generic.

**How the conclusion avoids a real functional calculus.**  The complex row's conclusion is phrased through `sinAngleOperatorC`, i.e. `cfc Real.sin` of the operator angle, which is why the complex file cannot be generalized as written.  The real theorem is instead stated on `crossSineSum U V`, and that this is the paper's whole-space `sin Theta` is COMPILED, not asserted:
* `proposition6_1_real_sinTheta_singularValues` (from the `RCLike` `crossSineSum_same_projectionDiff`) gives every source norm the same membership and value on `crossSineSum U V` as on the projector difference `P_V - P_U`;
* `proposition6_1_real_sinTheta_eq_literalFullSinAngle` matches its complete approximation-singular-value sequence to that of the repository's LITERAL real full sine angle `sourceFullSinR`;
...
`Theorem62Data.operatorNorm_result_across_of_rank_le (P) (S) (h : rank P.data.residual <= r) :
...
`RealTheorem62Data.operatorNorm_result_across_of_rank_le` with the identical statement over
...
**importance:** `major`  **section:** 6  **source:** Section 6 equations (6.2)–(6.6), Example 6.1, and Theorem 6.3  **kind:** theorem  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** A strict inequality of source-coordinate Hilbert dimensions, the Rayleigh–Ritz residual condition, and a one-sided gap control a directed rectangular tangent representative defined from the singular values of E₀*F₁.

**Scope gap.** NO SCOPE GAP REMAINS.  Closed 2026-08-10 (Claude Opus 5, coordinator-verified).  The trial-dimension axis closed earlier; the NORM-ABSTRACTION question that held this row is now MEASURED AND ANSWERED FAVOURABLY, and the complex `SymmetricNormingFunction` endpoint exists.

THE MEASUREMENT, three compiled pieces of evidence.  (1) `SymmetricNormingFunction` is SCALAR-AGNOSTIC DATA and its Fan-dominance law is `RCLike`-generic: `SymmetricNormingFunction.mul_gauge_le_of_all_mul_kyFan_le` (`SineTheta/Norms/UnitaryInvariantNorm.lean:325`) is quantified over `{K} [RCLike K]` and consumes ONLY `forall k, c * kyFanApproximationGauge k A <= kyFanApproximationGauge k B`.  So a paper norm measures a COMPLEX operator directly and the recorded cross-field transport trap is STRUCTURALLY UNREACHABLE on this route.  (2) The complex Ky Fan core supplies exactly that input at every prefix and every trial dimension: `theorem6_3_all_kyFan_core_infiniteTrial` (`TanTheta/Theorem63InfiniteTrial.lean:468`).  (3) The paper's norm class LITERALLY CONTAINS the Ky Fan norms -- `kyFanNormingFunction k hk` (`Ideals/KyFanNorm.lean:210`) IS a `SymmetricNormingFunction` whose extended gauge is `kyFanApproximationGauge k`, which is how `all_mul_kyFan_le_of_every_symmetricNorming_gauge_le` recovers the family back.  THE TWO ABSTRACTIONS ARE EQUI-STRONG FOR THIS THEOREM: the ideal-family endpoint was never a narrowing, and the paper-norm endpoint is not one either.

Residue, and not a gap: `[CompleteSpace Z]`, which `Theorem63InfiniteTrial.lean` already records as following from `[Z.HasOrthogonalProjection]` with `H` complete.
...
- `TauCeti.DavisKahan1970.Section6Example61.residual_norm`
- `TauCeti.DavisKahan1970.Section6Example61.tangent_bound_fails`
- `TauCeti.DavisKahan1970.Section6Example61.tangent_components_equal`
- `TauCeti.DavisKahan1970.theorem6_3`
- `TauCeti.DavisKahan1970.exists_hasTheorem63DirectedTangentApproximationNumbersReal`
- `TauCeti.DavisKahan1970.tanTheta_directed_bounded_symmetricNorming_complex`
- `TauCeti.DavisKahan1970.tanTheta_directed_bounded_symmetricNorming_real`
...
| In this argument the source temporarily supposes that all the operators are bounded and that S_0 is compact, and states that the Appendix to Section 6 removes both restrictions. | Neither restriction is present in the canonical declarations, and that is exactly why they are the canonical witnesses: `tanTheta_directed_unboundedTrial_symmetricNorming_complex` and its real sibling take the ambient operator as an unbounded self-adjoint `LinearPMap`, an arbitrary complete trial subspace of arbitrary Hilbert dimension, and no compactness hypothesis at all. This is the Appendix scope the passage promises, carried in the statement rather than deferred. | claimed_exact |
...
| The generalized theorem assumes exhaustive isometries E_0, E_1, F_0, F_1 whose ranges reduce A and A + H, with A_0 = E_0^*(A + H) E_0 and R defined by (1.8). | The canonical declarations take the ambient self-adjoint operator `A` and a trial subspace `Z` inside its domain, bundled as an `BoundedCompressionTrialBlock`: `D.operator` is the Rayleigh--Ritz compression A_0 and `D.residual` is the residual of (1.8), each pinned by a defining identity rather than assumed. The exact reducing subspace is not a free parameter but the spectral subspace of `A` for the half-line below alpha, which is the paper's own choice of Q. The isometries are replaced by the subspaces they exhaust, which is the same data coordinate-free. | claimed_exact |
| but allow dim X(E_0) < dim X(F_0). | The canonical declarations do not assume the strict dimension inequality; they prove the conclusion for an arbitrary complete trial subspace, so dropping the hypothesis strengthens rather than narrows. The literal form is registered as supporting evidence: `theorem6_3_generalizedTanTheta_ideal_directedTangent` binds `Module.rank Z < Module.rank V` exactly as printed, at the cost of also carrying a finite-dimensionality instance. | claimed_exact |
| let the directed sine data have the singular values of E_0^* F_1. | The canonical declarations take the tangent representative `tanTheta0` as an explicit parameter together with `htan`, which prescribes exactly the tangents of the arcsines of the directed sine block's approximation numbers -- the printed 'let the directed tangent data have these singular values', as a hypothesis rather than an existential. That such a representative always exists is separately compiled: `theorem63DirectedTangent` and `theorem63DirectedTangentReal` are the explicit witnesses, and the bounded endpoints exhibit one in their conclusion. | claimed_exact |
| If spec(A_0) subset [beta, alpha] and spec(Lambda_1) subset [alpha + delta, infinity). | The canonical declarations take the printed separation in its half-infinite ordered form, which is the configuration the source's scope paragraph explicitly permits: the Ritz compression is bounded above by alpha in quadratic form, and `A` has no spectrum in the open gap `(alpha, alpha + delta)`, so the exact subspace is the spectral subspace for `(-infinity, alpha]`. The printed lower endpoint beta is dropped, which weakens the hypothesis. The literal printed spectral inclusions, both of them, are carried by the supporting bounded endpoint `tanTheta_directed_bounded_spectralGap_symmetricNorming_complex`; over the reals the corresponding bounded endpoint is stated in the equivalent form-bound orientation, and there is no real declaration in the printed spectral orientation. | claimed_exact |
| then the corresponding directed tangent operator satisfies, for every unitary-invariant norm, delta \|\|tan Theta_0\|\| <= \|\|R\|\|. | Both canonical declarations conclude `N.Mem tanTheta0 /\ delta * N.gauge tanTheta0 <= N.gauge D.residual` for an arbitrary `N : SymmetricNormingFunction`: the printed inequality with the printed constant, plus membership of the tangent in the norm's ideal whenever the residual is in it. | claimed_exact |
...
| The scalar field is real or complex and the dimension is unrestricted. | Both fields are covered at unbounded ambient operator, arbitrary Hilbert dimension and arbitrary complete trial subspace, and both endpoints are at the paper's norm class. | claimed_exact |
...
**CORRECTION TO THIS ROW'S OWN PREVIOUS `scope_gap`, which the coordinator wrote and which was WRONG.**  It named `SymmetricNormingFunction.prefixGauge_le_of_all_kyFan_le_hetero` as `exactly the bridge the real endpoint uses`.  MEASURED 2026-08-10: the real endpoint `tanTheta_directed_bounded_symmetricNorming_real` NEVER INVOKES IT -- it uses `N.mul_gauge_le_of_all_mul_kyFan_le` (`DirectedReal.lean:448`, coordinator-verified by reading the line).  The `_hetero` variant is for operators with DIFFERENT CODOMAINS, whereas here both operands are `Z ->L E`; and it could not have been the bridge anyway, being unscaled (no `delta`) and concluding only a `prefixGauge` inequality rather than membership plus the gauge bound.
...
### `DK-6-appendix` — Unbounded-operator passage

**importance:** `technical`  **section:** 6 appendix  **source:** Appendix to Section 6, equations (6.7)–(6.11)  **kind:** appendix  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `reopened_mapping`

**Summary.** Domain invariance, bounded residual, spectral cutoffs, and limiting arguments extend the single-angle theorems to unbounded self-adjoint operators.

**Scope gap.** **FIELD RECONCILED 2026-08-10 (Claude Opus 5, coordinator).  THIS FIELD PREVIOUSLY CONTRADICTED ITSELF AND THE CONTRADICTION COST A MISSION.**  It opened with an M32 paragraph saying the tangent half is complex-only and holds the row open, and contained further down, IN THE SAME FIELD, an M35 paragraph reading `REAL-SCALAR AXIS CLOSED 2026-08-09; THE BLOCKER IS REMOVED FROM THIS ROW`.  Both dated 2026-08-09.  The coordinator truncated the field when scoping, read the stale opening, and dispatched a mission for work already done -- the row's own `lean_declarations` already listed the real endpoints.  THE M35 CORRECTION GOVERNS.  Fields here are append-only in practice: a later mission adds a dated paragraph without deleting the one it supersedes, so THE CORRECTION IS USUALLY AT THE END.  Read each field in full.

**THE REAL-SCALAR AXIS IS CLOSED, both halves.**  Sine: `theorem6_1_real_commonDomain`, `theorem6_2_real_commonDomain`, `theorem6_1_real_commonCore`, `theorem6_2_real_commonCore`.  Tangent cutoff/Fan passage: `theorem6_3_unbounded_infiniteTrial_ideal_exists_of_reducing_real` (`DirectedUnboundedReal.lean:368`) and its two siblings, all axiom-clean in the default build.

**PROPOSITION 6.1's COMMON-DOMAIN FORM NOW EXISTS** (item (c)): `CommonDomainSymmetricSinThetaProblem` with `A` and `B` closed operators, self-adjoint in the domain-aware sense, sharing a domain, and a bounded `perturbation` representing `B - A` there.  Its conclusion is the bounded Proposition 6.1's, at every `SymmetricNormingFunction`.  IT IS A MACHINE-CHECKED RELAXATION, not an asserted one: `ofBounded` maps any `SymmetricSinThetaProblem` into it with `domain_eq := rfl` and `perturbation_eq := rfl`, so no hypothesis is dropped and none added.  `perturbation_isSymmetric` is DERIVED from symmetry of `A` and `B` on the common domain plus density, NOT taken as a field -- making it a field would have strengthened the source hypotheses.

**WHAT HOLDS THE ROW: items (a), (b) and (e) ONLY.**  Not scalars, not Proposition 6.1.  (a) the unbounded Ritz compression with the paper's `Omega(tau)` truncation and its `||F||_1 <= eta tau <= epsilon` estimate; (b) the unbounded `tan 2Theta` Ky Fan `nu >= 2` endpoint, which is gated by the seam recorded on `S2-unbounded-scope` and measured there as a NO-GO for any argument resting only on strong convergence of spectral cutoffs; (e) the displayed chain (6.7)-(6.11), optional and documentation fidelity rather than theorem debt.

NARROWER GAP CREATED RATHER THAN CLOSED: there is no REAL common-domain Proposition 6.1.  The complex one is landed; the real sibling would follow `SymmetricReal.lean`'s pattern, substituting `real_unbounded_sylvester_kyFan` for `davisKahan1970_sylvester_complex` and stating the conclusion on `crossSineSum`.

**ADJUDICATED 2026-08-10 (subagent, coordinator-verified by direct file read).  ITEM (e) IS DISCHARGED AS DOCUMENTATION AND MUST NOT HOLD THIS ROW.  ITEM (a) IS GENUINE, AND THE DESCRIPTION ABOVE NAMES THE PAPER'S PROOF STEP RATHER THAN THE GAP.**

(e) -- the displayed chain (6.7)-(6.11), transcription L2114-2259.  (6.7)/(6.8)/(6.9) are properties of a CHOSEN nu-projector `Upsilon`; (6.10) is (6.5) compressed by `Gamma`/`Upsilon`; (6.11) is the scalar inequality extracted from (6.10).  Every one of them exists only INSIDE the paper's proof of the unbounded `tan theta` estimate.  NONE is a statement the paper asserts as a result, and the repository reaches the same conclusion by a different route (`Theorem63UnboundedInfiniteTrial.lean` module doc: the only approximation operator used is the bounded self-adjoint Ritz compression).  So (e) has no content independent of (a): if (a) is ever closed the paper's way, (6.7)-(6.11) become its proof steps.  Struck from `next_action`.

(a) RESTATED AT THE LEVEL OF A STATEMENT, so it is never again mistaken for apparatus.  The printed text is explicit (L2124): `A_0 <= alpha` and `Lambda_1 >= alpha + delta`, BUT BOTH MAY NOW BE UNBOUNDED -- which is why the spectral resolution and the `Omega(tau) A_0 Omega(tau)` truncation appear at all.  Measured against the build (coordinator-verified, note the paths, which the subagent report gave with an extra `Sources/DavisKahan1970/` segment): `DavisKahan/TanTheta/UnboundedSpectrum.lean:46` has `structure BoundedCompressionTrialBlock` with `domain_le : Z <= A.domain` and `operator : Z ->L[k] Z`, and `DavisKahan/TanTheta/Theorem63TrialData.lean:68` has `action : Z ->L[k] H` and `compression : Z ->L[k] Z`.  So on the TANGENT half unboundedness is permitted only in the ambient `A`; the Ritz compression -- indeed the whole restriction of `A` to `Z` -- is a hypothesis-level BOUNDED operator, and `hCompression` is a form bound on a CLM, strictly narrower than `semibounded above by alpha`.  The missing statement is Theorem 6.3 / the `tan theta` theorem with an UNBOUNDED densely-defined self-adjoint `A_0 : Z ->l.[k] Z`, semibounded above in form (`for all z in A_0.domain, re <A_0 z, z> <= alpha ||z||^2`), `Lambda_1 >= alpha + delta`, bounded residual `R : Z ->L[k] H`, concluding `delta * N.gauge tanTheta_0 <= N.gauge R` for every `KyFanDominantIdealFamily`.
...
**FALSE PREMISE IN THE DISPATCH BRIEF, RECORDED.**  The brief presented (a) and (e) as un-adjudicated.  Both had in fact been adjudicated on 2026-08-09 in `dev/`: `dev/davis-kahan-1970-final-audit-2026-08-09.md:288` states the (a) finding in nearly the words independently reached today, and `dev/davis-kahan-1970-completion-handoff.md` section F.8 poses the (e) question and pre-answers it.  Both today's verdicts agree with those documents.  THIRD TIME THE AUDIT DOC HAS BEATEN THE CENSUS: check `dev/davis-kahan-1970-final-audit-2026-08-09.md` BEFORE scoping any adjudication mission.

ALSO OVER-PESSIMISTIC ELSEWHERE: `dev/davis-kahan-1970-frontier-status.md:35` scores this row at 0% while the sine half in both scalar fields, the tangent half at arbitrary trial dimension, and Lemma 6.3 in both fields are all compiled and axiom-clean.

**THE REAL COMMON-DOMAIN PROPOSITION 6.1 NOW EXISTS, 2026-08-10 (coordinator-verified: build 9611 -> 9612 jobs EXIT=0, seven checks EXIT=0, all four ratchets byte-identical at 165/51/51/91, probe EXIT=0 with zero `sorryAx` on all 39 touched declarations).  THE SENTENCE ABOVE READING `NARROWER GAP CREATED RATHER THAN CLOSED: there is no REAL common-domain Proposition 6.1' IS NOW FALSE AND IS SUPERSEDED BY THIS PARAGRAPH.**

The in-place `RCLike` generalization of `SineTheta/CommonDomainSymmetric.lean` SUCCEEDED with no fallback to a parallel real module.  Every existing declaration name and every existing statement is preserved; `CommonDomainSymmetricSinThetaProblem`'s field list is unchanged (verified by dumping it from the environment), `perturbation_isSymmetric` is still DERIVED rather than a field, and `ofBounded` still carries `domain_eq := rfl` and `perturbation_eq := rfl`.  New source-facing aliases: `proposition6_1_real_commonDomain`, `proposition6_1_real_commonDomain_kyFan`, `proposition6_1_real_commonDomain_ofBounded`, plus three `crossSineSum` forms.  `ofBoundedReal` makes the real common-domain form a RELAXATION of the real bounded Proposition 6.1, not a parallel statement.

**TWO GENUINELY COMPLEX-ONLY DEPENDENCIES WERE FOUND, AND THE CENSUS WAS RIGHT ABOUT THE FIRST ONE.**
...
REMAINING, SMALL: the common-domain row has no analogue of `SymmetricReal.lean`'s `approximationNumber_sourceFullSinR_eq_crossSineSum`, so it lacks the literal-full-sine certificate that the bounded real row carries.  Direct transcription, no new mathematics.  SEPARATELY AVAILABLE NOW: `HasUnboundedSylvesterKyFan` unblocks the same axis elsewhere -- `SymmetricReal.lean` could collapse into `Symmetric.lean`, retiring roughly 515 lines of parallel real code.

CENSUS-GATE NOTE 2026-08-10: `HasUnboundedSylvesterKyFan` and `unbounded_sylvester_kyFan` are deliberately NOT in `lean_declarations`.  They elaborate and are axiom-clean, but the census declaration probe does not resolve them, and the row's obligations are carried by the `Proposition6_1_*` aliases regardless.  Both live in `TauCeti.DavisKahan.Experimental.ExactSinTheta` in `DavisKahan/Sylvester/ScalarGeneric.lean`, reachable from `DavisKahan.All` via `DavisKahan.Sylvester.All`.  Do not re-add them to this list without first confirming the probe resolves them.

**ITEM (b) IS DISCHARGED AT COMPLEX SCALARS, 2026-08-10.**  The unbounded `tan 2Theta` Ky Fan `nu >= 2` and arbitrary-unitarily-invariant-norm endpoint now exists -- `mem_and_gauge_le_reflectionTangentCorner` in `DavisKahan/Sources/DavisKahan1970/TanTwoThetaUnboundedGramMiddle.lean` -- with the extremality hypothesis DELETED rather than discharged, and over cutoff nets whose levels grow without bound.  Full detail is recorded on `S2-unbounded-scope`.  **ITEM (a) IS NOW THE ONLY MATHEMATICAL ITEM HOLDING THIS ROW**, alongside the real-scalar axis that item (b)'s endpoint does not cross.

**ITEM (a) IS DISCHARGED AT COMPLEX SCALARS, 2026-08-10 (Claude Opus 5; coordinator-verified: build 9614 -> 9615 jobs, BUILD_EXIT=0 read from the echoed log line after waiting for it, zero errors, ZERO warnings from the new module, seven checks EXIT=0, all four ratchets byte-identical at 165/51/51/91).**  New module `DavisKahan/TanTheta/Theorem63UnboundedCompression.lean` (826 lines, 53 declarations, no `sorry`), plus an IN-PLACE refactor of `Theorem63TrialData.lean` that keeps `restrict`'s name and is definitionally identical field-by-field, so every downstream `rfl` lemma survives.

  `UnboundedCompressionTrialData` -- `compression : Z ->l.[k] Z` UNBOUNDED with self-adjointness as a field, `residual : Z ->L[k] H` bounded, scalar-generic rather than fixed at C, mirroring `CommonDomainSinThetaData`'s layout rather than a new shape
  `UnboundedCompressionTrialData.ofBounded` -- the existing bounded `Theorem63TrialData` is an instance, so NO hypothesis is added to anything already proved
  `ideal_of_formBounds`, `ideal_of_formBounds_exists`, `ideal_of_reducing_exists` -- `delta * N.gauge tanTheta_0 <= N.gauge D.residual` at every `KyFanDominantIdealFamily`, under `SemiboundedAbove D.compression alpha` (a FORM bound on an unbounded operator, not a CLM norm bound)

**THE STAGE-1 MEASUREMENT, WHICH IS THE DURABLE PART.**  Boundedness of the compression is consumed by two chains that answer DIFFERENTLY, and the census had been describing the wrong one.  (A) The finite-trial chain (`Theorem63TrialData.sine_lt_one_of_formBounds`, `kyFan_core_of_le_finrank`, `all_kyFan_core_of_formBounds`, `ideal_of_formBounds`) carries `[FiniteDimensional C Z]` throughout, and on a finite-dimensional `Z` every linear map is continuous -- so removing `->L` there generalizes NOTHING, and the paper's `A_0 may now be unbounded' is only a real statement about an INFINITE-dimensional trial space.  (B) The infinite-trial chain `Theorem63UnboundedInfiniteTrial.lean` is the one that matters, and there boundedness enters ESSENTIALLY: `exists_finiteDimensional_superset_compression_leak` (line 145) discharges its goal through `TauCeti.BorelCalculus.exists_finiteDimensional_le_almostInvariant`, whose proof sets `R := ||T|| + 1` and partitions `[-R, R]` into bands -- a genuine use of the operator norm, not bookkeeping.  **So item (a) was NOT structural**, contrary to the coordinator's hypothesis.

THE ROUTE WAS TRUNCATE-THEN-RELEASE, the pattern proved out the same day on the `tan 2Theta` endpoint, and the ordering was load-bearing in the same way.  The fixed-cutoff theorem `all_kyFan_core_trunc` has a `tau`-FREE right-hand side (`kyFanApproximationGauge k D.residual`), which is what lets the release run over `tau -> atTop` with unbounded levels.  It is cheap because `truncSpace tau` is a SPECTRAL subspace and therefore REDUCES `A_0`: `truncData_residual` shows the truncation contributes nothing to the Ritz residual and `truncData_action_eq_action` shows the truncated action IS the ambient action there, so the truncated bundle is ordinary bounded `Theorem63TrialData` and the compiled `all_kyFan_core_of_formBounds_infinite` applies VERBATIM -- **no reproof of Theorem 6.3**.

**FALSE PREMISES IN THE COORDINATOR'S BRIEF.**  (1) The brief located the state of the art at `Theorem63TrialData.lean:67` and `Theorem63Unbounded.lean:73`; BOTH are finite-trial, where the gap is invisible.  The module that actually governs item (a) is `Theorem63UnboundedInfiniteTrial.lean` -- which this row's own `lean_declarations` already listed and the brief never mentioned.  (2) The brief hypothesized the generalization was `largely structural if it enters only through form bounds and Ky Fan gauges'; it does not.  (3) The brief quoted the dependency-layer baseline as 11; it is **13** and has been since the Section 9 merge -- see the note on that below.  Route note, not an error: `BoundedCutoff`/`cutoffCorner` exist as described but cut an AMBIENT operator to a corner, whereas the operator needing spectral resolution here already lives on `Z`, so `ExactSinTheta.spectraSpectralCutoff` / `spectraBoundedTruncation` were used instead.

**WHAT REMAINS ON THIS ROW IS NOW PURELY THE REAL-SCALAR AXIS.**  Every printed item has a complex endpoint: (a) and (b) both landed 2026-08-10, (c) and (d) earlier, (e) is documentation.  The new endpoints are C-only, blocked at `TauCeti.BorelCalculus.exists_finiteDimensional_le_almostInvariant` and at `spectraSpectralCutoff`/`spectraBoundedTruncation`, all C-hardwired through the bounded PVM -- the same C-only dependency this row's M35 note already recorded for the Appendix passage.  The real sibling would follow `DirectedUnboundedReal.lean`.

SCOPE STATED HONESTLY BY THE MISSION, and it is a real limitation worth keeping visible: the data layer abstracts `A_0` as a self-adjoint operator GIVEN on `Z`, exactly as `Theorem63TrialData` already did.  Deriving self-adjointness of `P_Z A|_Z` from an ambient `A` is NOT attempted -- that is the Rayleigh-Ritz/Friedrichs question -- and `ideal_of_reducing_exists` takes the link as the hypothesis `haction`.

**ITEM (a) NOW HOLDS OVER REAL SCALARS TOO, 2026-08-11 (Claude Opus 5; coordinator-verified: build 9616 -> 9618 jobs, BUILD_EXIT=0 read from the echoed log line after waiting for it, zero errors, seven checks EXIT=0, four ratchets TRUE_EXIT=1 with counts flat at 165/51/51/91, three baselines flat at 13/154/16, probe clean on all 28 new declarations).**  New module `DavisKahan/Sources/DavisKahan1970/UnboundedCompressionReal.lean` giving `theorem6_3_unboundedCompression_ideal_of_reducing_exists_real` and siblings: `delta * N.gauge tanTheta_0 <= N.gauge D.residual` at every `KyFanDominantIdealFamily (k := R)`, with the compression UNBOUNDED and semibounded above in form.  Plus an IN-PLACE `RCLike` generalization of the data layer in `Theorem63UnboundedCompression.lean` (the structure, `action`, `ofBounded` and its three equations, `orthogonalProjectionOnto_coe`, `crossed_lower_of_reducing`), names kept verbatim.

THE ROUTE WAS THE TRIAL-DATA TRANSPORT, NOT A REAL SPECTRAL CUTOFF, and this is the reusable lesson: the `Omega(tau)` cutoff in item (a) is the spectral cutoff of the RITZ COMPRESSION ON THE TRIAL SPACE, so under the `DirectedUnboundedReal.lean` pattern it is applied to the COMPLEXIFIED compression, entirely inside the already-compiled complex `all_kyFan_core`.  The real module never mentions a real spectral cutoff.  Approximation numbers are preserved on the nose at the finite Ky Fan level, so the numerical conclusion descends.  The only genuinely new analytic ingredient was `semiboundedAbove_unitaryConjugate` -- an upper form bound survives conjugation by a `<=_l_i[C]` -- needed because `PartialMapComplexification.semiboundedAbove_complexify` lands on `RealComplexification of Z` while the bundle needs it on `complexifySubmodule Z`.

**A REAL `SpectralCutoffInterface` ALSO LANDED, AND IT IS STANDALONE INFRASTRUCTURE RATHER THAN A PREREQUISITE.**  `DavisKahan/SpectralTheory/Real/SpectralCutoff.lean` supplies `realSpectralCutoff` and `realSpectraSpectralCutoffInterface` with all five fields.  It discharges the real cutoff obligation for the unbounded Sylvester / `sin Theta` path; item (a) did NOT need it.  Recorded so nobody treats the two as coupled.  In-place `RCLike` generalization of `spectraSpectralCutoff` is NOT possible: it is definitionally `LinearPMap.specProjection`, whose PVM comes from the Borel calculus of the CAYLEY TRANSFORM, so the real construction is a different EXTERNAL theorem (conjugation-fixedness of the complexified PVM) -- precisely the case that `RCLike.I_mul_I_ax` cannot assemble.

**TWO FALSE PREMISES IN THE COORDINATOR'S BRIEF, AND THE SECOND MATTERS FOR ANY FUTURE CUTOFF WORK.**  (1) The brief claimed four of the five interface fields already had compiled real counterparts, mapping `realSelfAdjointSpectralProjection_mem_domain` to `range_le_domain`.  FALSE: that lemma quantifies over `x : A.domain` only, whereas `range_le_domain` quantifies over the whole RANGE of the cutoff, i.e. over all of `E`.  What makes the field true is BOUNDEDNESS OF THE BAND `[-tau, tau]`, exactly as on the complex side (`mem_domain_of_mem_specRange_of_bounded`); it had to be proved by descending through the complex side and is not a restatement.  (2) Consequently the brief's `tendsto_identity is the one genuinely missing piece' was wrong -- TWO fields were missing, not one.  `tendsto_identity` itself did descend as predicted, via `spectraSpectralCutoff_tendsto_identity` plus `selfAdjointSpectralProjection_ofReal` plus isometry of `ofReal`.

**WHAT NOW HOLDS THIS ROW: ITEM (b)'s REAL AXIS ONLY.**  Item (a) is real and complex; item (b)'s endpoint (`mem_and_gauge_le_reflectionTangentCorner`) is still C-only, blocked at the Gram-resolvent and Gram-selection layers, whose root is the CAYLEY TRANSFORM in `gramSpectralPVM` -- an obstruction with no R analogue, distinct from the two resolved here.

**PROMOTED TO `compiled_exact` 2026-08-11.**  Item (b)'s real axis -- the last thing holding this row -- is discharged by `mem_and_gauge_le_reflectionTangentCorner_real` and its two siblings; see the paragraph of the same date on `S2-unbounded-scope` for the full record, including the 56793-constant closure check confirming the extremality condition is absent from the real side too.  EVERY PRINTED ITEM NOW HOLDS OVER BOTH SCALAR FIELDS: (a) complex 2026-08-10 and real 2026-08-11, (b) complex 2026-08-10 and real 2026-08-11, (c) and (d) struck earlier, (e) adjudicated as documentation fidelity rather than theorem debt.

**THE FRONTIER 0% IS FIXED 2026-08-11 (Claude Opus 5, coordinator, task #9 strand 2), and this row's own complaint about it is now discharged.**  The paragraph above reading `ALSO OVER-PESSIMISTIC ELSEWHERE: dev/davis-kahan-1970-frontier-status.md:35 scores this row at 0%' was correct and is now stale: the row reads **0 / 17 missing, 100%, grounded**.

THE CAUSE WAS MANIFEST GRANULARITY, NOT A STALE NUMBER, so the fix was to split the node rather than edit the score.  `s6-appendix-unbounded` carried `open_obligation: true` with an EMPTY dependency list, which makes its closure 1/1 -- so one stale flag scored the entire appendix at 0% however much of it was proved.  It is now eight nodes, one per printed item per scalar field where the row distinguishes them: `s6-appendix-unbounded` and `s6-appendix-sine-real` (d), `s6-appendix-prop6-1-common-domain{,-real}` (c), `s6-appendix-unbounded-compression{,-real}` (a), `s6-appendix-tan2-kyfan{,-real}` (b).  Item (e) deliberately gets NO node, on this row's own 2026-08-10 adjudication that it is proof apparatus internal to (a) rather than a statement the paper asserts.  All three reasons the flag cited were re-measured against the build before clearing it, not taken from the note.
...
- `TauCeti.DavisKahan1970.theorem6_3_unbounded_infiniteTrial_ideal_exists_of_reducing_real`
- `TauCeti.DavisKahan1970.theorem6_3_unbounded_infiniteTrial_ideal_exists_real`
- `TauCeti.DavisKahan.ExactSinTheta.CommonDomainSymmetricSinThetaProblem`
- `TauCeti.DavisKahan.ExactSinTheta.CommonDomainSymmetricSinThetaProblem.perturbation_isSymmetric`
- `TauCeti.DavisKahan.ExactSinTheta.CommonDomainSymmetricSinThetaProblem.forward_all_kyFan`
- `TauCeti.DavisKahan.ExactSinTheta.CommonDomainSymmetricSinThetaProblem.reverse_all_kyFan`
- `TauCeti.DavisKahan.ExactSinTheta.CommonDomainSymmetricSinThetaProblem.symmetric_all_kyFan`
- `TauCeti.DavisKahan.ExactSinTheta.CommonDomainSymmetricSinThetaProblem.result_every_unitarilyInvariantNorm`
- `TauCeti.DavisKahan.ExactSinTheta.CommonDomainSymmetricSinThetaProblem.ofBounded`
- `TauCeti.DavisKahan1970.CommonDomainSymmetricSinThetaProblem`
- `TauCeti.DavisKahan1970.proposition6_1_commonDomain`
- `TauCeti.DavisKahan1970.proposition6_1_commonDomain_kyFan`
- `TauCeti.DavisKahan1970.proposition6_1_commonDomain_ofBounded`
- `TauCeti.DavisKahan1970.theorem6_3_unbounded_infiniteTrial_ideal_of_reducing_real`
- `TauCeti.DavisKahan1970.theorem6_3_unbounded_infiniteTrial_ideal_real`
- `TauCeti.DavisKahan1970.proposition6_1_real_commonDomain`
- `TauCeti.DavisKahan1970.proposition6_1_real_commonDomain_kyFan`
- `TauCeti.DavisKahan1970.proposition6_1_real_commonDomain_ofBounded`
...
**Notes.** Common-domain and graph-core source forms are compiled. This does not by itself ground the Appendix's full arbitrary-unitarily-invariant tan-theta cutoff/Fan passage, which remains a separate frontier obligation.
...
**SHARED ADAPTER LANDED 2026-08-07 (Claude Opus 5).**  `complexifySubmoduleEquiv (Z : Submodule ℝ E) : RealComplexification ↥Z ≃ₗᵢ[ℂ] ↥(complexifySubmodule Z)` (`DavisKahan/SpectralTheory/Complexification/SubmoduleEquiv.lean`, axiom-clean, in the default build) removes the first load-bearing obstruction to the real lift on this row.  The problem it solves: a real configuration carries an operator on `↥Z`, complexifying lands on `RealComplexification ↥Z`, and every complex theorem here speaks about `↥(complexifySubmodule Z)`.  Canonically the same space, NOT definitionally equal.  `re`/`im` are preserved on the nose, so conjugating a compression or residual through it is mechanical.  It is deliberately an isometric equivalence rather than a definitional identification, because the ideal/norm layer only needs equality of approximation singular values and unitary conjugation gives exactly that.  The unbounded appendix reuses the same adapter for trial subspaces, on top of the existing closed-operator transports in `DavisKahan/SpectralTheory/PartialMap/Complexification.lean`.  Do not rewrite the cutoff argument.
...
2. **Proposition 6.1 has no common-domain or unbounded form.**  The Appendix says explicitly that "the hypotheses of Proposition 6.1 and Theorem 6.1 may be relaxed similarly".  Theorem 6.1 has been relaxed (`theorem6_1_commonDomain`, `theorem6_1_commonCore`, and their real companions).  Proposition 6.1 has not: its only source-facing input record is `SymmetricSinThetaProblem` (`Sources/DavisKahan1970/SineTheta/Symmetric.lean`), whose fields are `A B : E ->L[C] E` -- bounded operators -- with both gap hypotheses phrased through the everywhere-defined partial-map view of a bounded operator.  There is no `PaperCommonDomainSymmetric...` analogue.
...
4. **The unbounded double-angle endpoint remains at nu = 1.**  See the entries above: `tanTwoTheta_unbounded_residual_opNorm_complex` is the operator norm, residual form; the Ky Fan `nu >= 2` and arbitrary-unitarily-invariant-norm cases are open, with the obstruction (the `A_1`-side cutoff that does not exist) recorded above.
...
WHAT THE LIFT ACTUALLY NEEDS, measured by reading the proof rather than guessing.  The Appendix Ky Fan passage `Theorem63TrialData.all_kyFan_core_of_formBounds_infinite` -- the cutoff/Fan argument itself -- consumes ONLY bounded data: the four fields of `Theorem63TrialData Z V` (`action : Z →L[ℂ] H`, `compression : Z →L[ℂ] Z`, `residual : Z →L[ℂ] H`, and the block identity), the form bound `hMupper` on `compression`, and the crossed form bound `hcross` on `action`.  The unbounded operator appears in exactly one place, `crossed_lower_of_reducing`, which manufactures `hcross` from the reducing hypotheses.  So the real lift decomposes into four independent pieces, none of which touches the cutoff argument:
  ...
  (iv) a real `UnboundedTrialBlockReal` over a real `LinearPMap`, its `ofUnbounded` instance, and a real `crossed_lower_of_reducing`.  Only (iv) is genuinely new closed-operator work; `DavisKahan/SpectralTheory/PartialMap/Complexification.lean` already complexifies a real closed operator and its domain.
The endpoint should be stated at `SymmetricNormingFunction` scope and the transport done at the finite Ky Fan level, for the reason recorded on `DK-6.3-thm` and `S2-tan-theta`: `KyFanDominantIdealFamily` instances cannot be compared across scalar fields.
...
**FOUR RECORDED CLAIMS ON THIS ROW WERE WRONG, all in the direction of overstating the work.**  (i) `the endpoint belongs at SymmetricNormingFunction scope rather than over KyFanDominantIdealFamily` -- FALSE as landed: it is over `KyFanDominantIdealFamily R`, and nothing is compared across fields, only approximation numbers cross.  (ii) `the work is a real Theorem63TrialData, plus its complexification, plus a real crossed_lower_of_reducing` -- NO real duplicates were ever written: `Theorem63TrialData` (`Theorem63TrialData.lean:67`), `Theorem63TrialData.ofUnbounded`, `BoundedCompressionTrialBlock` and `crossed_lower_of_reducing` (`Theorem63Unbounded.lean:120`) all sit inside `section ScalarGeneric` with `[RCLike K]`, so the real instances ARE those declarations at `K = R`.  (iii) `the four bounded fields of Theorem63TrialData` -- it has SIX fields, three operators (`action`, `compression`, `residual`) and three properties.  (iv) `lean_declarations` omitted two real endpoints that exist, are axiom-clean and are in the default build; both are now listed.

REUSE, not rebuilding: the paper's argument was untouched for item (c).  Both one-sided applications already ran through `UnboundedSinThetaData`, `unbounded_adjoint_residual_block_identity` and `davisKahan1970_sylvester_complex` -- closed-operator theorems that the BOUNDED file reached only via the everywhere-defined partial-map view of a bounded operator.  Lemma 6.1, the Lemma 6.2 contraction and the literal `sin Theta` identification are reused verbatim.  DELIBERATELY NOT DONE: rewriting `Symmetric.lean` to derive the bounded endpoint from the new one -- a real convergence cleanup, but it churns `SymmetricReal.lean` and the `SineThetaSourceInventory` surface for no mathematical gain.
...
FOR THIS ROW SPECIFICALLY: item (b) is delivered CONDITIONALLY.  The note that it should not be dispatched as a routine mission STANDS, but its reason is corrected: the blocked route is the GRAPH LANE, not the theorem.
...
FOR THIS ROW: item (b) still open.  This work strictly WIDENS the conditional rather than discharging it.  The row's recorded "ONE GENUINE RISK" is retired.
...
FOR THIS ROW: item (b) does not close, **BUT ITS RECORDED OBSTRUCTION NO LONGER APPLIES.**  The row gates (b) on a seam measured as a NO-GO for arguments resting on strong convergence of spectral cutoffs.  The new route rests on EXACT finite-dimensional compression and uses no cutoff, no limit and no error term, so that NO-GO does not bind it.  What (b) still needs is the filtration hypothesis.
...
FOR THIS ROW: item (b) does not close.  Its obstruction is now the attainment clause, superseding both the cutoff NO-GO (already retired) and the invariant-subspace route (refuted above).

**AMBIENT CONSUMER ADDED 2026-08-12.**  The Appendix unbounded-compression machinery is now consumed by the Section 2 ambient tangent theorem itself, not only by directed Theorem 6.3.  `tanTheta_ambient_unboundedRitz_explicitCompatibility_symmetricNorming_complex` and its real sibling preserve the Appendix case in which both `A_0` and `Lambda_1` may be unbounded, while the residual and perturbation norm remain bounded.  This closes the source-scope integration gap; the row's separate hostile atomization issue for equations (6.7)--(6.11) is unchanged.

**Next action.** Hostile re-audit reopened this row. The TeX explicitly preserves equations (6.7)-(6.11) and the limiting proof chain. The row maps endpoint/common-domain machinery and historically treats parts of the chain as documentation fidelity; under statement-level 100% coverage, every preserved mathematical equation needs explicit evidence/disposition.

**Blocked by:** `hostile-audit-atomization`

**Completion holes:**

- {'kind': 'audit_atomization', 'detail': 'The TeX explicitly preserves equations (6.7)-(6.11) and the limiting proof chain. The row maps endpoint/common-domain machinery and historically treats parts of the chain as documentation fidelity; under statement-level 100% coverage, every preserved mathematical equation needs explicit evidence/disposition.'}

### `DK-6.3-lem` — Finite-rank near-maximizer leakage estimate

**importance:** `technical`  **section:** 6 appendix  **source:** Lemma 6.3  **kind:** lemma  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** A nearly Ky-Fan-optimal finite-rank compression has small off-block trace norm.

**Scope gap.** CLOSED 2026-08-09 (Claude Opus 5).  The gap recorded below was real and is now discharged: `lemma6_3_approximationNumber_leakage_real` and `lemma6_3_singularValue_leakage_real` (`DavisKahan/Sources/DavisKahan1970/Section6AppendixLeakageReal.lean`) are Lemma 6.3 over a REAL Hilbert space of arbitrary dimension -- real operator `K : E →L[ℝ] F`, real subspaces `P`, `Q`, real approximation numbers, real operator norm -- with the source-faithful block hypothesis `K ∘ P = Q ∘ K ∘ P` unchanged and no dimension hypothesis on the approximation-number form.  PRIOR TEXT, for the record: real-scalar/infinite-dimensional: every declaration was `InnerProductSpace ℂ` only, confirmed by elaboration 2026-08-07 under the corrected repo-wide method, with no real endpoint anywhere in the repo.
...
- `TauCeti.DavisKahan1970.Section6Appendix.lemma6_3_approximationNumber_leakage_of_energySplit`
...
STATUS CORRECTED 2026-08-07 (Fable 5): `partial_or_wrapper_missing` -> `compiled_exact`.  The next_action ('state and prove the source lemma') predates the 2026-08-04 correction that located the declaration; the lemma IS stated and proved, in the default build, axiom-clean, in BOTH the source's forms: `lemma6_3_approximationNumber_leakage_complex` (near-Ky-Fan-optimal prefix square energy forces off-block operator norm below eta, with the source-faithful block hypothesis K P = Q K P -- the module docstring documents why the earlier K P = Q K stating was wrong) and the finite-dimensional singular-value specialization `lemma6_3_singularValue_leakage_complex`.  The compiled statement generalizes the source only by not assuming K compact (the rank hypotheses on the projections carry the finiteness), which is scope-widening, not scope-narrowing.

**M32, THE SECTION 6 SCALAR TRANCHE, 2026-08-09 (Claude Opus 5).**  **THE REAL-SCALAR AXIS IS CLOSED, BY PROOF, AND THE ROUTE WAS NOT THE ONE THE BLOCKER PREDICTED.**  The blocker's standing ROUTE note says a real wrapper 'should go through' the complexification route 'rather than by reproving over `RCLike`, since several proofs use the complex continuous functional calculus essentially'.  MEASURED for this lemma: the proof uses no functional calculus at all.  Of its eight supporting declarations, seven are scalar generic verbatim -- they consume only `approximationSingularValue`, `approximationNumberEnergy_eq_sum_range_of_rank_le`, `approximationNumber_comp_le_norm_mul` and `starProjection_norm_le`, all of which are already `RCLike`.  Exactly ONE step was complex-only: the Pythagorean splitting `hilbertSchmidtEnergy_domain_projection_add_complex`, and only because the column-energy bridge `approximationNumberEnergy_eq_basisEnergy` (`Ideals/HilbertSchmidtBasis.lean`) is stated over `ℂ`.

So `Section6AppendixLeakage.lean` was generalized to `RCLike 𝕜` (`approximationEnergy` and its five lemmas, plus the new engine `lemma6_3_approximationNumber_leakage_of_energySplit`, which takes the splitting for the one operator that needs it as a hypothesis), and only the splitting was transported.  `Section6AppendixLeakageReal.lean` proves `hilbertSchmidtEnergy_domain_projection_add_real` by reading the complex splitting at `complexify L` and `complexifySubmodule P`: complexification preserves the whole approximation singular-value sequence hence the energy (`approximationNumberEnergy_complexify`), the orthogonal projection onto a complexified real subspace is the complexification of the real one (`starProjection_complexifySubmodule`), and complexification carries `1 - P` to `1 - complexify P`.  `lemma6_3_approximationNumber_leakage_real` and the finite-dimensional `lemma6_3_singularValue_leakage_real` are then the ℝ instances of the same engine the ℂ forms use, word for word the complex statements with `InnerProductSpace ℂ` replaced by `InnerProductSpace ℝ`, at arbitrary dimension.  Both axiom-clean (`[propext, Classical.choice, Quot.sound]`), both in the default build.

**Next action.** No hostile-review hole is currently recorded for this source passage. Preserve exact source scope and re-audit if the distributable source specification changes.

### `DK-7-sin2-proof` — Reflection proof of the sine double-angle theorem

**importance:** `technical`  **section:** 7  **source:** Section 7, equations (7.1)–(7.5)  **kind:** proof_package  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `reopened_mapping`

**Summary.** Reflect the perturbation by 2P-1, identify U squared and sin(2 Theta), and reduce the result to the symmetric sine theorem.
...
**Notes.** The reflection identities and finite theorem exist; the exact full proof package is under repair.
...
ROW WAS STALE; CORRECTED 2026-08-07 (Fable 5).  The requested 'source wrapper preserving both residual and perturbation conclusions' has existed since the SinTwoTheta facade landed (DavisKahan/Sources/DavisKahan1970/SinTwoTheta.lean, `namespace TauCeti.DavisKahan1970`): the mirror-defect identities of the reflection proof (equations (7.1)-(7.3): `sinTwoTheta_mirrorDefect_eq_perturbationDefect`, `_le_two_mul`, and the gauge form), the double-angle identification (7.4)-(7.5) (`sinTwoTheta_reflectedOverlap_norm`), and BOTH conclusions at source-general scope -- arbitrary complete Hilbert space, unbounded closed self-adjoint operator, arbitrary Ky-Fan-dominant ideal family, representative freedom: `sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_complex` (perturbation form, sharp factor two) and `sinTwoTheta_unbounded_reflectionResidual_arbitraryRepresentative_complex` (residual form, constant one).  All resolve from `DavisKahan.All` and are axiom-clean (verified by elaborator probe 2026-08-07).

**M37, 2026-08-09 (Claude Opus 5).  STALE BLOCKER ENTRY REMOVED.**  The 2026-08-07 correction on this row already recorded that the requested source wrapper exists and that the row's `next_action` is 'Nothing outstanding for the reflection proof package'; the `blocked_by` reference to `exact-source-wrappers` was simply not removed with it.  Re-measured 2026-08-09 by elaborating all five declarations against `DavisKahan.All`: every one resolves, including both conclusions at source-general scope (`sinTwoTheta_unbounded_perturbation_arbitraryRepresentative_complex`, sharp factor two, and `sinTwoTheta_unbounded_reflectionResidual_arbitraryRepresentative_complex`, constant one).  The blocker is retired; its text is preserved on `S1-block-residual`.

**Next action.** Hostile re-audit reopened this row. The block contains equations (7.1)-(7.5), reflected diagonalization, the factor-one directed residual refinement, swap asymmetry, and a counterexample. The current clauses do not explicitly account for every separable identity/assertion.

**Blocked by:** `hostile-audit-atomization`

**Completion holes:**

- {'kind': 'audit_atomization', 'detail': 'The block contains equations (7.1)-(7.5), reflected diagonalization, the factor-one directed residual refinement, swap asymmetry, and a counterexample. The current clauses do not explicitly account for every separable identity/assertion.'}

### `DK-7-tan2-proof` — Singular-vector proof of the tangent double-angle theorem

**importance:** `technical`  **section:** 7  **source:** Section 7, equation (7.6) and following argument  **kind:** proof_package  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `reopened_mapping`

**Summary.** The off-diagonal block equation and paired singular vectors yield Ky Fan and UI-norm bounds for tan(2 Theta).

**Lean declarations:**

- `TauCeti.DavisKahan1970.tanTwoTheta_principalBranch_finiteDimensional_uiNorm_rclike`
- `TauCeti.DavisKahan1970.tanTwoTheta_principalBranch_finiteDimensional_kyFan_rclike`
- `TauCeti.DavisKahan1970.tanTwoTheta_principalBranch_finiteSubspace_idealFamily_rclike`
- `TauCeti.DavisKahan1970.tanTwoTheta_principalBranch_finiteSubspace_kyFan_rclike`
- `TauCeti.DavisKahan1970.tanTwoTheta_sharpness_opNorm_rclike`
- `TauCeti.DavisKahan1970.tanTwoTheta_spectral_repulsion`
- `TauCeti.DavisKahan1970.tanTwoTheta_unbounded_residual_opNorm_complex`
- `TauCeti.DavisKahan1970.tanTwoTheta_unbounded_residual_div_complex`

**Notes.** The operator-norm theorem is compiled in finite dimensions; the arbitrary UI-norm singular-vector argument remains uncertified.
...
ROW WAS STALE; CORRECTED 2026-08-07 (Fable 5).  The requested 'exact source norm scope and infinite-dimensional approximation passage' have existed since the TanTwoTheta facade landed (DavisKahan/Sources/DavisKahan1970/TanTwoTheta.lean): `tanTwoTheta_principalBranch_finiteDimensional_uiNorm_rclike` is equation (7.6) at the source norm scope -- every rectangular unitarily invariant norm, proved by the paper's paired-singular-vector argument -- and `tanTwoTheta_principalBranch_finiteSubspace_idealFamily_rclike` / `tanTwoTheta_principalBranch_finiteSubspace_kyFan_rclike` are the infinite-dimensional sharp ideal forms via compression to the finite carrier (the paper's own passage), with `tanTwoTheta_sharpness_opNorm_rclike` the pole-free sharp subspace theorem carrying the Section 8 acute branch and `tanTwoTheta_spectral_repulsion` the branch-keeping mechanism.  The facade's docstring records the audited boundary: the sharp infinite-dimensional ideal form requires a finite-dimensional invariant subspace (principal angles attained), the unbounded companions cover genuine spectral subspaces at the extended-cosine denominator, and the UNRESTRICTED sharp infinite-dimensional statement is excluded as refuted (the genuine unbounded Sylvester equation has a nonzero commutator defect; `doubleAngleTangent_sylvesterEquation` carries it explicitly).  Excluding an unsupported statement is completing the surface, not a gap.  All declarations resolve from `DavisKahan.All` and are axiom-clean (elaborator probe 2026-08-07).
...
**OPERATOR-NORM UNBOUNDED RESIDUAL COMPANION, 2026-08-09 (Claude Opus 5).**  `TauCeti.DavisKahan1970.tanTwoTheta_unbounded_residual_opNorm_complex` and `..._div` (`Sources/DavisKahan1970/TanTwoThetaUnboundedResidual.lean`) give the operator-norm case of this row's theorem for UNBOUNDED self-adjoint `A`, in residual form with the sharp constant `2` and structural branch-freeness, together with the explicit pole exclusion `|cos 2 Theta_0| >= delta / sqrt(delta^2 + 4 ||B||^2)`.  The arbitrary-UI-norm (Ky Fan `nu >= 2`) case in the unbounded setting is still open; the obstruction is recorded on `DK-6-appendix`.  Nothing on this row changes: the bounded results here are unaffected.
...
**M37, 2026-08-09 (Claude Opus 5).  STALE BLOCKER ENTRY REMOVED.**  As on `DK-7-sin2-proof`, the 2026-08-07 correction had already recorded that equation (7.6) is compiled at the source norm scope (`tanTwoTheta_principalBranch_finiteDimensional_uiNorm_rclike`, by the paper's paired-singular-vector argument) with the infinite-dimensional sharp ideal forms beside it, and had set `next_action` to 'Nothing outstanding at the source's own scope'; only the `blocked_by` entry was left behind.  Re-measured 2026-08-09 by elaboration against `DavisKahan.All`: all eight declarations resolve.  The blocker is retired; its text is preserved on `S1-block-residual`.

**Next action.** Hostile re-audit reopened this row. The exact directed/ambient tan(2 Theta) endpoints are now closed. The proof block still contains equation (7.6), scalar singular-vector inequality, pole exclusion as a conclusion, Fan-dominance steps, and both endpoints under one coarse audit clause; atomize these for static semantic certification.

**Blocked by:** `hostile-audit-atomization`

**Completion holes:**

- {'kind': 'audit_atomization', 'detail': 'The exact directed/ambient tan(2 Theta) endpoints are now closed. The proof block still contains equation (7.6), scalar singular-vector inequality, pole exclusion as a conclusion, Fan-dominance steps, and both endpoints under one coarse audit clause; atomize these for static semantic certification.'}

### `DK-8.1-thm` — Branch selection and spectral repulsion

**importance:** `major`  **section:** 8  **source:** Theorem 8.1  **kind:** theorem  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Under tan(2 Theta) hypotheses, the closed quarter-angle condition is equivalent to the selected spectral ordering; a canonical reducing subspace exists, is unique, and satisfies the operator, ordered-eigenvalue and every-symmetric-gauge repulsion inequalities on both blocks.

**Lean declarations:**

- `TauCeti.DavisKahan1970.Section8.theorem8_1_canonicalBranch`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_eq_canonicalBranch_of_maximalAngle_le`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_maximalAngle_le_iff_spectrumIn`
- `TauCeti.DavisKahan1970.Section8.Theorem81Conclusion`
- `TauCeti.DavisKahan1970.Section8.canonicalLowBranch`
...
- `TauCeti.DavisKahan1970.Section8.approximationNumber_upperBlockShift_eq_zero_of_le`
- `TauCeti.DavisKahan1970.Section8.approximationNumber_lowerBlockShift_eq_zero_of_le`
- `TauCeti.DavisKahan1970.Section8.approximationNumber_cosineBlock_eq_principalCosines`
- `TauCeti.DavisKahan1970.Section8.approximationNumber_lowerCosineBlock_eq_principalCosines`
- `TauCeti.DavisKahan1970.Section8.norm_cosineBlock_eq_principalCosines_zero`
- `TauCeti.DavisKahan1970.Section8.norm_lowerCosineBlock_eq_principalCosines_zero`
- `TauCeti.DavisKahan1970.Section8.cos_arccos_approximationNumber_cosineBlock`
- `TauCeti.DavisKahan1970.Section8.maximalAngle_le_pi_div_six_iff`
...
- `TauCeti.DavisKahan1970.Section8.Theorem81ConclusionReal`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_canonicalBranch_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_eq_of_maximalAngle_le_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_maximalAngle_le_iff_spectrumIn_real`
- `TauCeti.DavisKahan.Foundation.realSpectrum_subset_Iic_of_re_inner_le_generic`
- `TauCeti.DavisKahan.Foundation.realSpectrum_subset_Ici_of_le_re_inner_generic`
- `TauCeti.DavisKahan.Foundation.spectrumIn_Iic_of_re_inner_le_generic`
- `TauCeti.DavisKahan.Foundation.spectrumIn_Ici_of_le_re_inner_generic`
- `TauCeti.DavisKahan.complexify_upperBlockShift`
- `TauCeti.DavisKahan.complexify_cosineBlock`
- `TauCeti.DavisKahan.complexify_lowerBlockShift`
- `TauCeti.DavisKahan.complexify_lowerCosineBlock`
- `TauCeti.DavisKahan.complexify_adjoint_sandwich`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_spectralRepulsion_real`
- `TauCeti.DavisKahan1970.Section8.canonicalLowBranchReal`
- `TauCeti.DavisKahan1970.Section8.complexifySubmodule_canonicalLowBranchReal`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_canonicalBranch_complexified`
- `TauCeti.DavisKahan1970.Section8.canonicalLowBranchReal_form_low`
- `TauCeti.DavisKahan1970.Section8.canonicalLowBranchReal_form_high`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_perturbedUpperBlockShift_nonneg_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_perturbedLowerBlockShift_nonneg_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_upperSandwichApproximation_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_upperApproximationRepulsion_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_lowerSandwichApproximation_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_lowerApproximationRepulsion_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_upperWeightedWeakMajorization_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_upperSymmetricGaugeRepulsion_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_lowerWeightedWeakMajorization_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_lowerSymmetricGaugeRepulsion_real`
- `TauCeti.DavisKahan1970.Section8.isPositive_toLinearMap_of_nonneg`
- `TauCeti.DavisKahan1970.Section8.range_upperBlockShift_le`
- `TauCeti.DavisKahan1970.Section8.range_lowerBlockShift_le`
- `TauCeti.DavisKahan1970.Section8.norm_cosineBlock_le_one`
- `TauCeti.DavisKahan1970.Section8.arcsin_one_div_two`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_upperApproximationRepulsion_angle_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_lowerApproximationRepulsion_angle_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_upperSymmetricGaugeRepulsion_angle_real`
- `TauCeti.DavisKahan1970.Section8.theorem8_1_lowerSymmetricGaugeRepulsion_angle_real`
...
| Assume the hypotheses of the tan 2 theta theorem. | The canonical source façades inherit the unbounded self-adjoint ambient scope used by the Section 2 tan 2 theta result: `A` is a self-adjoint partial operator, `H` is bounded self-adjoint and fully off-diagonal relative to `P`, `P` reduces `A`, and the two `P`-blocks satisfy the printed ordered placement.  The earlier bounded-vs-unbounded interpretation dispute is operationally moot because the delivered evidence covers the wider unbounded reading in both real and complex scalar scope; the former bounded witnesses remain registered only as specializations. | claimed_exact |
| Then Theta <= pi/4 if and only if the chosen reducing blocks of A + H satisfy Lambda_1 >= alpha + delta and Lambda_0 <= alpha. | `theorem8_1_maximalAngle_le_iff_blockPlacement_unbounded_complex` is that biconditional at unbounded ambient scope, on the source's own blocks: `maximalAngle P Q ≤ pi/4 ↔ (Lambda_0 ≤ alpha ∧ Lambda_1 ≥ alpha + delta)`, where `Lambda_0`, `Lambda_1` are `reducingRestriction (A + H) Q` and its complement and the two relations are `SemiboundedAbove`/`SemiboundedBelow` on them.  The `tan 2theta` hypotheses are likewise on the blocks `A_0`, `A_1`.  Both directions are proved from the printed hypotheses; neither is supplied by the caller.  `..._real` is the same over a real Hilbert space.  The general form-inequality version and the bounded spectrum-inclusion version are registered underneath it. | claimed_exact |
| For fixed A, P, H there exists a reducing projector Q with these properties (take the spectral projector of A + H on the appropriate side of alpha). | `theorem8_1_exists_branch_blockPlacement_unbounded_complex` is the existential the source asserts, at unbounded ambient scope: there is a reducing `Q` of `A + H` with `Lambda_0 ≤ alpha`, `Lambda_1 ≥ alpha + delta` and `maximalAngle P Q ≤ pi/4`.  The spectral projector of `A + H` on the side of `alpha` is the internal witness and does not appear in the public type; `theorem8_1_canonicalBranchUnbounded_printed` is that named-branch statement, registered underneath.  `theorem8_1_eq_canonicalBranchUnbounded_of_maximalAngle_le` is the uniqueness half.  `..._real` are the real siblings. | claimed_exact |
| (i) The upper block obeys A_1 - alpha <= C_1 (Lambda_1 - alpha) C_1, with the analogous lower-block inequality. | `theorem8_1_upperCompressionRepulsion_sourceExact_unbounded_complex` and its lower companion, in the source's own `A/H/P/Q` context and at unbounded ambient scope: `A_1 - alpha ≤ C_1 (Lambda_1 - alpha) C_1` as a form inequality read on `P^perp`, with `C_1` the cosine block `P_{Q^perp}`.  The left side is the form of `A`, not of `A + H`, because `H` is fully off-diagonal and so has no form on `P^perp`.  Both are dimension-free.  The real siblings are `..._unbounded_real`, and the general statement about an arbitrary partial map and reducing subspace is registered underneath. | claimed_exact |
| (ii) In finite dimensions, if lambda_k are the ordered eigenvalues of Lambda_1 and alpha_k those of A_1, then alpha_k - alpha <= \|\|C_1\|\|_1^2 (lambda_k - alpha), with the analogous lower-block statement and natural infinite-dimensional extensions. | The printed finite-dimensional inequality is canonical, on the BLOCKS themselves rather than on the blocks extended by zero to the ambient space: `theorem8_1_{upper,lower}EigenvalueRepulsion_blockSourceExact{,_real}` index the ordered eigenvalue lists of `A_1` on P-perp and `Lambda_1` on Q-perp by the block dimension, the two dimensions agreeing by `theorem8_1_finrank_orthogonal_branch_eq`, and `norm_cosineBlock_eq_principalCosines_zero` identifies the printed \|\|C_1\|\|_1 with the largest principal cosine.  The clause's closing phrase 'and natural infinite-dimensional extensions' is an ASSERTION the source does not make precise -- Section 1 offers the minimax sequence (1.10) for general bounded operators and then says spectral-multiplicity language may be more appropriate in the noncompact case, and Theorem 8.1 prints no infinite-dimensional formula -- so it is accounted for by classification, not discharged by proof.  The repository additionally proves one concrete extension consistent with the Section 1 minimax machinery, `theorem8_1_{upper,lower}ApproximationRepulsion_blockExtension{,_real}`, registered as a generalization. | claimed_exact |
...
| The scalar field is real or complex. | Both fields are carried at every part.  The characterization, the existence half, the uniqueness half and part (i) have real endpoints at unbounded scope on the source's own blocks (`theorem8_1_maximalAngle_le_iff_blockPlacement_unbounded_real`, `theorem8_1_exists_branch_blockPlacement_unbounded_real`, `theorem8_1_eq_canonicalBranchUnbounded_of_maximalAngle_le_real`, `theorem8_1_{upper,lower}CompressionRepulsion_sourceExact_unbounded_real`), proved by complexifying the operator, the perturbation and the subspaces, applying the complex theorem, and descending.  Parts (ii) and (iii) carry their own real endpoints. | claimed_exact |
| The dimension scope differs across the parts: (a), (b) and (i) carry none, (ii) is printed in finite dimensions with natural infinite-dimensional extensions, and (iii) in finite dimensions. | That is exactly how the declarations are stated.  The characterization, the branch construction and part (i) carry no dimension hypothesis.  Parts (ii) and (iii) carry `[FiniteDimensional]`, which is the printed restriction on both.  Part (ii)'s further phrase 'and natural infinite-dimensional extensions' asserts that extensions exist without printing one; the repository proves an approximation-number extension and registers it as a generalization rather than as evidence for the phrase. | claimed_exact |
...
roots, so no transfer and no finite-dimensionality hypothesis is needed.  That supplies one concrete approximation-number extension of the finite-dimensional
formula.  It is retained as a generalization; it is **not** claimed to be the unique
meaning of the source's underspecified phrase "and natural infinite-dimensional
extensions".  The two blocks share the step
...
SUPERSEDED LATER THE SAME DAY.  At this point only canonical evidence selection and the real unbounded ports remained; the next entry records their completion.

REAL UNBOUNDED ENDPOINTS AND CANONICAL PROMOTION, 2026-09-06.  The unbounded Section 8 development now has its real siblings: `theorem8_1_canonicalBranchUnbounded_printed_real`, `theorem8_1_maximalAngle_le_iff_orderedFormGap_unbounded_real`, `theorem8_1_eq_canonicalBranchUnbounded_of_maximalAngle_le_real` and the two `..._CompressionRepulsion_unbounded_real`, transported by complexification through `realSpecRange` and `complexifySubmodule`.  With complex and real unbounded evidence for every clause of Theorem 8.1 that inherits ambient scope, the canonical evidence for `existence-correct-q`, `acute-iff-spectral-placement` and `part-i-compression` is promoted to the unbounded witnesses; the bounded declarations that were canonical are retained as registered specializations.  The explicit finite-dimensional formulas in parts (ii) and (iii) keep their finite-dimensional canonical evidence.  Part (ii)'s separate infinite-dimensional-extension phrase is classified rather than assigned a unique canonical theorem.

SOURCE-FACING UNBOUNDED FAÇADES, 2026-09-06.  The canonical declarations were the general unbounded theorems -- the placements as form inequalities over the ambient domain, part (i) for an arbitrary partial map and reducing subspace.  Those are the right shapes for the mathematics and the wrong shapes for a source boundary.  `Theorem81SourceUnbounded.lean` restates them on the objects Davis and Kahan write: `Lambda_0`, `Lambda_1` as the reducing restrictions of `A + H` with the placements as operator inequalities on them, the existence clause as the existential, and part (i) in the `A/H/P/Q` context with `C_1` the cosine block.  The bridge `semiboundedAbove_reducingRestriction_iff` and its siblings are unfolding.  The general theorems are retained as registered generalizations.
...
### `DK-8.2-thm` — Smallness selects the acute branch and closing extension remark

**importance:** `major`  **section:** 8  **source:** Theorem 8.2 and final Section 8 extension remark  **kind:** theorem  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `reopened_mapping`

**Summary.** If the perturbation norm or the residual norm is below half the gap, and the unperturbed block's spectrum lies in the enlarged central interval, then the sine double-angle estimate is accompanied by Theta < pi/4.

**Scope gap.** **ONE AXIS REMAINS.  Updated 2026-08-10 (Claude Opus 5, coordinator-verified); the two mechanical leftovers and the documentation defect this field used to record are all CLOSED.**

**THE REMAINING AXIS: the RESIDUAL `sin 2Theta` at a general unitarily invariant norm, at the DIRECTED `Theta_0`, with the printed constant 2.**  The obstruction is MATHEMATICAL.  With `C` the `P`-to-`Pperp` block of `A + K`, the singular values of `C + C*` are those of `C` DOUBLED, so `N(C + C*) = 2 N(C)` in general -- the trace norm witnesses it.  Every route through `sinTwoTheta_ambient_bounded_symmetricNorming_complex` must supply a comparison operator REDUCED BY `P`, hence block-diagonal, whose displacement from `A + K` is at best exactly `-(C + C*)`; with `N(C) <= N(R)` that gives constant FOUR, not TWO, and it is not improvable within that route.  Recovering the printed constant needs the singular-value identification of `sin 2Theta_0` with `sin 2Theta_1` -- the HALMOS GENERIC DECOMPOSITION.  Contrast the DIMENSION axis of this row, which turned out NOT to need that machinery.

THIS AXIS IS EQUALLY OPEN OVER `R` AND OVER `C`, AND THE SCALAR AXIS ADDS NOTHING TO IT: the real perturbation half reaches the full printed norm scope and the real residual half reaches the operator norm, EXACTLY MATCHING the complex coverage.

At the OPERATOR norm the compiled residual statement is sound and in fact STRONGER than printed, because `norm_offdiag_add_eq` makes the two off-diagonal blocks equal there, so the AMBIENT reading is legitimate.  Note also that the paper's own proof (transcription L2342) delivers constant ONE, `delta ||sin 2Theta_0|| <= ||B|| <= ||R||`, via Lemma 6.1, where L757 and L2523-2525 print two.
...
- `TauCeti.DavisKahan1970.Section8.ResidualHalfGapBridge`
- `TauCeti.DavisKahan1970.Section8.theorem82_branch_of_residualHalfGapBridge`
...
| source clause | Lean realization | status |
| --- | --- | --- |
| Add to the hypotheses of the $\sin 2\theta$ theorem … | The `sin 2theta` hypotheses are written out in the type of each of the four source façades: `hPred` that `P` reduces `A`, and `hQred`, `hQspec`, `hQperp` that `Q` reduces `A + H` with the printed spectral placement.  The row still has no Lean object standing for "the hypotheses of the previous theorem"; it has them enumerated. | claimed_exact |
| either $\norm{H}_1<\delta/2$ or $\norm{R}_1<\delta/2$ | The alternative is split across two declarations rather than carried as a disjunction, which is what lets the residual branch keep the printed `‖R‖ < delta/2` and not acquire `‖H‖ < delta/2`.  `theorem8_2_perturbation_sourceExact_unbounded_{complex,real}` take `‖H‖ < delta/2`; `theorem8_2_residual_sourceExact_unbounded_{complex,real}` take `‖R‖ < delta/2` on the residual itself.  `theorem8_2_branch_maximalAngle_lt_unbounded_source_{complex,real}` carry the disjunction. | claimed_exact |
| and assume $\spec(A_0)\subset[\beta-\delta/2,\alpha+\delta/2]$ | `hPspec : realSpectrum (reducingRestriction A P hPred) ⊆ Set.Icc (beta - delta/2) (alpha + delta/2)`, the central-spectrum assumption on the block `A_0` at unbounded scope. | claimed_exact |
| The two crossed subspaces have equal dimension — condition (3.5), never restated in Theorem 8.2. | Every unbounded source façade takes `CrossedDefectsEquivalent P Q` and no dimension hypothesis of any kind, which is (3.5) itself rather than the finite-dimensional sufficient condition (1.5). | claimed_exact |
| the corresponding double-angle estimate remains valid | The first conjunct of each source façade: `delta * N(sin 2Theta) ≤ 2 * N(H)` for the perturbation alternative and `delta * N(sin 2Theta_0) ≤ 2 * N(R)` for the residual one, at every normalized unitarily invariant norm, with `A` a possibly unbounded self-adjoint partial map.  The bounded `theorem8_2_sinTwoTheta_*_sourceExact` family, canonical until 2026-09-06, is retained as a registered specialization. | claimed_exact |
| $\Theta<\pi/4$ | `maximalAngle P Q < Real.pi / 4`, the second conjunct of each source façade and the whole conclusion of `theorem8_2_branch_maximalAngle_lt_unbounded_source_{complex,real}`. | claimed_exact |
...
**FOUR PRODUCTION-SOURCE DEFECTS REMAIN AND MUST BE FIXED -- documentation, not mathematics, but this is EXACTLY the defect class that downgraded this row on 2026-08-07.**  (i) `Section8SourceTheorem82.lean` L328-352, heading "## Why the residual alternative is not here", states the constant-4 obstruction as unresolvable -- the resolving theorem is 108 lines below it IN THE SAME FILE (L460).  (ii) `Section8SourceSurface.lean` L166-172 calls the directed UI-norm residual "the one remaining substantive axis" and says no route reaches constant 2.  Stale.  (iii) `Section8SourceTheorem82.lean` L57-90 says "Under the cardinal reading the printed conclusion is FALSE, and the counterexample satisfies EVERY printed hypothesis".  IT DOES NOT: `P = span{e1,e2,...} x 0`, `Q = E x 0` gives `dim(P inf Qperp) = 0` but `dim(Pperp inf Q) = 1`, violating standing (3.5).  Flagged as audit disagreement 19 on 2026-08-09 and never fixed; now also refuted by `maximalAngle_lt_pi_div_four_of_crossedDefects`.  The same prose is mirrored in `dev/section8-source-theorems-2026-08-07.md` L100-103.  (iv) MISSING SOURCE-FACING ALIASES: the complex directed residual UI-norm endpoints are reachable only under `DavisKahan.Experimental.Frontier.Section8`; the real one is aliased but the complex one is not.  One-line `alias` each.

ALSO DISCHARGED: `dev/davis-kahan-1970-final-audit-2026-08-09.md` items 20 and 21 against this row.  Item 19 is NOT.
...
WHAT SURVIVES, ON BETTER GROUNDS: the finite form of (1.5) is still the right reading, but now by the Remark's POSITIVE justification -- `Since we are assuming (1.5), (3.5) will hold automatically if either dim P.H or dim Ptilde.H is finite` -- i.e. the finite form is exactly the regime where the standing (3.5) is free.  Whether the printed conclusion holds under the cardinal form TOGETHER WITH (3.5) is NOT settled and must not be asserted either way.  The paper's configuration is no longer documented-only: it is machine-checked as `Section3.directedGap_asymmetric_coordinateHalfSpace` with `coordinateHalfSpace_dimensions_agree` and `not_crossedDefectsEquivalent_coordinateHalfSpace` (`DavisKahan/Frontier/Section3BilateralShift.lean`).
...
SOURCE-FACING UNBOUNDED FAÇADES, 2026-09-06.  The retained double-angle estimates were still canonical at BOUNDED operator scope (`A K : H ->L[k] H`) while the acute conclusion was canonical at the inherited unbounded scope -- a visible signature mismatch.  Four façades now state Theorem 8.2 as the source states it, one theorem per alternative and scalar field concluding BOTH the retained estimate and `Theta < pi/4`, with `A` a possibly unbounded self-adjoint partial map: `theorem8_2_{perturbation,residual}_sourceExact_unbounded_{complex,real}`.  No new mathematics: the retained estimates are the Section 2 unbounded endpoints, with the printed spectral placement converted to the `FormBoundedSylvesterGap` they take by `intervalExterior`.  The bounded declarations are retained as registered specializations.
...
- {'kind': 'audit_atomization', 'detail': 'A single `.whole` clause covers two alternative half-gap hypotheses, branch selection, homotopy, perturbation and residual forms, unequal-dimensional extension, and the source statement that no analogous tan(2 Theta) extension is known. These need atomic evidence/dispositions.'}

### `DK-9-model` — Fourth-derivative Rayleigh–Ritz model

**importance:** `technical`  **section:** 9  **source:** Section 9, problem setup  **kind:** numerical_model  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** The free-beam fourth derivative on L2(0,1), perturbed by multiplication by epsilon t, with the two-dimensional linear trial eigenspace.

**Scope gap.** **AXIS (3) OF THE OLD THREE -- THE POSITIVE SPECTRUM -- IS CLOSED, 2026-08-10 (Claude Opus 5, coordinator-verified).**  `exists_five_hundred_lt_mem_realSpectrum_beamOperator` supplies an actual spectral point above 500; `beamFiniteDataCertificate` now takes only `(eps) (0 < eps) (eps < 100)` and its former `alpha in realSpectrum` and `alpha != 0` HYPOTHESES ARE GONE, so that result is UNCONDITIONAL.  Nothing was assumed: the spectral point is CONSTRUCTED.

**TWO AXES REMAIN, AND NEITHER IS DEFERRED.**

**(A) FORM VERSUS CLOSURE.**  No theorem equates `beamOperator` with the closure of the classical `(d/dt)^4` on the four free-end boundary-condition domain; the boundary conditions are DERIVED for eigenfunctions from the vanishing boundary form, which is weaker than identifying the operator domain.

**(B) REAL `L^2(0,1)`: MEASURED 2026-08-10, ROUTE (b) CHOSEN, AND THE PREREQUISITES ARE NOW DONE.**  The campaign owner directed that this axis is NOT to be deferred; it was not.  The paper's space is REAL (transcription L2565); `BeamL2 := Lp C 2 unitIocMeasure`.

THE MEASUREMENT THAT DECIDED IT.  The ten abstract form-method modules under `DavisKahan/SpectralTheory/FormMethod/` (1953 lines: `BoundedGraphCompactness`, `BoundedInverseRealization`, `CoerciveFormResolvent`, `CompactGraphEmbedding`, `FormCompactness`, `GraphClosedness`, `MaximalDomainTransport`, `PositiveSurjectiveCriterion`, `ShiftedBeamRealization`, `TraceKernelModel`) contained ZERO `Complex.*` tokens -- every `C` was a scalar-field binder or an inner-product subscript -- and the ForTauCeti analytic layer was ~99% scalar-generic, with exactly ONE piece of genuinely complex mathematics in it (the Weierstrass re/im split).  Route (a) is STRICTLY LARGER, and larger than this row previously recorded: THE `Lp` ISOMETRY ALONE DOES NOT PRODUCE A REAL BEAM OPERATOR.  There is no complex-to-real descent anywhere in the tree -- `DavisKahan/SpectralTheory/Complexification/LinearPMapSpectralDescent.lean` is 60 lines with one theorem, `complexifySubmodule_realSpecRange`, whose `[InnerProductSpace R E]` binder means it runs real-to-complex.  Route (a) therefore needs THREE new things (the `Lp` isometry; a conjugation on `BeamL2` plus a proof that `beamOperator` commutes with it; and a genuinely new descent theorem for conjugation-invariant complex `LinearPMap`s) where route (b) needed a mechanical scalar substitution over a known file list.

**CORRECTION 2026-08-10, AND THE OVERSTATEMENT WAS THE COORDINATOR'S.**  The sentence above, and the commit message that carried it, said there is NO complex-to-real descent anywhere in this tree.  THAT IS FALSE.  Operator-level descent is extensive and load-bearing: `TauCeti.RealComplexification.realify` and `realPartOperator` with `complexify_realify` (`ForTauCeti/Analysis/InnerProductSpace/Complexification/Basic.lean:572, 522, 596`) and `complexify_realPartOperator` (`.../Complexification/FunctionalCalculus.lean:431`), all keyed on `conjugateOperator A = A`; and THIS REPOSITORY'S ENTIRE REAL CONTINUOUS FUNCTIONAL CALCULUS IS ITSELF A DESCENT CONSTRUCTION (`realCfcFun ha f := realPartOperator (complexifiedCfcHom ha f)`, `RealContinuousFunctionalCalculus.lean:180`), as are `realBoundedSpectralProjectionIicOfGap`, `realSpecProjection`, `hilbertSchmidtReal`, `directRotationR` and `sinAngleOperatorR`.  The claim was generalized from ONE file (`LinearPMapSpectralDescent.lean`, which does run real-to-complex) to the whole tree without checking.

WHAT IS ACTUALLY ABSENT IS NARROWER AND SHOULD BE QUOTED THIS WAY: **descent of an ISOMETRIC EQUIVALENCE.**  An arbitrary complex unitary between complexifications need not commute with the conjugations, so it does not descend; that is a different and much more specific statement than "no descent exists".  ROUTE (b) REMAINS THE RIGHT CHOICE -- it was chosen on the measurement that the abstract form method contains zero complex mathematics, which is independent of this and still stands -- but it was chosen partly for a reason that was overstated, and the record should say so.  No Bochner campaign was launched.

WHAT LANDED 2026-08-10 (coordinator-verified: build 9589 jobs unchanged and EXIT=0, six gates EXIT=0, three baselines flat, three ratchets unmoved, real instantiations elaborated in a probe run from OUTSIDE the source tree).  The ten `FormMethod` modules and `ForTauCeti/MeasureTheory/{IntervalWeakSecondDeriv,IntervalSecondPrimitiveDeriv,IntervalSecondPrimitiveCompact}.lean` are now `RCLike`-generic, generalized IN PLACE with NO declaration renamed, added or removed (`check_declaration_name_drift` EXIT=0).  Not one proof line changed in the abstract layer.  The single genuine repair was the Weierstrass approximation inside `TauCeti.ae_eq_zero_of_forall_integral_pow_eq_zero`, reworked from `Complex.norm_le_abs_re_add_abs_im` to `RCLike.re_add_im` together with `||(RCLike.I : k)|| <= 1` -- which degenerates CORRECTLY at `k = R`, where `I = 0`.

VERIFIED TO DELIVER THE REAL INSTANCE, not merely to typecheck: `TauCeti.secondPrimitiveCLM (k := R)`, `TauCeti.isCompactOperator_secondPrimitiveCLM (k := R)`, `TauCeti.eq_affine_add_secondPrimitive_of_forall_integral_bumpD2` applied at genuinely real `u w : R -> R`, and `...FreeBeam.Abstract.CoerciveFormData.associatedOperator_isSelfAdjoint` and `...FreeBeam.Analytic.ShiftedBeamFormData.beamOperator_isSelfAdjoint` at `(k := R)` all elaborate, all axiom-clean.  Also now real-usable: `TauCeti.ae_eq_zero_of_forall_integral_pow_eq_zero`, `TauCeti.hasDerivAt_secondPrimitive`, `TauCeti.hasDerivWithinAt_firstPrimitive_of_continuous`.

WHAT REMAINS ON (B).  ONLY THE CONCRETE BEAM LAYER is still pinned to `C`: `BeamFormSpace.lean` (662 lines), `BeamSpectrum.lean` (1050), `BeamSection9.lean` (2091) and `Sources/DavisKahan1970/Section9/FreeBeamFoundationAssembler.lean` (165), plus the consumers that move with the model type (`BeamTangent`, `BeamInPlaneAngle`, `BeamDoubleTangent`, `BeamEigenbasis`, `BeamWeinberger`).  `FreeBeamModeUniqueness.lean` has ZERO `C` -- the ODE classification is already real and needs nothing.  The prerequisites underneath the concrete layer are DONE, so what is left is a substitution over a known file list, not a research question.

A ROW CLAIM WAS TOO STRONGLY FRAMED.  This row said "the string `Lp R` does not occur in either package".  That is true of `DavisKahan/` and `ForTauCeti/`, but it framed real `Lp` as foreign to the dependency graph, which it is not: `Lp R` is in active use in the `external/TauCeti` build input (`TauCeti/Analysis/SpecialFunctions/Trigonometric/Chebyshev/{Measure,Span}.lean` and `Hermite/Function/MemLp.lean`).

**THE SEQUENCE RESIDUE IS SUBSTANTIALLY CLOSED, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9599 EXIT=0, six gates EXIT=0, baselines flat, all four ratchets flat after the `TOPICS` row and a `## Provenance` section, probe from outside the source tree).**  `BeamL2` IS INFINITE-DIMENSIONAL: `not_finiteDimensional_beamL2`, from the reusable criterion `TauCeti.not_finiteDimensional_lpTwo_of_pairwise_disjoint` and its unit-interval instance `TauCeti.not_finiteDimensional_lpTwo_unitIocMeasure` (both `RCLike`-generic, so the REAL instance is free -- coordinator-probed).

WHAT IS NOW PROVED ABOUT THE PRINTED SEQUENCE, stated exactly and not overstated: `beamOperator.realSpectrum` is UNBOUNDED ABOVE (`not_bddAbove_realSpectrum_beamOperator`), has INFINITELY MANY points above 500 (`infinite_five_hundred_lt_mem_realSpectrum_beamOperator`), and carries a STRICTLY INCREASING `f : N -> R` of spectral points all above 500 (`exists_strictMono_mem_realSpectrum_beamOperator`).  The positive POINT spectrum `beamEigenvalues` is unbounded above (`exists_lt_mem_beamEigenvalues`) AND finite below every bound (`finite_beamEigenvalues_inter_Iic`).  Unbounded plus locally finite IS the mathematical substance of `alpha_3 < alpha_4 < ... -> infinity`.

WHERE THE CHAIN STOPS, both gaps named and neither hidden.  (1) No monotone bijection `N ~=o beamEigenvalues` is constructed; Mathlib's enumeration API (`Nat.nth`, `Nat.Subtype.orderIsoOfNat`) covers subsets of `N` only, and there is no ready-made "unbounded + locally finite subset of `R` is order-isomorphic to `N`".  Given the two theorems above this is PURE ORDER THEORY with no analysis left.  (2) Local finiteness is proved for the POINT spectrum, not for `realSpectrum`; the missing bridge is "every nonzero real spectral point of `beamOperator` is an eigenvalue", which sits INSIDE the body of `realSpectrum_beamOperator_subset` (`BeamSpectrum.lean:892`, the `hasEigenvalue_or_mem_resolventSet` branch) but is not its statement.  Extracting it restructures ~90 lines of Fredholm assembly; it is not new mathematics.

**THREE ERRORS IN THIS ROW'S OWN RECORD OF THE ROUTE, all found by executing it.**  (i) "THE SINGLE MISSING INPUT is that `BeamL2` is INFINITE-DIMENSIONAL" -- THERE WERE TWO.  Mathlib has NOTHING about how many eigenvalues of a compact operator lie outside a disc (checked across `Mathlib/Analysis/Normed/Operator/Compact/*` and `InnerProductSpace/Spectrum.lean`); `TauCeti.finite_setOf_hasEigenvalue_le_norm` had to be proved from scratch, via `c`-separated images inside a totally bounded set.  (ii) THE RECORDED ROUTE REACHES ONLY "INFINITELY MANY", NOT "UNBOUNDED": "finitely many eigenspaces would exhaust the space" yields an infinite eigenvalue SET, and infinitely many distinct reals above 500 is entirely compatible with all of them lying below 501.  The bullet silently read "infinitely many" as "unbounded"; the conclusion survives only THROUGH the accumulation theorem in (i), which this row did not record.  (iii) The suggested `contToLp p != 0` route is not supported as implied: the moments are fine (`integral_unitIocMeasure_pow` gives every monomial moment), but the POSITIVITY step `integral |p|^2 > 0` is positive-definiteness of the Hilbert matrix, and no "continuous and a.e. zero implies zero" lemma for `unitIocMeasure` exists anywhere.  Disjoint-interval indicators need neither -- and the repository ALREADY had indicator machinery for this measure (`TauCeti.cellIndicatorLp`, `partitionCell`) that the recorded route overlooked.

VERIFIED TRUE: `BeamL2` infinite-dimensionality was indeed nowhere in the repository and not used from Mathlib.

RESIDUE OF THE CLOSED AXIS: the printed `alpha_3 < alpha_4 < ...` SEQUENCE.  The single missing input is that `BeamL2` is INFINITE-DIMENSIONAL -- MEASURED to be nowhere in the repository and not used from Mathlib.  With it the rest is short: eigenspaces for nonzero eigenvalues are finite-dimensional, so finitely many would make the supremum of eigenspaces finite-dimensional, closed, and by the spectral theorem all of `BeamL2`; and compact-operator eigenvalues accumulate only at zero, so the inverted values are unbounded.  Natural route: `contToLp p != 0` for a nonzero polynomial (finitely many roots, so nonzero a.e. on `(0,1]`), which the existing `contToLp`/moment layer supports.

**THE SEQUENCE RESIDUE IS FULLY CLOSED, 2026-08-10 (Claude Opus 5, coordinator-verified: build 9600 EXIT=0, six gates EXIT=0, baselines flat, probe EXIT=0 with no `sorryAx`).**  Both gaps recorded hours earlier are discharged.  `exists_strictMono_range_eq_beamEigenvalues` gives `f : N -> R` STRICTLY MONOTONE with `Set.range f = beamEigenvalues` and every `f n > 500` in the real spectrum; `nonempty_orderIso_nat_beamEigenvalues` gives the order isomorphism.  `realSpectrum_beamOperator_eq_insert_zero` proves the real spectrum is EXACTLY `{0} union beamEigenvalues`, and `finite_realSpectrum_beamOperator_inter_Iic` lifts local finiteness from the point spectrum to `realSpectrum` itself.  Nothing about the printed `alpha_3 < alpha_4 < ...` is left unproved.

**BOTH OF THE COORDINATOR'S DIFFICULTY ESTIMATES WERE WRONG, IN THE SAME DIRECTION.**  (i) "Mathlib has no enumeration of an unbounded locally finite subset of `R`" -- Mathlib HAS `orderIsoNatOfLinearSuccPredArch` (`Mathlib/Order/SuccPred/LinearLocallyFinite.lean:380`) plus `LocallyFiniteOrder.ofFiniteIcc` and `LinearLocallyFiniteOrder.succOrder`/`predOrder`, with `IsSuccArchimedean` free as an instance.  No recursion had to be written; the whole thing is instance plumbing on the subtype and elaborated first try.  The narrow claim that SURVIVES is that Mathlib has no SET-LEVEL statement in these hypotheses, which is what the new general module supplies.  (ii) "Extracting the eigenvector bridge restructures ~90 lines of Fredholm assembly" -- THE ASSEMBLY WAS REUSED VERBATIM, UNTOUCHED.  What changed is 12 lines of front matter and the DELETION of 28 lines of bookkeeping the new formulation makes unnecessary; `BeamSpectrum.lean`'s proof got SHORTER.  The "stop and report" contingency never triggered.  Also: the bridge is stronger than recorded -- `0` is an eigenvalue too, which is what gives the EXACT equality rather than a containment.

A COORDINATOR PROCESS PREMISE WAS ALSO INCOMPLETE: a `## Provenance` section alone does NOT hold readiness for a new `ForTauCeti` module.  `check_tauceti_readiness` skips the provenance check entirely for any module no `TOPICS` entry claims and counts it `UNPLACED` regardless, so the `TOPICS` row in `check_tauceti_roadmap_topics.py` is required as well -- BOTH halves, every time.

**ADJUDICATED 2026-08-10 (subagent, coordinator-verified by direct file read).  BOTH RECORDED AXES ARE DISCHARGED; THE BLOCKER COMES OFF; ONE NEW, SMALLER GAP IS RECORDED IN THEIR PLACE.**

THE BLOCKER `real-scalar-infinite-dimensional-scope` IS REMOVED FROM THIS ROW.  `RealBeamL2` unfolds to `Lp R 2 unitIocMeasure` and `...FreeBeam.Model.Real.not_finiteDimensional_beamL2 : not (FiniteDimensional R BeamL2)` is proved, so both halves of that blocker -- real scalars and infinite dimension -- are met.  The blocker's own M34 paragraph reasoned that this row must KEEP it because `Lp C 2 mu` is not presented as `RealComplexification (Lp R 2 mu)`; that reasoning is now obsolete, because route (b) (native real substitution) was taken and finished instead of the complexification route the paragraph assumed.

AXIS (A) IS THE PAPER'S BOUNDARY CONDITIONS, NOT A SUBSTITUTE.  `ClassicalFreeBeamRepresentative` (`DavisKahan/SpectralTheory/FormMethod/BeamClassicalReal.lean:323`) carries `u0..u4` with `HasDerivWithinAt` chains on `Set.Icc 0 1` and the four fields `second_left : u2 0 = 0`, `third_left : u3 0 = 0`, `second_right : u2 1 = 0`, `third_right : u3 1 = 0` -- literally `u''(0)=u'''(0)=u''(1)=u'''(1)=0`.  Coordinator-verified by reading the structure.  NOTE, so this is never re-litigated as a defect: the Lean core is NARROWER than the printed domain (it also demands `u4` continuous, i.e. C^4 up to the boundary), which makes `closure classicalFreeBeamGraph = beamOperator.toLinearPMap.graph` a STRONGER statement, proved from a smaller core.
...
i.e. equality rather than a subset.  THIS IS NO LONGER RESEARCH.  The ODE half is already proved in BOTH directions -- `Section9/FreeBeamCharacteristicConverse.lean:129` `...FreeBeam.Classical.exists_nontrivial_freeBoundary_of_characteristic` and `characteristic_iff_exists_nontrivial_freeBoundary` produce a nontrivial `FreeBoundary beta a b a b`, and `FreeBoundary` is the four traces of `mode beta a b c d = a cos(beta x) + b sin(beta x) + c cosh(beta x) + d sinh(beta x)`.  The only missing link is that this smooth `mode` gives a `ClassicalFreeBeamRepresentative (contToLp (mode ...)) (beta^4 . contToLp (mode ...))`, after which `classicalFreeBeamGraph_subset_graph` (`BeamClassicalReal.lean:887`) lands it in the graph.  That machinery did not exist before `2981de34` and does now.
...
- `TauCeti.DavisKahan.FreeBeam.Model.beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.beamOperator_isSelfAdjoint`
- `TauCeti.DavisKahan.FreeBeam.Model.realSpectrum_beamOperator_subset_gap`
- `TauCeti.DavisKahan.FreeBeam.Model.realSpectrum_beamOperator_subset_sharp`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTrial_orthonormal`
- `TauCeti.DavisKahan.FreeBeam.Model.inner_centeredAffineLp`
- `TauCeti.DavisKahan.FreeBeam.Model.inner_centeredAffineLp_mul`
- `TauCeti.DavisKahan.FreeBeam.Model.inner_mul_centeredAffineLp_mul`
- `TauCeti.DavisKahan.FreeBeam.Model.beamRitz_matrix`
- `TauCeti.DavisKahan.FreeBeam.Model.beamResidualGram_matrix`
- `TauCeti.DavisKahan.FreeBeam.Model.beamFiniteDataCertificate`
- `TauCeti.DavisKahan1970.Section9.CenteredAffine`
- `TauCeti.DavisKahan1970.Section9.ritz_matrix_from_affine_moments`
- `TauCeti.DavisKahan1970.Section9.FreeBeamFiniteDataCertificate`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_pos_eigenpair_beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_five_hundred_lt_mem_realSpectrum_beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_mem_realSpectrum_beamOperator_ne_zero`
- `TauCeti.DavisKahan.FreeBeam.Model.beamQuadLp`
- `TauCeti.DavisKahan.FreeBeam.Model.inner_affineLp_beamQuadLp`
- `TauCeti.DavisKahan.FreeBeam.Model.beamQuadLp_mem_beamTrial_orthogonal`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamQuadLp_sq`
- `TauCeti.DavisKahan.FreeBeam.Model.beamQuadLp_ne_zero`
- `TauCeti.DavisKahan.FreeBeam.Model.eigenspace_beamResolvent_one_le_beamTrial`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_beamOperator_apply_of_beamResolvent_smul`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_affine_of_beamResolvent_eq_self`
- `TauCeti.LinearPMap.mem_realSpectrum_of_eigenvector`
- `TauCeti.exists_hasEigenvalue_eigenspace_not_le`
- `TauCeti.DavisKahan.FreeBeam.Model.not_finiteDimensional_beamL2`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_pos_eigenpair_beamOperator_gt`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_lt_five_hundred_lt_mem_realSpectrum_beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.not_bddAbove_realSpectrum_beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.beamEigenvalues`
- `TauCeti.DavisKahan.FreeBeam.Model.finite_beamEigenvalues_inter_Iic`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_lt_mem_beamEigenvalues`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_strictMono_mem_realSpectrum_beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.infinite_five_hundred_lt_mem_realSpectrum_beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.beamResolvent_apply_of_beamOperator_eigen`
- `TauCeti.DavisKahan.FreeBeam.Model.eigenspace_beamResolvent_zero_eq_bot`
- `TauCeti.not_finiteDimensional_lpTwo_unitIocMeasure`
- `TauCeti.not_finiteDimensional_lpTwo_of_pairwise_disjoint`
- `TauCeti.finite_setOf_hasEigenvalue_le_norm`
- `TauCeti.exists_hasEigenvalue_norm_lt`
- `TauCeti.exists_isLeast_of_finite_inter_Iic`
...
- `TauCeti.DavisKahan.FreeBeam.Model.nonneg_of_beamOperator_eigen`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_eigenvector_of_mem_realSpectrum_beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.zero_mem_realSpectrum_beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.realSpectrum_beamOperator_eq_insert_zero`
...
- `TauCeti.DavisKahan.FreeBeam.Model.Real.BeamL2`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.beamOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.ClassicalFreeBeamRepresentative`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.classicalFreeBeamGraph`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.beamOperator_is_closure_of_classical_freeBeam_fourthDerivative`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.closure_classicalFreeBeamGraph_eq_graph`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.classicalFreeBeamGraph_subset_graph`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.exists_characteristic_of_eigen`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.realSpectrum_beamOperator_subset`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.beamEigenvalues`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.exists_strictMono_range_eq_beamEigenvalues`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.five_hundred_lt_of_mem_beamEigenvalues`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.not_finiteDimensional_beamL2`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.beamFiniteDataCertificate`
- `TauCeti.DavisKahan.FreeBeam.Model.Real.beamTrial_le_domain`
...
A COORDINATOR PREMISE WAS WRONG: the brief said the compact-resolvent theorem `belongs in the form-method / self-adjoint spectral theory layer of ForTauCeti`.  THERE IS NO FORM-METHOD LAYER IN `ForTauCeti` -- `CoerciveFormData`, `ShiftedBeamFormData`, `SequentiallyCompactEmbedding` and `inversePartialMap` all live in `DavisKahan/SpectralTheory/FormMethod/`.  (Inherited from handoff H.1, which says the same.)  What WAS missing was only the EXISTENCE half of the compact spectral theorem, now `TauCeti.exists_hasEigenvalue_eigenspace_not_le`, plus the missing INTRODUCTION rule `TauCeti.LinearPMap.mem_realSpectrum_of_eigenvector`; the beam-specific compact resolvent already existed and was not rebuilt.
...
**BOTH REMAINING AXES APPEAR CLOSED, 2026-08-10 (owner's commits `2981de34`/`f26d9372`; coordinator-validated after rebase: build **9611 jobs** EXIT=0, zero errors, six gates EXIT=0, all four ratchets flat, probe `sorryAx` count ZERO).**  ~3,300 lines of real beam material entered the DEFAULT BUILD for the first time in this commit, so this is the first run in which any of it is gate-checked.
...
**RE-AUDITED FROM THE CURRENT CODE 2026-08-29 (Claude Opus 5).  `partial_or_wrapper_missing` -> `compiled_exact`.**
...
- `TauCeti.DavisKahan1970.Section9.initial_residual_gram_from_affine_moments`
- `TauCeti.DavisKahan1970.Section9.residualGram_eigenvalueHigh_charAt`
- `TauCeti.DavisKahan1970.Section9.equation_9_1`
- `TauCeti.DavisKahan1970.Section9.equation_9_4`
- `TauCeti.DavisKahan.FreeBeam.Model.beamSinTheta_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamSinTwoTheta_lt`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamPerturbation_comp_trialIncl_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamSpecProjection_lowSet_eq_singleton`
- `TauCeti.DavisKahan.FreeBeam.Model.beamSinTwoThetaSum_lt`
- `TauCeti.DavisKahan.FreeBeam.Model.beamKyFanTwo_gaugeReal_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTrialVec_span_eq_top`
- `TauCeti.DavisKahan.FreeBeam.Model.exists_beamTrialVec_repr`
- `TauCeti.DavisKahan.FreeBeam.Model.beamResidual_gram`
- `TauCeti.DavisKahan.FreeBeam.Model.beamGram_orthogonal_direction`
- `TauCeti.DavisKahan.FreeBeam.Model.beamResidualRankOne_rank_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamResidual_sub_rankOne_apply`
- `TauCeti.DavisKahan.FreeBeam.Model.beamResidual_orthogonal_norm_sq`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamResidual_sub_rankOne_le`
- `TauCeti.DavisKahan.FreeBeam.Model.approximationSingularValue_one_beamResidual_le`
- `TauCeti.DavisKahan.FreeBeam.Model.kyFanTwo_beamResidual_le`
...
**Scope gap.** (9.5), both sentences of (9.6) and the bound-norm sentence of (9.7) are derived from the genuine perturbed beam, with no certificate field in any statement.  The 2-norm sentence of (9.7) -- `tan 2theta_1 + tan 2theta_2` -- has no statement at all, because the unbounded residual-form tan(2 Theta) theorem is proved only at the operator norm.

**PROMOTED TO `compiled_exact` 2026-08-11.**  `beamTanTwoThetaSum_lt_printed` gives the paper's 2-norm sentence of (9.7) -- `tan 2theta_1 + tan 2theta_2` bounded by the printed decimal `(1291/1250000 * eps) / (1 - 7887/5000000 * eps)` -- as `kyFanApproximationGauge 2` of the directed tangent corner, for every `0 < eps < 100`.

**THIS ROW'S OWN `three lines' ESTIMATE WAS FALSE, AND SO WAS THE COORDINATOR'S REPETITION OF IT.**  The unbounded endpoint had ZERO consumers repo-wide, and its hypothesis `hS1 : ||U.offDiagonalPart Z|| < 1` had **NO PRODUCER ANYWHERE** -- only the pointwise bound on `U` existed.  Supplying it was the bulk of the work: new general lemmas `crossBlockBound_lt_one`, `norm_offDiagonalPart_le_of_tendsto` and `norm_offDiagonalPart_lt_one_of_tendsto` in `ForTauCeti/.../DoubleAngle/UnboundedPole.lean`, resting on `S` being self-adjoint and exchanging `U` and `U^perp`, so its `U^perp` block is the adjoint of its `U` block, the two land orthogonally and assemble by Pythagoras.  `2 beta < sqrt(delta^2 + 4 beta^2)` needs only `delta > 0` -- NO smallness in `||B||`.

THE INSTANCE IS A NEW MODULE `Section9/BeamDoubleTangentKyFan.lean` and could NOT live in `BeamDoubleTangent.lean`: that is a generic-foundation module, and importing the source facade there raised `check_dependency_layers` from 13 to 14.

**THE COORDINATOR'S ROUTE NOTE WAS RIGHT AND THE REASON IS WORTH KEEPING.**  The residual must be charged to the CORNER: the ambient `B = Rhat (+) Rhat*` carries both blocks, so nothing kills its second approximation number, and `kyFanApproximationGauge_reflectionResidualCorner_le` bounds corner <= ambient -- the WRONG direction for reaching the printed constant.  The `_ambient` endpoint does not serve here.  `reflectionResidualCorner_beamRitzOffDiagonal` proves the directed corner IS the Rayleigh-Ritz residual, and the rank-one recentered Gram does the rest.

**Lean declarations:**

- `TauCeti.DavisKahan1970.Section9.recentered_residual_gram_from_affine_moments`
...
- `TauCeti.DavisKahan.FreeBeam.Model.beamResidual_inner_trial`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamRitzResidual_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamRitz_form_le`
- `TauCeti.DavisKahan1970.Section9.equation_9_5_high`
- `TauCeti.DavisKahan.FreeBeam.Model.beamPerturbed_specProjection_Ioo_eq_zero`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanTheta_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanTheta_lt_printed`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamRitzResidual_sq_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamRitzResidual_vecOne_add_vecTwo_eq_zero`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTrialBlock_residual_vecOne_add_vecTwo`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTrialBlock_residual_vecTwo`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTrialBlock_residual_rank_le`
- `TauCeti.DavisKahan.FreeBeam.Model.approximationSingularValue_one_beamTrialBlock_residual_le`
- `TauCeti.DavisKahan.FreeBeam.Model.kyFanTwo_beamTrialBlock_residual_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanThetaSum_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanThetaSum_lt_printed`
- `TauCeti.DavisKahan.FreeBeam.Model.beamComparison_reduces`
- `TauCeti.DavisKahan.FreeBeam.Model.beamRitzOffDiagonal_isOddFor`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamRitzOffDiagonal_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamComparison_form_le_of_mem_beamTrial`
- `TauCeti.DavisKahan.FreeBeam.Model.beamComparison_form_ge_of_mem_orthogonal`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowReflection_comm`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanTwoTheta_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanTwoTheta_lt_printed`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanTwoThetaSum`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanTwoThetaSum_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanTwoThetaSum_lt_printed`

**Notes.** The Ritz compression, rank-one recentered residual, singular-value scalars, exact tangent envelopes, and decimal corollaries are present as a candidate. The unbounded tan-theta and tan-two-theta instantiations remain to be connected.
...
WHAT REMAINS IS EXACTLY PART (b), and nothing else: assemble `BoundedCompressionTrialBlock (beamPerturbed eps) beamTrial` from these (its `operator` is the compression and its `operator_apply`/`residual_apply` fields are the projection identities, with `A.toLinearMap` on the trial reducing to `beamPerturbation eps` by `beamOperator_apply_trial`), and prove `specProjection (beamPerturbed eps) (Ioo (ritzHigh eps) 500) = 0`.
...
FOR THIS ROW SPECIFICALLY: the one remaining item is exactly the conclusion shape of `mem_and_gauge_le_of_doubleAngleEigenbasis` at an arbitrary `KyFanDominantIdealFamily`.  It still needs `IsDoubleAngleEigenbasis` discharged.
...
FOR THIS ROW: still open -- it needs the UNCONDITIONAL UI-norm endpoint.  A REAL LEAD, though: the beam's trial subspace is concrete and finite-dimensional, so `IsCompressedDoubleAngleEigenbasis` may be dischargeable THERE directly, without the general construction.
...
FOR THIS ROW: does not close, and it is now the CLOSEST of the three.  `mem_and_gauge_le_of_invariantDoubleAngleFiltration` is its remaining item modulo the filtration, and for the BEAM the `A`-invariant subspaces are genuinely available (the beam operator has an orthonormal eigenbasis), so the eigen-part is discharged by construction.  The only genuinely new work is the prefix-realisation clause against the beam's compression spectrum.

**A CLAIM ON THIS ROW WAS ALREADY STALE:** its summary says the arbitrary-UI-ideal unbounded residual `tan 2Theta` endpoint "is not proved anywhere in the repository".  `mem_and_gauge_le_of_compressedDoubleAngleEigenbasis` landed in `4dc3ddad` and proves it under the compressed hypothesis.
...
**importance:** `technical`  **section:** 9  **source:** Equation (9.8)  **kind:** comparison_claim  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Derive lower-eigenvalue estimates from a 3x3 comparison matrix and compare individual-vector angle bounds.

**Lean declarations:**

- `TauCeti.DavisKahan1970.Section9.ArrowheadThreeByThree`
...
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanPhi_low_lt_printed`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanPhi_high_lt_printed`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanPhi_low_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTanPhi_high_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beamColumn_tangent_le`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamColumnResidual_low`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamColumnResidual_high`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_equation_9_8_lower`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_equation_9_8_upper`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_equation_9_8`
- `TauCeti.DavisKahan1970.Section9.weinberger_sine_sq_le_of_coupled_energy`
- `TauCeti.DavisKahan1970.Section9.secondScalarLowerBound_angleBound_counterexample`

**Notes.** The exact arrowhead characteristic polynomial and the algebraic conversion of Weinberger sine-square bounds to tangent bounds are represented. The historical lower-root theorem is deliberately an explicit certificate rather than an informal O(epsilon^4) assertion.
...
### `DK-9-infinite-residual-counterexample` — Residual-infinite limitation example

**importance:** `supporting`  **section:** 9  **source:** Section 9, l2 example after (9.8)  **kind:** example  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** An l2 trial vector has a useful Rayleigh quotient but lies outside the perturbed operator domain, so residual-based theorems do not apply while lower-bound methods still do.

**Lean declarations:**

- `TauCeti.DavisKahan1970.Section9.cos_angle_geometricTrial`
- `TauCeti.DavisKahan1970.Section9.dense_diagonalDomain`
- `TauCeti.DavisKahan1970.Section9.diagonalOperator`
- `TauCeti.DavisKahan1970.Section9.diagonalOperator_domain`
- `TauCeti.DavisKahan1970.Section9.diagonalOperator_firstEigenvector`
- `TauCeti.DavisKahan1970.Section9.diagonalOperator_isSelfAdjoint`
- `TauCeti.DavisKahan1970.Section9.diagonalOperator_isSymmetric`
- `TauCeti.DavisKahan1970.Section9.exists_truncatedTrial_mem_domain_and_dist_lt`
- `TauCeti.DavisKahan1970.Section9.firstEigenvector`
- `TauCeti.DavisKahan1970.Section9.firstEigenvector_apply`
- `TauCeti.DavisKahan1970.Section9.firstEigenvector_def`
- `TauCeti.DavisKahan1970.Section9.firstEigenvector_mem_diagonalDomain`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_form_summable`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_hasSum_form`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_hasSum_normalizedForm`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_hasSum_normalizedFormTail`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_hasSum_sq`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_norm_sq`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_normalizedForm_apply`
...
- `TauCeti.DavisKahan1970.Section9.geometricTrial_rayleighQuotient`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_weinberger_best_sin_le`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_weinberger_best_sin_sq_le`
- `TauCeti.DavisKahan1970.Section9.geometricTrial_weinberger_sin_sq_le`
- `TauCeti.DavisKahan1970.Section9.inner_geometricTrial_firstEigenvector`
- `TauCeti.DavisKahan1970.Section9.norm_firstEigenvector`
- `TauCeti.DavisKahan1970.Section9.geometricDiagonalImage_eq_one`
- `TauCeti.DavisKahan1970.Section9.geometricDiagonalImage_partial_energy`
- `TauCeti.DavisKahan1970.Section9.sin_angle_geometricTrial`
- `TauCeti.DavisKahan1970.Section9.tendsto_norm_truncatedTrial_sub_geometricTrial`
...
- `TauCeti.DavisKahan1970.Section9.truncatedTrial_sub_geometricTrial_apply`
- `TauCeti.DavisKahan1970.Section9.truncatedTrial_sub_geometricTrial_hasSum_sq`
- `TauCeti.LinearPMap.adjoint_domain_le_lpDiagonal_domain`
- `TauCeti.LinearPMap.dense_lpDiagonal_domain`
- `TauCeti.LinearPMap.lpDiagonal`
- `TauCeti.LinearPMap.lpDiagonalDomain`
- `TauCeti.LinearPMap.lpDiagonal_apply`
- `TauCeti.LinearPMap.lpDiagonal_domain`
- `TauCeti.LinearPMap.lpDiagonal_isSelfAdjoint`
- `TauCeti.LinearPMap.lpDiagonal_isSymmetric`
- `TauCeti.LinearPMap.lpDiagonal_single`
- `TauCeti.LinearPMap.mem_lpDiagonalDomain_iff`
- `TauCeti.LinearPMap.single_mem_lpDiagonal_domain`

**Notes.** The pointwise constant image and divergent finite partial energies are formalized algebraically, together with an explicit finite-support truncation repair that agrees on arbitrary prescribed prefixes.
...
### `DK-9.9-9.11` — Individual eigenvector identification inside a cluster

**importance:** `technical`  **section:** 9  **source:** Equations (9.9)–(9.11) and final bounds  **kind:** numerical_claims  **status:** `compiled_exact`  **verification:** `proved_in_build`  **completion:** `mixed_disposition`

**Summary.** Reduce the full eigenproblem to a two-dimensional Schur complement, then combine tan(2 Theta) and tan Theta bounds to control each eigenvector angle omega_k.

**Lean declarations:**

- `TauCeti.DavisKahan1970.Section9.half_tanTwoPsi_ratio_lt_of_eigenvalue_upper`
...
- `TauCeti.DavisKahan1970.Section9.NumericalExampleCertificate`
- `TauCeti.DavisKahan1970.Section9.norm_lower_coordinate_le`
- `TauCeti.DavisKahan1970.Section9.schurCoefficient_nonneg`
- `TauCeti.DavisKahan1970.Section9.schurCoefficient_le`
- `TauCeti.DavisKahan1970.Section9.lower_coordinate_eq_zero_of_residual_eq_zero`
- `TauCeti.DavisKahan1970.Section9.individual_angle_le_exact_envelope_of_tangents`
- `TauCeti.DavisKahan1970.Section9.individual_angle_le_exact_envelope_of_subspace`
- `TauCeti.DavisKahan.FreeBeam.Model.rank_beamLowFiveHundred_le`
- `TauCeti.DavisKahan.FreeBeam.Model.finiteDimensional_beamLowFiveHundred`
- `TauCeti.DavisKahan.FreeBeam.Model.finrank_beamLowFiveHundred`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowFiveHundred_eq_specRange_ritzHigh`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowOperator`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowOperator_isSymmetric`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowEigenbasis`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowEigenvector`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowEigenvalue`
- `TauCeti.DavisKahan.FreeBeam.Model.beamPerturbed_apply_beamLowEigenvector`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowEigenvector_orthonormal`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowEigenvalue_lt_five_hundred`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_lower_block_equation`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_lower_block_form_ge`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_norm_residual_column_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_norm_orthogonal_part_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_starProjection_ne_zero`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_tan_eta_le`
- `TauCeti.DavisKahan1970.Section9.arccos_ratio_lt_pi_div_four`
- `TauCeti.DavisKahan1970.Section9.half_tan_two_arccos_ratio`
- `TauCeti.DavisKahan.FreeBeam.Model.beamRitzColumnMap`
- `TauCeti.DavisKahan.FreeBeam.Model.beamRitzColumnMap_vecTwo`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamRitzColumnMap_vecOne_sq_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_ritz_compression_vecOne`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_ritz_compression_vecTwo`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_ritz_coordinate_identity`
- `TauCeti.DavisKahan.FreeBeam.Model.beamTrial_starProjection_eq`
- `TauCeti.DavisKahan.FreeBeam.Model.norm_beamTrial_starProjection_sq`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_residual_at_starProjection`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_angle_of_ritz_coordinates`
- `TauCeti.DavisKahan.FreeBeam.Model.two_coordinate_schur_identity`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_ritz_scalar_data`
- `TauCeti.DavisKahan.FreeBeam.Model.inplane_ratio_bound`
- `TauCeti.DavisKahan.FreeBeam.Model.schur_gap_bound_of_sum_nonneg`
- `TauCeti.DavisKahan.FreeBeam.Model.schur_gap_bound_of_sum_nonpos`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_individual_angle_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_individual_angle_le_printed`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowEigenvector_individual_angle_le`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_eigenvalue_le_ritzHigh`
- `TauCeti.DavisKahan.FreeBeam.Model.beam_individual_envelope_lt_pi_div_four`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowEigenvector_not_both_near`
- `TauCeti.DavisKahan.FreeBeam.Model.beamLowEigenvector_ritz_pairing`

**Notes.** Equation (9.9) is represented as an explicit block linear map, and equations (9.10)-(9.11) by a generic Schur reduction. The rank-one correction is decomposed into its shifted diagonal and off-diagonal parts, with the exact sqrt(3)/30 coefficient. The final scalar combination producing sqrt(7)/10 and the printed bounds is present. The operator-order resolvent sandwich and actual angle identifications remain certificate fields.
...
Section 9 compiles, but every source conclusion is stated relative to `FreeBeamFiniteDataCertificate` (Section9/ExactData.lean) or `TheoremOutputCertificate` (Section9/ExampleCertificateSurface.lean), and no value of either type is ever constructed.
...
**Next action.** Hostile re-audit reopened this row. The numerical/Schur-complement conclusions appear formalized, but the block ends with a source assertion that the 3x3 comparison angle is the best possible bound obtainable from the stated data while explicitly deferring its proof to unresolved Question 10.2. Record that assertion separately as source-asserted/unproved rather than counting the entire block as exact.

**Blocked by:** `hostile-mixed-disposition`

**Completion holes:**

- {'kind': 'mixed_disposition', 'detail': 'The numerical/Schur-complement conclusions appear formalized, but the block ends with a source assertion that the 3x3 comparison angle is the best possible bound obtainable from the stated data while explicitly deferring its proof to unresolved Question 10.2. Record that assertion separately as source-asserted/unproved rather than counting the entire block as exact.'}

### `DK-10.1` — Sine bounds under arbitrary pairwise spectral distance

**importance:** `technical`  **section:** 10  **source:** Question 10.1  **kind:** open_question  **status:** `resolved_by_modern_development`  **verification:** `proved_in_build`  **completion:** `not_applicable`

**Summary.** Ask for the best UI-norm sine-angle estimate when the two relevant spectra are only known to be at distance delta.
...
* RESOLVED, under the weak hypothesis Question 10.1 actually asks about (the two spectra
  ...
  concludes `frameLowerBound * ContinuousLinearMap.hilbertSchmidtNorm (canonicalSinTheta) <= ...`, over
  `hilbertSchmidt_sylvester_le_of_pairwiseSpectrumGap_direct`; the real-scalar form is
  `RealTheorem62Data.result_across`.
...
**Next action.** Retain as a source open-question record. It is not theorem proof debt; do not use it to hide established mathematical clauses from mixed neighboring/source blocks.

### `DK-10.2` — Three-way subspace decompositions

**importance:** `technical`  **section:** 10  **source:** Question 10.2  **kind:** open_question  **status:** `not_a_completion_obligation`  **verification:** `not_applicable`  **completion:** `not_applicable`

**Summary.** Seek perturbation estimates for two decompositions into three reducing subspaces using off-diagonal coordinate blocks.

**Notes.** This is explicitly an open research direction, not a theorem required to formalize the 1970 paper.

**Next action.** Retain as a source open-question record. It is not theorem proof debt; do not use it to hide established mathematical clauses from mixed neighboring/source blocks.

### `DK-10.3` — Joint eigenvalue–eigenvector bounds

**importance:** `technical`  **section:** 10  **source:** Question 10.3  **kind:** open_question  **status:** `not_a_completion_obligation`  **verification:** `not_applicable`  **completion:** `not_applicable`

**Summary.** Seek optimal estimates coupling changes in eigenvalues and eigenvectors.

**Notes.** Open research question.

**Next action.** Retain as a source open-question record. It is not theorem proof debt; do not use it to hide established mathematical clauses from mixed neighboring/source blocks.

### `DK-10.4` — Perturbation bounds for functional calculus

**importance:** `technical`  **section:** 10  **source:** Question 10.4, including ambient and directed functional-calculus specializations  **kind:** mixed_open_question  **status:** `not_a_completion_obligation`  **verification:** `proved_in_build`  **completion:** `accepted`

**Summary.** Mixed source block: established spectral-projection/step-function specializations and tan(2 Theta) bounds precede the genuinely open question asking for broader functional-calculus perturbation bounds.
...
**Notes.** Open research question; modern operator-Lipschitz theory is outside the paper-completion target.
