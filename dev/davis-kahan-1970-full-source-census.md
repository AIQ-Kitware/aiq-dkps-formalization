...
**Items:** 50  
**Unique cited Lean declarations:** 1176
...
**Next action.** REOPENED 2026-09-02 on hostile review under obligation `tan2theta-directed-correspondence`. The registered correspondence does not compose with the canonical directed primaries: they quantify over an arbitrary involution `Z`, and the real clause was given a complex-only witness. Close with source-shaped directed endpoints on the paper objects, `paperTanTwoDirectedCornerR U V` on the real side.
