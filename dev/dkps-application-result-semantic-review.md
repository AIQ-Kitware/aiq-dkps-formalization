...
| `acharyya-2024` | `A24-T2` | Theorem 2 | PASS | The passage from that definition to the sample-mean bound is the source's Appendix A.2 and is compiled separately, not threaded into one endpoint. |
...
| `acharyya-2025` | `A25-P1` | Proposition 1 | REFUTED printed statement; repair proved | The hypothesis constrains the ambient manifold; the conclusion constrains the placement of the models within it. |
