...
The augmented-CMDS geometry layer starts from a measurable high-probability family of
...
This remains a proved compatibility capstone.  The raw-response theorem layer in
`DkpsQuench2026.QueryEfficiency` shows how its remaining inputs disappear from the final
