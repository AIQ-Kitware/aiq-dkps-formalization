...
`DkpsQuench2026.Core.ProofEngine`.
...
spectral chain in `DkpsQuench2026.Geometry.AlignedCMDS`.
-/
import DkpsQuench2026.Core.ProofEngine
import Mathlib
...
`DkpsQuench2026.Geometry.AlignedCMDS.queryEfficient_nn_of_aligned_spectral`; for the variant
...
`DkpsQuench2026.Geometry.AlignedCMDS.queryEfficient_nn_of_aligned_spectral` (which discharges
