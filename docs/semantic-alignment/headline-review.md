...
**Compiler imports:** `DavisKahan.All`, `YuWangSamworth2015`, `ForTauCeti.Analysis.InnerProductSpace.AngleGeometry`, `ForTauCeti.Analysis.InnerProductSpace.Residual.Ritz`, `ForTauCeti.Analysis.OperatorIdeal.ApproximationNumber.Core`
