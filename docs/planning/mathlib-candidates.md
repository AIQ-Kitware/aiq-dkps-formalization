...
`Challenge/ApproximationNumbers/Leaderboard.lean`.
...
argmin modulus `exists_modulus_pairDist` (item F3).

Remaining non-trivial items are catalogued in Git history (RCLike
