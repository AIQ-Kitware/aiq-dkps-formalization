...
\paragraph{Role in the raw-response Quench theorem family.}
...
\paragraph{Role in the raw-response Quench theorem family.}
The completed theorem family replaces stagewise global spectral assumptions by a
...
closed in \code{DkpsQuench2026/Geometry/Covariance.lean}, and the sample-centered
quadratic identity is closed in \code{DkpsQuench2026/Geometry/CenteredCovariance.lean}.
The rectangular scatter/Gram eigenvalue transfers are closed in
\code{DkpsQuench2026/Spectral/GramSpectrum.lean} on top of the new proved
...
proved in \code{DkpsQuench2026/Spectral/Regularity.lean}.  The explicit response
...
paper-shaped and raw-response Quench interfaces. & Redundant hypothesis removed \\
\addlinespace
...
random reference sample from cached-response noise. & raw-response Quench uses a
...
bound and uses the qualitative regime $r=\omega(n^3)$. & raw-response Quench starts
...
\section{Raw-response Quench theorem family: completed state}

The \code{DkpsQuench2026} development is proof-complete.  Every proof
body in the directory is closed, including the finite, compact-infinite, and
all-proper-subset capstones:
\begin{itemize}
\item \code{DkpsQuench2026.QueryEfficiency.finiteFixedSubset};
\item \code{DkpsQuench2026.QueryEfficiency.infiniteFixedSubset};
\item \code{DkpsQuench2026.QueryEfficiency.finiteAllQueries};
\item \code{DkpsQuench2026.QueryEfficiency.infiniteAllQueries}.
\end{itemize}
