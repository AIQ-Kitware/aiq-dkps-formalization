...
proofs are recorded in \texttt{dev/external-lean-references.md} and
\texttt{vendor/lean/}.  This setup does not claim the rectangular spectral bridge is
proved, and it introduces no new paper-facing hypothesis; it fixes the intended
Mathlib contribution boundary and proof routes before the next proof wave.
