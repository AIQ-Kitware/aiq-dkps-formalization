...
def main():
    ...
    cases += block(
        ...
        'Repaired on 2026-09-06; selected for the four-page worked example.',
    ...
    header = [
        ...
        'The four-page paper currently uses **1 (Theorem 8.2 bounded/unbounded scope)** because the mismatch is visible directly in the operator types: the earlier witness makes the ambient operator bounded even though Section 8 inherits a possibly unbounded self-adjoint scope. Candidates **2**, **3**, **5**, and **6** remain useful alternatives for extra-hypothesis and scope failures.', '',
    ]
