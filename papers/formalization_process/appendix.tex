...
ambient self-adjoint operator is $A$.  The trial-coordinate space carries a
possibly unbounded self-adjoint operator $A_0$, and the isometry
$E_0$ embeds those coordinates into the ambient Hilbert space.  Its range is
the trial subspace.  The bounded residual $R$ extends
\[
  AE_0-E_0A_0
\]
...
\texttt{A}, \texttt{A0}, $\Lambda_1$ as partial linear maps
  & The ambient, trial, and complementary exact self-adjoint operators; each
    may be unbounded. \\
