...
$T$, $A_0$, and $\Lambda_1$.  Thus the $\mathtt L$ and $\mathtt L_{\mathrm p}$
forms distinguish bounded everywhere-defined maps from domain-aware partial
maps.

For continuous linear maps, $S\mathbin{\circ_L}T$ denotes composition,
$x\mapsto S(Tx)$.  In particular,
\[
...
$\Lambda_1:G\mathrel{\to}\!\mathtt{L}_{\mathrm p}[\mathbb K]G$
  & The perturbed full-space operator $T$, trial operator $A_0$, and
    complementary exact self-adjoint block $\Lambda_1$; each may be unbounded. \\
...
$\texttt{R}:F\mathrel{\to}\!\mathtt{L}[\mathbb K]E$
  & The bounded residual extending $TE_0-E_0A_0$ from $\operatorname{dom}A_0$. \\
