...
def build_resource_table():
    ...
    pretty = {
        ...
        'live_exact_model_turns': 'Live exact model turns',
        'backfill_model_turns': 'Explicit-backfill model turns',
        'pending_model_turns': 'Live pending model turns',
    ...
    basis = {
        'retained_observed': 'Retained observed telemetry.',
        'partition': 'Retained telemetry partition.',
        'coverage': 'Coverage.',
