...
def main():
    ...
    cases += block(
        ...
        'Repaired on 2026-09-06; retained as an alternative candidate.',
    ...
    cases += block(
        ...
        'Repaired on 2026-09-04; alternative post-rename candidate.',
    ...
    cases += block(
        ...
        'Repaired historically; selected for the four-page narrative example.',
