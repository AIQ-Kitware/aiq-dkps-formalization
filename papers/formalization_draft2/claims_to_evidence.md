...
| Ancillary downstream-reuse audit can identify the exact formalization slice consumed by Quench | `DkpsQuench2026/Geometry/AlignedCMDS.lean`, `scripts/build_quench_reuse_trace.py`, generated `quench_reuse_*` artifacts | Repository audit; not a main paper contribution |
